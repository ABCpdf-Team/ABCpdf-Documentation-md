...
```csharp
GroupAttributesElement()
GroupAttributesElement(Atom atom, IndirectObject host)
GroupAttributesElement(IndirectObject obj)
GroupAttributesElement(Element relation, CreationOptions options)
```
...
```
GroupAttributesElement()
GroupAttributesElement(atom As Atom, host As IndirectObject)
GroupAttributesElement(obj As IndirectObject)
GroupAttributesElement(relation As Element, options As CreationOptions)
```
