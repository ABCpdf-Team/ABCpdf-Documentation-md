...
| --- | --- | --- | --- |
| **[C#]** ```csharp XObjectElement ``` [Visual Basic] `XObjectElement` | null | No | Represents the "G" entry of the soft-mask dictionary object. | 

## Notes

Represents the "G" entry of the soft-mask dictionary object.

It is a required entry defined as part of the PDF 1.0 specification.

It contains a [XObjectElement](../../../08-graphics/1209-xobjectelement/default.md).
