...
```csharp
SoftMaskElement()
SoftMaskElement(Atom atom, IndirectObject host)
SoftMaskElement(IndirectObject obj)
SoftMaskElement(Element relation, CreationOptions options)
```
...
```
SoftMaskElement()
SoftMaskElement(atom As Atom, host As IndirectObject)
SoftMaskElement(obj As IndirectObject)
SoftMaskElement(relation As Element, options As CreationOptions)
```
