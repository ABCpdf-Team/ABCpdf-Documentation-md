...
```csharp
SeparationElement()
SeparationElement(Atom atom, IndirectObject host)
SeparationElement(IndirectObject obj)
SeparationElement(Element relation, CreationOptions options)
```
...
```
SeparationElement()
SeparationElement(atom As Atom, host As IndirectObject)
SeparationElement(obj As IndirectObject)
SeparationElement(relation As Element, options As CreationOptions)
```
