...
```csharp
PrintersMarkAnnotationElement()
PrintersMarkAnnotationElement(Atom atom, IndirectObject host)
PrintersMarkAnnotationElement(IndirectObject obj)
PrintersMarkAnnotationElement(Element relation, CreationOptions options)
```
...
```
PrintersMarkAnnotationElement()
PrintersMarkAnnotationElement(atom As Atom, host As IndirectObject)
PrintersMarkAnnotationElement(obj As IndirectObject)
PrintersMarkAnnotationElement(relation As Element, options As CreationOptions)
```
