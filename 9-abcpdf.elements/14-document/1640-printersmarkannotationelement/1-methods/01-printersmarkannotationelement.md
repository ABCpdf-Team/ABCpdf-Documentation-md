...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new PrintersMarkAnnotationElement. |  |  | 
...
| **[C#]** ```csharp PrintersMarkAnnotationElement() PrintersMarkAnnotationElement(Atom atom, IndirectObject host) PrintersMarkAnnotationElement(IndirectObject obj) PrintersMarkAnnotationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` PrintersMarkAnnotationElement() PrintersMarkAnnotationElement(atom As Atom, host As IndirectObject) PrintersMarkAnnotationElement(obj As IndirectObject) PrintersMarkAnnotationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
