...
```csharp
UserPropertyElement()
UserPropertyElement(Atom atom, IndirectObject host)
UserPropertyElement(IndirectObject obj)
UserPropertyElement(Element relation, CreationOptions options)
```
...
```
UserPropertyElement()
UserPropertyElement(atom As Atom, host As IndirectObject)
UserPropertyElement(obj As IndirectObject)
UserPropertyElement(relation As Element, options As CreationOptions)
```
