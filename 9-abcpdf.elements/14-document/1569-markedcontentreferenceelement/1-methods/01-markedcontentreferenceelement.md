...
```csharp
MarkedContentReferenceElement()
MarkedContentReferenceElement(Atom atom, IndirectObject host)
MarkedContentReferenceElement(IndirectObject obj)
MarkedContentReferenceElement(Element relation, CreationOptions options)
```
...
```
MarkedContentReferenceElement()
MarkedContentReferenceElement(atom As Atom, host As IndirectObject)
MarkedContentReferenceElement(obj As IndirectObject)
MarkedContentReferenceElement(relation As Element, options As CreationOptions)
```
