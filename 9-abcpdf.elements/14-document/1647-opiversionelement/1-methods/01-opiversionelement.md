...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new OpiVersionElement. |  |  | 
...
| **[C#]** ```csharp OpiVersionElement() OpiVersionElement(Atom atom, IndirectObject host) OpiVersionElement(IndirectObject obj) OpiVersionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` OpiVersionElement() OpiVersionElement(atom As Atom, host As IndirectObject) OpiVersionElement(obj As IndirectObject) OpiVersionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
