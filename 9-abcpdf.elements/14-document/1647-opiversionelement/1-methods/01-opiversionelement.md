...
```csharp
OpiVersionElement()
OpiVersionElement(Atom atom, IndirectObject host)
OpiVersionElement(IndirectObject obj)
OpiVersionElement(Element relation, CreationOptions options)
```
...
```
OpiVersionElement()
OpiVersionElement(atom As Atom, host As IndirectObject)
OpiVersionElement(obj As IndirectObject)
OpiVersionElement(relation As Element, options As CreationOptions)
```
