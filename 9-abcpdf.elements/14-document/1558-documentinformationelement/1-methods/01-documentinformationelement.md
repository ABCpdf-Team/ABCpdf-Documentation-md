...
DocumentInformationElement(Atom atom, IndirectObject host)
DocumentInformationElement(IndirectObject obj)
DocumentInformationElement(Element relation, CreationOptions options)
```
...
```
DocumentInformationElement()
DocumentInformationElement(atom As Atom, host As IndirectObject)
DocumentInformationElement(obj As IndirectObject)
DocumentInformationElement(relation As Element, options As CreationOptions)
```
