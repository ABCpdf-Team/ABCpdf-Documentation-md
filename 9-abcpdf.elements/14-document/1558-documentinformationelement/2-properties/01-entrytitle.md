...
| --- | --- | --- | --- |
| **[C#]** ```csharp string ``` [Visual Basic] `string` | null | No | Represents the "Title" entry of the document information dictionary object. | 

## Notes

Represents the "Title" entry of the document information dictionary object.
