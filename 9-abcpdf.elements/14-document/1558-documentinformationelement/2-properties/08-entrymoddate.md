...
| --- | --- | --- | --- |
| **[C#]** ```csharp string ``` [Visual Basic] `string` | null | No | Represents the "ModDate" entry of the document information dictionary object. | 

## Notes

Represents the "ModDate" entry of the document information dictionary object.
