...
```csharp
WebCaptureImageSetElement()
WebCaptureImageSetElement(Atom atom, IndirectObject host)
WebCaptureImageSetElement(IndirectObject obj)
WebCaptureImageSetElement(Element relation, CreationOptions options)
```
...
```
WebCaptureImageSetElement()
WebCaptureImageSetElement(atom As Atom, host As IndirectObject)
WebCaptureImageSetElement(obj As IndirectObject)
WebCaptureImageSetElement(relation As Element, options As CreationOptions)
```
