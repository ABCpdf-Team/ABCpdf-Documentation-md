...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new WebCaptureImageSetElement. |  |  | 
...
| **[C#]** ```csharp WebCaptureImageSetElement() WebCaptureImageSetElement(Atom atom, IndirectObject host) WebCaptureImageSetElement(IndirectObject obj) WebCaptureImageSetElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` WebCaptureImageSetElement() WebCaptureImageSetElement(atom As Atom, host As IndirectObject) WebCaptureImageSetElement(obj As IndirectObject) WebCaptureImageSetElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
