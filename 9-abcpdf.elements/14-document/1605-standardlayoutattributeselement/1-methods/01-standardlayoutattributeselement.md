...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new StandardLayoutAttributesElement. |  |  | 
...
| **[C#]** ```csharp StandardLayoutAttributesElement() StandardLayoutAttributesElement(Atom atom, IndirectObject host) StandardLayoutAttributesElement(IndirectObject obj) StandardLayoutAttributesElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` StandardLayoutAttributesElement() StandardLayoutAttributesElement(atom As Atom, host As IndirectObject) StandardLayoutAttributesElement(obj As IndirectObject) StandardLayoutAttributesElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
