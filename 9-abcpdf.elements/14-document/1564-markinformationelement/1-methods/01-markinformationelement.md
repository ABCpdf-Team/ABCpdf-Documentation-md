...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new MarkInformationElement. |  |  | 
...
| **[C#]** ```csharp MarkInformationElement() MarkInformationElement(Atom atom, IndirectObject host) MarkInformationElement(IndirectObject obj) MarkInformationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` MarkInformationElement() MarkInformationElement(atom As Atom, host As IndirectObject) MarkInformationElement(obj As IndirectObject) MarkInformationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
