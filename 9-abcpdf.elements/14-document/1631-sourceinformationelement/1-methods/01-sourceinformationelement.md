...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new SourceInformationElement. |  |  | 
...
| **[C#]** ```csharp SourceInformationElement() SourceInformationElement(Atom atom, IndirectObject host) SourceInformationElement(IndirectObject obj) SourceInformationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` SourceInformationElement() SourceInformationElement(atom As Atom, host As IndirectObject) SourceInformationElement(obj As IndirectObject) SourceInformationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
