...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new TrapNetworkAnnotationElement. |  |  | 
...
| **[C#]** ```csharp TrapNetworkAnnotationElement() TrapNetworkAnnotationElement(Atom atom, IndirectObject host) TrapNetworkAnnotationElement(IndirectObject obj) TrapNetworkAnnotationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` TrapNetworkAnnotationElement() TrapNetworkAnnotationElement(atom As Atom, host As IndirectObject) TrapNetworkAnnotationElement(obj As IndirectObject) TrapNetworkAnnotationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
