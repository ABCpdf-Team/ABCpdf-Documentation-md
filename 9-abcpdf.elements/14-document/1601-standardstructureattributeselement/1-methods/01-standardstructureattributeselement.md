...
StandardStructureAttributesElement(Atom atom, IndirectObject host)
StandardStructureAttributesElement(IndirectObject obj)
StandardStructureAttributesElement(Element relation, CreationOptions options)
```
...
```
StandardStructureAttributesElement()
StandardStructureAttributesElement(atom As Atom, host As IndirectObject)
StandardStructureAttributesElement(obj As IndirectObject)
StandardStructureAttributesElement(relation As Element, options As CreationOptions)
```
