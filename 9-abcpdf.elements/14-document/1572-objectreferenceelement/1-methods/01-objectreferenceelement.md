...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new ObjectReferenceElement. |  |  | 
...
| **[C#]** ```csharp ObjectReferenceElement() ObjectReferenceElement(Atom atom, IndirectObject host) ObjectReferenceElement(IndirectObject obj) ObjectReferenceElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` ObjectReferenceElement() ObjectReferenceElement(atom As Atom, host As IndirectObject) ObjectReferenceElement(obj As IndirectObject) ObjectReferenceElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
