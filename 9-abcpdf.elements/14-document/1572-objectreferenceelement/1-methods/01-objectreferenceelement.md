...
ObjectReferenceElement(Atom atom, IndirectObject host)
ObjectReferenceElement(IndirectObject obj)
ObjectReferenceElement(Element relation, CreationOptions options)
```
...
```
ObjectReferenceElement()
ObjectReferenceElement(atom As Atom, host As IndirectObject)
ObjectReferenceElement(obj As IndirectObject)
ObjectReferenceElement(relation As Element, options As CreationOptions)
```
