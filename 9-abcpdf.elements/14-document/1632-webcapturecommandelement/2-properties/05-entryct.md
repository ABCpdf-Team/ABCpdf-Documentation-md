...
Represents the "CT" entry of the web capture command dictionary object.
...
The PDF specification states that this item assumes a value of "application / x-www-form-urlencoded" if no value has been provided.
