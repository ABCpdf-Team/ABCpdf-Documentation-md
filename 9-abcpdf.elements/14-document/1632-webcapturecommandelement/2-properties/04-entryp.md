...
| --- | --- | --- | --- |
| **[C#]** ```csharp Element ``` [Visual Basic] `Element` | null | No | Represents the "P" entry of the web capture command dictionary object. | 

## Notes

Represents the "P" entry of the web capture command dictionary object.
