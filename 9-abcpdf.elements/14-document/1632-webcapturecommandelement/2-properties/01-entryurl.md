...
| --- | --- | --- | --- |
| **[C#]** ```csharp string ``` [Visual Basic] `string` | null | No | Represents the "URL" entry of the web capture command dictionary object. | 

## Notes

Represents the "URL" entry of the web capture command dictionary object.
