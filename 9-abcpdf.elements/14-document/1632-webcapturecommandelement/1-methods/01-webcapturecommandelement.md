...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new WebCaptureCommandElement. |  |  | 
...
| **[C#]** ```csharp WebCaptureCommandElement() WebCaptureCommandElement(Atom atom, IndirectObject host) WebCaptureCommandElement(IndirectObject obj) WebCaptureCommandElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` WebCaptureCommandElement() WebCaptureCommandElement(atom As Atom, host As IndirectObject) WebCaptureCommandElement(obj As IndirectObject) WebCaptureCommandElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
