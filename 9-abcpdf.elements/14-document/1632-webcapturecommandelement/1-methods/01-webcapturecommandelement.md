...
```csharp
WebCaptureCommandElement()
WebCaptureCommandElement(Atom atom, IndirectObject host)
WebCaptureCommandElement(IndirectObject obj)
WebCaptureCommandElement(Element relation, CreationOptions options)
```
...
```
WebCaptureCommandElement()
WebCaptureCommandElement(atom As Atom, host As IndirectObject)
WebCaptureCommandElement(obj As IndirectObject)
WebCaptureCommandElement(relation As Element, options As CreationOptions)
```
