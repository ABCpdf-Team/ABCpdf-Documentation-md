...
WebCaptureContentSetElement(Atom atom, IndirectObject host)
WebCaptureContentSetElement(IndirectObject obj)
WebCaptureContentSetElement(Element relation, CreationOptions options)
```
...
```
WebCaptureContentSetElement()
WebCaptureContentSetElement(atom As Atom, host As IndirectObject)
WebCaptureContentSetElement(obj As IndirectObject)
WebCaptureContentSetElement(relation As Element, options As CreationOptions)
```
