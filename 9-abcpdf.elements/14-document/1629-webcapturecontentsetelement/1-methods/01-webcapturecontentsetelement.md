---
title: "01-webcapturecontentsetelement"
css: "abcpdf-docs.css"
---
...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new WebCaptureContentSetElement. |  |  | 
...
| **[C#]** ```csharp WebCaptureContentSetElement() WebCaptureContentSetElement(Atom atom, IndirectObject host) WebCaptureContentSetElement(IndirectObject obj) WebCaptureContentSetElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` WebCaptureContentSetElement() WebCaptureContentSetElement(atom As Atom, host As IndirectObject) WebCaptureContentSetElement(obj As IndirectObject) WebCaptureContentSetElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
