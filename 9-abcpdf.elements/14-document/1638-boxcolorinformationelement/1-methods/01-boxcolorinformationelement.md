...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new BoxColorInformationElement. |  |  | 
...
| **[C#]** ```csharp BoxColorInformationElement() BoxColorInformationElement(Atom atom, IndirectObject host) BoxColorInformationElement(IndirectObject obj) BoxColorInformationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` BoxColorInformationElement() BoxColorInformationElement(atom As Atom, host As IndirectObject) BoxColorInformationElement(obj As IndirectObject) BoxColorInformationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
