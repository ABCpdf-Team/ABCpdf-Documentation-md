...
BoxColorInformationElement(Atom atom, IndirectObject host)
BoxColorInformationElement(IndirectObject obj)
BoxColorInformationElement(Element relation, CreationOptions options)
```
...
```
BoxColorInformationElement()
BoxColorInformationElement(atom As Atom, host As IndirectObject)
BoxColorInformationElement(obj As IndirectObject)
BoxColorInformationElement(relation As Element, options As CreationOptions)
```
