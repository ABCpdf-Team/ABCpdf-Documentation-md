...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new LinearizationParameterElement. |  |  | 
...
| **[C#]** ```csharp LinearizationParameterElement() LinearizationParameterElement(Atom atom, IndirectObject host) LinearizationParameterElement(IndirectObject obj) LinearizationParameterElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` LinearizationParameterElement() LinearizationParameterElement(atom As Atom, host As IndirectObject) LinearizationParameterElement(obj As IndirectObject) LinearizationParameterElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
