...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new WebCaptureCommandSettingsElement. |  |  | 
...
| **[C#]** ```csharp WebCaptureCommandSettingsElement() WebCaptureCommandSettingsElement(Atom atom, IndirectObject host) WebCaptureCommandSettingsElement(IndirectObject obj) WebCaptureCommandSettingsElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` WebCaptureCommandSettingsElement() WebCaptureCommandSettingsElement(atom As Atom, host As IndirectObject) WebCaptureCommandSettingsElement(obj As IndirectObject) WebCaptureCommandSettingsElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
