...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new ArtifactAttributesElement. |  |  | 
...
| **[C#]** ```csharp ArtifactAttributesElement() ArtifactAttributesElement(Atom atom, IndirectObject host) ArtifactAttributesElement(IndirectObject obj) ArtifactAttributesElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` ArtifactAttributesElement() ArtifactAttributesElement(atom As Atom, host As IndirectObject) ArtifactAttributesElement(obj As IndirectObject) ArtifactAttributesElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
