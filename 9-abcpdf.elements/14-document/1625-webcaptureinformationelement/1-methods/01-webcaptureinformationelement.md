...
```csharp
WebCaptureInformationElement()
WebCaptureInformationElement(Atom atom, IndirectObject host)
WebCaptureInformationElement(IndirectObject obj)
WebCaptureInformationElement(Element relation, CreationOptions options)
```
...
```
WebCaptureInformationElement()
WebCaptureInformationElement(atom As Atom, host As IndirectObject)
WebCaptureInformationElement(obj As IndirectObject)
WebCaptureInformationElement(relation As Element, options As CreationOptions)
```
