...
| **[C#]** ```csharp BoxStyleElement() BoxStyleElement(Atom atom, IndirectObject host) BoxStyleElement(IndirectObject obj) BoxStyleElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` BoxStyleElement() BoxStyleElement(atom As Atom, host As IndirectObject) BoxStyleElement(obj As IndirectObject) BoxStyleElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
