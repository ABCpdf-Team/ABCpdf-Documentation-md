...
```csharp
DocumentPartElement()
DocumentPartElement(Atom atom, IndirectObject host)
DocumentPartElement(IndirectObject obj)
DocumentPartElement(Element relation, CreationOptions options)
```
...
```
DocumentPartElement()
DocumentPartElement(atom As Atom, host As IndirectObject)
DocumentPartElement(obj As IndirectObject)
DocumentPartElement(relation As Element, options As CreationOptions)
```
