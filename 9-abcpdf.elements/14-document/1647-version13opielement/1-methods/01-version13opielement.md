...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new Version13OpiElement. |  |  | 
...
| **[C#]** ```csharp Version13OpiElement() Version13OpiElement(Atom atom, IndirectObject host) Version13OpiElement(IndirectObject obj) Version13OpiElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` Version13OpiElement() Version13OpiElement(atom As Atom, host As IndirectObject) Version13OpiElement(obj As IndirectObject) Version13OpiElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
