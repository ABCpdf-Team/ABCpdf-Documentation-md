...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new WebCapturePageSetElement. |  |  | 
...
| **[C#]** ```csharp WebCapturePageSetElement() WebCapturePageSetElement(Atom atom, IndirectObject host) WebCapturePageSetElement(IndirectObject obj) WebCapturePageSetElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` WebCapturePageSetElement() WebCapturePageSetElement(atom As Atom, host As IndirectObject) WebCapturePageSetElement(obj As IndirectObject) WebCapturePageSetElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
