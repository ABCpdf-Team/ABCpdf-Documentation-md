...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new StructureTreeRootElement. |  |  | 
...
| **[C#]** ```csharp StructureTreeRootElement() StructureTreeRootElement(Atom atom, IndirectObject host) StructureTreeRootElement(IndirectObject obj) StructureTreeRootElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` StructureTreeRootElement() StructureTreeRootElement(atom As Atom, host As IndirectObject) StructureTreeRootElement(obj As IndirectObject) StructureTreeRootElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
