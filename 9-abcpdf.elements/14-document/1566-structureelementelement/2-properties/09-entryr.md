...
| --- | --- | --- | --- |
| **[C#]** ```csharp int? ``` [Visual Basic] `Integer?` | null | No | Represents the "R" entry of the structure element dictionary object. | 

## Notes

Represents the "R" entry of the structure element dictionary object.
