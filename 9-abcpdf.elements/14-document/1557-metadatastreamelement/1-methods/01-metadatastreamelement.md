...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new MetadataStreamElement. |  |  | 
...
| **[C#]** ```csharp MetadataStreamElement() MetadataStreamElement(Atom atom, IndirectObject host) MetadataStreamElement(IndirectObject obj) MetadataStreamElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` MetadataStreamElement() MetadataStreamElement(atom As Atom, host As IndirectObject) MetadataStreamElement(obj As IndirectObject) MetadataStreamElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
