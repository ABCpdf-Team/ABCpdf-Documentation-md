...
```csharp
PagePieceDataElement()
PagePieceDataElement(Atom atom, IndirectObject host)
PagePieceDataElement(IndirectObject obj)
PagePieceDataElement(Element relation, CreationOptions options)
```
...
```
PagePieceDataElement()
PagePieceDataElement(atom As Atom, host As IndirectObject)
PagePieceDataElement(obj As IndirectObject)
PagePieceDataElement(relation As Element, options As CreationOptions)
```
