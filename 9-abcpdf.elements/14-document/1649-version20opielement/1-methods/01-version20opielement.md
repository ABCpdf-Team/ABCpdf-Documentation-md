...
```csharp
Version20OpiElement()
Version20OpiElement(Atom atom, IndirectObject host)
Version20OpiElement(IndirectObject obj)
Version20OpiElement(Element relation, CreationOptions options)
```
...
```
Version20OpiElement()
Version20OpiElement(atom As Atom, host As IndirectObject)
Version20OpiElement(obj As IndirectObject)
Version20OpiElement(relation As Element, options As CreationOptions)
```
