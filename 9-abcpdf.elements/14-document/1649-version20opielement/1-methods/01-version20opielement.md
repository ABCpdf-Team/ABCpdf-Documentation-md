...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new Version20OpiElement. |  |  | 
...
| **[C#]** ```csharp Version20OpiElement() Version20OpiElement(Atom atom, IndirectObject host) Version20OpiElement(IndirectObject obj) Version20OpiElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` Version20OpiElement() Version20OpiElement(atom As Atom, host As IndirectObject) Version20OpiElement(obj As IndirectObject) Version20OpiElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
