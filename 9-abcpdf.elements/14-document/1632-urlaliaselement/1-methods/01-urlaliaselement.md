...
```csharp
UrlAliasElement()
UrlAliasElement(Atom atom, IndirectObject host)
UrlAliasElement(IndirectObject obj)
UrlAliasElement(Element relation, CreationOptions options)
```
...
```
UrlAliasElement()
UrlAliasElement(atom As Atom, host As IndirectObject)
UrlAliasElement(obj As IndirectObject)
UrlAliasElement(relation As Element, options As CreationOptions)
```
