...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new OutputProfilesElement. |  |  | 
...
| **[C#]** ```csharp OutputProfilesElement() OutputProfilesElement(Atom atom, IndirectObject host) OutputProfilesElement(IndirectObject obj) OutputProfilesElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` OutputProfilesElement() OutputProfilesElement(atom As Atom, host As IndirectObject) OutputProfilesElement(obj As IndirectObject) OutputProfilesElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
