...
```csharp
OutputIntentElement()
OutputIntentElement(Atom atom, IndirectObject host)
OutputIntentElement(IndirectObject obj)
OutputIntentElement(Element relation, CreationOptions options)
```
...
```
OutputIntentElement()
OutputIntentElement(atom As Atom, host As IndirectObject)
OutputIntentElement(obj As IndirectObject)
OutputIntentElement(relation As Element, options As CreationOptions)
```
