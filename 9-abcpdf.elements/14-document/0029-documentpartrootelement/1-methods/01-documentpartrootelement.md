# DocumentPartRootElement Function
...
```csharp
<a href="../default.htm">DocumentPartRootElement</a>()<a href="../default.htm">DocumentPartRootElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">DocumentPartRootElement</a>(IndirectObject obj)<a href="../default.htm">DocumentPartRootElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">DocumentPartRootElement</a>()<a href="../default.htm">DocumentPartRootElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">DocumentPartRootElement</a>(obj As IndirectObject)<a href="../default.htm">DocumentPartRootElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
Create a new [DocumentPartRootElement](default.md).
