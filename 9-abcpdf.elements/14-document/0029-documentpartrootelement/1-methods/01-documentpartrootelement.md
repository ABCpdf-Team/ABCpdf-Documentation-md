...
```csharp
DocumentPartRootElement()
DocumentPartRootElement(Atom atom, IndirectObject host)
DocumentPartRootElement(IndirectObject obj)
DocumentPartRootElement(Element relation, CreationOptions options)
```
...
```
DocumentPartRootElement()
DocumentPartRootElement(atom As Atom, host As IndirectObject)
DocumentPartRootElement(obj As IndirectObject)
DocumentPartRootElement(relation As Element, options As CreationOptions)
```
