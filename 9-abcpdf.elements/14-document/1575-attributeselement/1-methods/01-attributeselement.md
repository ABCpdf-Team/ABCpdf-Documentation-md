...
```csharp
AttributesElement()
AttributesElement(Atom atom, IndirectObject host)
AttributesElement(IndirectObject obj)
AttributesElement(Element relation, CreationOptions options)
```
...
```
AttributesElement()
AttributesElement(atom As Atom, host As IndirectObject)
AttributesElement(obj As IndirectObject)
AttributesElement(relation As Element, options As CreationOptions)
```
