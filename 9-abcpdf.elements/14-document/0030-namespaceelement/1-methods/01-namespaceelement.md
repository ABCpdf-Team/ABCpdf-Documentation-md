...
| **[C#]** ```csharp NamespaceElement() NamespaceElement(Atom atom, IndirectObject host) NamespaceElement(IndirectObject obj) NamespaceElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` NamespaceElement() NamespaceElement(atom As Atom, host As IndirectObject) NamespaceElement(obj As IndirectObject) NamespaceElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
