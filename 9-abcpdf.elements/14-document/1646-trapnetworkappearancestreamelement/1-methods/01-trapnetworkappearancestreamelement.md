...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new TrapNetworkAppearanceStreamElement. |  |  | 
...
| **[C#]** ```csharp TrapNetworkAppearanceStreamElement() TrapNetworkAppearanceStreamElement(Atom atom, IndirectObject host) TrapNetworkAppearanceStreamElement(IndirectObject obj) TrapNetworkAppearanceStreamElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` TrapNetworkAppearanceStreamElement() TrapNetworkAppearanceStreamElement(atom As Atom, host As IndirectObject) TrapNetworkAppearanceStreamElement(obj As IndirectObject) TrapNetworkAppearanceStreamElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
