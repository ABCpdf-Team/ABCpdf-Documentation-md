...
```csharp
UserPropertiesAttributesElement()
UserPropertiesAttributesElement(Atom atom, IndirectObject host)
UserPropertiesAttributesElement(IndirectObject obj)
UserPropertiesAttributesElement(Element relation, CreationOptions options)
```
...
```
UserPropertiesAttributesElement()
UserPropertiesAttributesElement(atom As Atom, host As IndirectObject)
UserPropertiesAttributesElement(obj As IndirectObject)
UserPropertiesAttributesElement(relation As Element, options As CreationOptions)
```
