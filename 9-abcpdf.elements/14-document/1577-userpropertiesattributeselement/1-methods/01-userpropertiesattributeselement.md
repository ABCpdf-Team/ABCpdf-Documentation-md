---
title: "01-userpropertiesattributeselement"
css: "abcpdf-docs.css"
---

|  |  | UserPropertiesAttributesElement Function |  |  | 
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new UserPropertiesAttributesElement. |  |  | 
...
| **[C#]** ```csharp UserPropertiesAttributesElement() UserPropertiesAttributesElement(Atom atom, IndirectObject host) UserPropertiesAttributesElement(IndirectObject obj) UserPropertiesAttributesElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` UserPropertiesAttributesElement() UserPropertiesAttributesElement(atom As Atom, host As IndirectObject) UserPropertiesAttributesElement(obj As IndirectObject) UserPropertiesAttributesElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
