...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new CIDSystemInfoElement. |  |  | 
...
| **[C#]** ```csharp CIDSystemInfoElement() CIDSystemInfoElement(Atom atom, IndirectObject host) CIDSystemInfoElement(IndirectObject obj) CIDSystemInfoElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` CIDSystemInfoElement() CIDSystemInfoElement(atom As Atom, host As IndirectObject) CIDSystemInfoElement(obj As IndirectObject) CIDSystemInfoElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
