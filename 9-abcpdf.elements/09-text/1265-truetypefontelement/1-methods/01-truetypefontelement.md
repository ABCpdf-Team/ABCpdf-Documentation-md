...
```csharp
TrueTypeFontElement()
TrueTypeFontElement(Atom atom, IndirectObject host)
TrueTypeFontElement(IndirectObject obj)
TrueTypeFontElement(Element relation, CreationOptions options)
```
...
```
TrueTypeFontElement()
TrueTypeFontElement(atom As Atom, host As IndirectObject)
TrueTypeFontElement(obj As IndirectObject)
TrueTypeFontElement(relation As Element, options As CreationOptions)
```
