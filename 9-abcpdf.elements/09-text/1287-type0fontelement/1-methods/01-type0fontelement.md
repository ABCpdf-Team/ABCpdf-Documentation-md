...
```csharp
Type0FontElement()
Type0FontElement(Atom atom, IndirectObject host)
Type0FontElement(IndirectObject obj)
Type0FontElement(Element relation, CreationOptions options)
```
...
```
Type0FontElement()
Type0FontElement(atom As Atom, host As IndirectObject)
Type0FontElement(obj As IndirectObject)
Type0FontElement(relation As Element, options As CreationOptions)
```
