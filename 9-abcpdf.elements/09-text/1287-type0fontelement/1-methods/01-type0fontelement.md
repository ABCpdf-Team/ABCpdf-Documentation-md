...
```csharp
<a href="../default.htm">Type0FontElement</a>()<a href="../default.htm">Type0FontElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">Type0FontElement</a>(IndirectObject obj)<a href="../default.htm">Type0FontElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">Type0FontElement</a>()<a href="../default.htm">Type0FontElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">Type0FontElement</a>(obj As IndirectObject)<a href="../default.htm">Type0FontElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
Create a new [Type0FontElement](default.md).
