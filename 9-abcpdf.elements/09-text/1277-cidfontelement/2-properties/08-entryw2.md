...
| --- | --- | --- | --- |
| **[C#]** ```csharp ArrayElementElement> ``` [Visual Basic] `ArrayElementElement>` | null | No | Represents the "W2" entry of the cidfont dictionary object. | 

## Notes

Represents the "W2" entry of the cidfont dictionary object.
