...
| **[C#]** ```csharp CIDFontElement() CIDFontElement(Atom atom, IndirectObject host) CIDFontElement(IndirectObject obj) CIDFontElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` CIDFontElement() CIDFontElement(atom As Atom, host As IndirectObject) CIDFontElement(obj As IndirectObject) CIDFontElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
