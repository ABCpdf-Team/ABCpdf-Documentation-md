...
```csharp
Type3FontElement()
Type3FontElement(Atom atom, IndirectObject host)
Type3FontElement(IndirectObject obj)
Type3FontElement(Element relation, CreationOptions options)
```
...
```
Type3FontElement()
Type3FontElement(atom As Atom, host As IndirectObject)
Type3FontElement(obj As IndirectObject)
Type3FontElement(relation As Element, options As CreationOptions)
```
