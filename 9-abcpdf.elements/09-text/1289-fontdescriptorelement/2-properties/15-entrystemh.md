...
| --- | --- | --- | --- |
| **[C#]** ```csharp double? ``` [Visual Basic] `Double?` | null | No | Represents the "StemH" entry of the font descriptor object. | 

## Notes

Represents the "StemH" entry of the font descriptor object.
