...
```csharp
FontDescriptorElement()
FontDescriptorElement(Atom atom, IndirectObject host)
FontDescriptorElement(IndirectObject obj)
FontDescriptorElement(Element relation, CreationOptions options)
```
...
```
FontDescriptorElement()
FontDescriptorElement(atom As Atom, host As IndirectObject)
FontDescriptorElement(obj As IndirectObject)
FontDescriptorElement(relation As Element, options As CreationOptions)
```
