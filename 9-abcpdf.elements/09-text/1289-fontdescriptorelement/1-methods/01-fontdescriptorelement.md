...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new FontDescriptorElement. |  |  | 
...
| **[C#]** ```csharp FontDescriptorElement() FontDescriptorElement(Atom atom, IndirectObject host) FontDescriptorElement(IndirectObject obj) FontDescriptorElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` FontDescriptorElement() FontDescriptorElement(atom As Atom, host As IndirectObject) FontDescriptorElement(obj As IndirectObject) FontDescriptorElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
