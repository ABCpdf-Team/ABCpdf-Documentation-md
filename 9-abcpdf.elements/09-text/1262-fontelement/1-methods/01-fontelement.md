...
| **[C#]** ```csharp FontElement() FontElement(Atom atom, IndirectObject host) FontElement(IndirectObject obj) FontElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` FontElement() FontElement(atom As Atom, host As IndirectObject) FontElement(obj As IndirectObject) FontElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
