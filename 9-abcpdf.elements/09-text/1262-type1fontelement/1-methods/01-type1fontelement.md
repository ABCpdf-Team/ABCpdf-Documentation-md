...
```csharp
Type1FontElement()
Type1FontElement(Atom atom, IndirectObject host)
Type1FontElement(IndirectObject obj)
Type1FontElement(Element relation, CreationOptions options)
```
...
```
Type1FontElement()
Type1FontElement(atom As Atom, host As IndirectObject)
Type1FontElement(obj As IndirectObject)
Type1FontElement(relation As Element, options As CreationOptions)
```
