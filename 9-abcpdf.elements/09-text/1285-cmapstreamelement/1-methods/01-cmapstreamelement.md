...
```csharp
CMapStreamElement()
CMapStreamElement(Atom atom, IndirectObject host)
CMapStreamElement(IndirectObject obj)
CMapStreamElement(Element relation, CreationOptions options)
```
...
```
CMapStreamElement()
CMapStreamElement(atom As Atom, host As IndirectObject)
CMapStreamElement(obj As IndirectObject)
CMapStreamElement(relation As Element, options As CreationOptions)
```
