...
| --- | --- | --- | --- |
| **[C#]** ```csharp Element ``` [Visual Basic] `Element` | null | No | Represents the "UseCMap" entry of the cmap stream dictionary object. | 

## Notes

Represents the "UseCMap" entry of the cmap stream dictionary object.
