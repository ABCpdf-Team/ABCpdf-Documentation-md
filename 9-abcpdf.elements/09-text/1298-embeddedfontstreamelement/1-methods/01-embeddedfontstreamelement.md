...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new EmbeddedFontStreamElement. |  |  | 
...
| **[C#]** ```csharp EmbeddedFontStreamElement() EmbeddedFontStreamElement(Atom atom, IndirectObject host) EmbeddedFontStreamElement(IndirectObject obj) EmbeddedFontStreamElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` EmbeddedFontStreamElement() EmbeddedFontStreamElement(atom As Atom, host As IndirectObject) EmbeddedFontStreamElement(obj As IndirectObject) EmbeddedFontStreamElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
