...
```csharp
<a href="../default.htm">EmbeddedFontStreamElement</a>()<a href="../default.htm">EmbeddedFontStreamElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">EmbeddedFontStreamElement</a>(IndirectObject obj)<a href="../default.htm">EmbeddedFontStreamElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">EmbeddedFontStreamElement</a>()<a href="../default.htm">EmbeddedFontStreamElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">EmbeddedFontStreamElement</a>(obj As IndirectObject)<a href="../default.htm">EmbeddedFontStreamElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
