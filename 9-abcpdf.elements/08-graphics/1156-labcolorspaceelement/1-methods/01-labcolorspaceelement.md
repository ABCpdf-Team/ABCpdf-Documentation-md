...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new LabColorSpaceElement. |  |  | 
...
| **[C#]** ```csharp LabColorSpaceElement() LabColorSpaceElement(Atom atom, IndirectObject host) LabColorSpaceElement(IndirectObject obj) LabColorSpaceElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` LabColorSpaceElement() LabColorSpaceElement(atom As Atom, host As IndirectObject) LabColorSpaceElement(obj As IndirectObject) LabColorSpaceElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
