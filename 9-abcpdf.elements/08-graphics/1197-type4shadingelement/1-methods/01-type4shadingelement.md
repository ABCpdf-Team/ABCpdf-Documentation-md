...
```csharp
Type4ShadingElement()
Type4ShadingElement(Atom atom, IndirectObject host)
Type4ShadingElement(IndirectObject obj)
Type4ShadingElement(Element relation, CreationOptions options)
```
...
```
Type4ShadingElement()
Type4ShadingElement(atom As Atom, host As IndirectObject)
Type4ShadingElement(obj As IndirectObject)
Type4ShadingElement(relation As Element, options As CreationOptions)
```
