...
```csharp
OptionalContentMembershipElement()
OptionalContentMembershipElement(Atom atom, IndirectObject host)
OptionalContentMembershipElement(IndirectObject obj)
OptionalContentMembershipElement(Element relation, CreationOptions options)
```
...
```
OptionalContentMembershipElement()
OptionalContentMembershipElement(atom As Atom, host As IndirectObject)
OptionalContentMembershipElement(obj As IndirectObject)
OptionalContentMembershipElement(relation As Element, options As CreationOptions)
```
