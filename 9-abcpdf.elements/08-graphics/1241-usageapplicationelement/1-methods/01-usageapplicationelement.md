...
```csharp
UsageApplicationElement()
UsageApplicationElement(Atom atom, IndirectObject host)
UsageApplicationElement(IndirectObject obj)
UsageApplicationElement(Element relation, CreationOptions options)
```
...
```
UsageApplicationElement()
UsageApplicationElement(atom As Atom, host As IndirectObject)
UsageApplicationElement(obj As IndirectObject)
UsageApplicationElement(relation As Element, options As CreationOptions)
```
