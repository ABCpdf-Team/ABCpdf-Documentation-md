...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new ICCProfileStreamElement. |  |  | 
...
| **[C#]** ```csharp ICCProfileStreamElement() ICCProfileStreamElement(Atom atom, IndirectObject host) ICCProfileStreamElement(IndirectObject obj) ICCProfileStreamElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` ICCProfileStreamElement() ICCProfileStreamElement(atom As Atom, host As IndirectObject) ICCProfileStreamElement(obj As IndirectObject) ICCProfileStreamElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
