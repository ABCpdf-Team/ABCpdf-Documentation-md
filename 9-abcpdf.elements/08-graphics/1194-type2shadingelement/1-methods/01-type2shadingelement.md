...
```csharp
Type2ShadingElement()
Type2ShadingElement(Atom atom, IndirectObject host)
Type2ShadingElement(IndirectObject obj)
Type2ShadingElement(Element relation, CreationOptions options)
```
...
```
Type2ShadingElement()
Type2ShadingElement(atom As Atom, host As IndirectObject)
Type2ShadingElement(obj As IndirectObject)
Type2ShadingElement(relation As Element, options As CreationOptions)
```
