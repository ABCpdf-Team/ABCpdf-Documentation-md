...
```csharp
ImageXObjectElement()
ImageXObjectElement(Atom atom, IndirectObject host)
ImageXObjectElement(IndirectObject obj)
ImageXObjectElement(Element relation, CreationOptions options)
```
...
```
ImageXObjectElement()
ImageXObjectElement(atom As Atom, host As IndirectObject)
ImageXObjectElement(obj As IndirectObject)
ImageXObjectElement(relation As Element, options As CreationOptions)
```
