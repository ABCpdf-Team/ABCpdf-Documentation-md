...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new Type5ShadingElement. |  |  | 
...
| **[C#]** ```csharp Type5ShadingElement() Type5ShadingElement(Atom atom, IndirectObject host) Type5ShadingElement(IndirectObject obj) Type5ShadingElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` Type5ShadingElement() Type5ShadingElement(atom As Atom, host As IndirectObject) Type5ShadingElement(obj As IndirectObject) Type5ShadingElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
