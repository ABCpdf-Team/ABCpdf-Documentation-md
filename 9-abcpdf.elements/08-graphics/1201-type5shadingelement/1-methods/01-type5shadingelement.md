...
```csharp
<a href="../default.htm">Type5ShadingElement</a>()<a href="../default.htm">Type5ShadingElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">Type5ShadingElement</a>(IndirectObject obj)<a href="../default.htm">Type5ShadingElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">Type5ShadingElement</a>()<a href="../default.htm">Type5ShadingElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">Type5ShadingElement</a>(obj As IndirectObject)<a href="../default.htm">Type5ShadingElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
Create a new [Type5ShadingElement](default.md).
