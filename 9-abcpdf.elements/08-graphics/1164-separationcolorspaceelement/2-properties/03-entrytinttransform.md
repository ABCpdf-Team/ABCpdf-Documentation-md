...
The function is used to map color values in the Separation color space into color values in the [EntryAlternateColorSpace](02-entryalternatecolorspace.md) color space.
