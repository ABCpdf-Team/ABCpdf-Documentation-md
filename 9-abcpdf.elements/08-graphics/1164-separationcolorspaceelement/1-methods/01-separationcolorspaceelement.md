...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new SeparationColorSpaceElement. |  |  | 
...
| **[C#]** ```csharp SeparationColorSpaceElement() SeparationColorSpaceElement(Atom atom, IndirectObject host) SeparationColorSpaceElement(IndirectObject obj) SeparationColorSpaceElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` SeparationColorSpaceElement() SeparationColorSpaceElement(atom As Atom, host As IndirectObject) SeparationColorSpaceElement(obj As IndirectObject) SeparationColorSpaceElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
