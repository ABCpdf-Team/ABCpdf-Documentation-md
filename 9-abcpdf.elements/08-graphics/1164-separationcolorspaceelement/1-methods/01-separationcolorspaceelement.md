...
```csharp
SeparationColorSpaceElement()
SeparationColorSpaceElement(Atom atom, IndirectObject host)
SeparationColorSpaceElement(IndirectObject obj)
SeparationColorSpaceElement(Element relation, CreationOptions options)
```
...
```
SeparationColorSpaceElement()
SeparationColorSpaceElement(atom As Atom, host As IndirectObject)
SeparationColorSpaceElement(obj As IndirectObject)
SeparationColorSpaceElement(relation As Element, options As CreationOptions)
```
