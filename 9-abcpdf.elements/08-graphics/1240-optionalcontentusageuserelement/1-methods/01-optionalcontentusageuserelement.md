---
title: "01-optionalcontentusageuserelement"
css: "abcpdf-docs.css"
---
...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new OptionalContentUsageUserElement. |  |  | 
...
| **[C#]** ```csharp OptionalContentUsageUserElement() OptionalContentUsageUserElement(Atom atom, IndirectObject host) OptionalContentUsageUserElement(IndirectObject obj) OptionalContentUsageUserElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` OptionalContentUsageUserElement() OptionalContentUsageUserElement(atom As Atom, host As IndirectObject) OptionalContentUsageUserElement(obj As IndirectObject) OptionalContentUsageUserElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
