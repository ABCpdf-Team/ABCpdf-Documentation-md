...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new Type7ShadingElement. |  |  | 
...
| **[C#]** ```csharp Type7ShadingElement() Type7ShadingElement(Atom atom, IndirectObject host) Type7ShadingElement(IndirectObject obj) Type7ShadingElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` Type7ShadingElement() Type7ShadingElement(atom As Atom, host As IndirectObject) Type7ShadingElement(obj As IndirectObject) Type7ShadingElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
