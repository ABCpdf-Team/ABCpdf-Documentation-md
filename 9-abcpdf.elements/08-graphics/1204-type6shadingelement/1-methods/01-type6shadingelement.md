...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new Type6ShadingElement. |  |  | 
...
| **[C#]** ```csharp Type6ShadingElement() Type6ShadingElement(Atom atom, IndirectObject host) Type6ShadingElement(IndirectObject obj) Type6ShadingElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` Type6ShadingElement() Type6ShadingElement(atom As Atom, host As IndirectObject) Type6ShadingElement(obj As IndirectObject) Type6ShadingElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
