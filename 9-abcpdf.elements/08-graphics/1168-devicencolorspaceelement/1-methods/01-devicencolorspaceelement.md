...
```csharp
DeviceNColorSpaceElement()
DeviceNColorSpaceElement(Atom atom, IndirectObject host)
DeviceNColorSpaceElement(IndirectObject obj)
DeviceNColorSpaceElement(Element relation, CreationOptions options)
```
...
```
DeviceNColorSpaceElement()
DeviceNColorSpaceElement(atom As Atom, host As IndirectObject)
DeviceNColorSpaceElement(obj As IndirectObject)
DeviceNColorSpaceElement(relation As Element, options As CreationOptions)
```
