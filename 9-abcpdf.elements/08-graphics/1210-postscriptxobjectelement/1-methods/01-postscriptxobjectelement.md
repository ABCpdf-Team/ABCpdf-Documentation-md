...
```csharp
PostScriptXObjectElement()
PostScriptXObjectElement(Atom atom, IndirectObject host)
PostScriptXObjectElement(IndirectObject obj)
PostScriptXObjectElement(Element relation, CreationOptions options)
```
...
```
PostScriptXObjectElement()
PostScriptXObjectElement(atom As Atom, host As IndirectObject)
PostScriptXObjectElement(obj As IndirectObject)
PostScriptXObjectElement(relation As Element, options As CreationOptions)
```
