...
```csharp
OptionalContentUsageZoomElement()
OptionalContentUsageZoomElement(Atom atom, IndirectObject host)
OptionalContentUsageZoomElement(IndirectObject obj)
OptionalContentUsageZoomElement(Element relation, CreationOptions options)
```
...
```
OptionalContentUsageZoomElement()
OptionalContentUsageZoomElement(atom As Atom, host As IndirectObject)
OptionalContentUsageZoomElement(obj As IndirectObject)
OptionalContentUsageZoomElement(relation As Element, options As CreationOptions)
```
