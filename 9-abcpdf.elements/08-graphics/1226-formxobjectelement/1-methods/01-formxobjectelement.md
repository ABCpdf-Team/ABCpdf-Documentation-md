...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new FormXObjectElement. |  |  | 
...
| **[C#]** ```csharp FormXObjectElement() FormXObjectElement(Atom atom, IndirectObject host) FormXObjectElement(IndirectObject obj) FormXObjectElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` FormXObjectElement() FormXObjectElement(atom As Atom, host As IndirectObject) FormXObjectElement(obj As IndirectObject) FormXObjectElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
