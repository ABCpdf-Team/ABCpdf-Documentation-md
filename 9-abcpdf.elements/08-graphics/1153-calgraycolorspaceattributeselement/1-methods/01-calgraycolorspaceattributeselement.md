---
title: "01-calgraycolorspaceattributeselement"
css: "abcpdf-docs.css"
---
...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new CalGrayColorSpaceAttributesElement. |  |  | 
...
| **[C#]** ```csharp CalGrayColorSpaceAttributesElement() CalGrayColorSpaceAttributesElement(Atom atom, IndirectObject host) CalGrayColorSpaceAttributesElement(IndirectObject obj) CalGrayColorSpaceAttributesElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` CalGrayColorSpaceAttributesElement() CalGrayColorSpaceAttributesElement(atom As Atom, host As IndirectObject) CalGrayColorSpaceAttributesElement(obj As IndirectObject) CalGrayColorSpaceAttributesElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
