...
```csharp
CalGrayColorSpaceAttributesElement()
CalGrayColorSpaceAttributesElement(Atom atom, IndirectObject host)
CalGrayColorSpaceAttributesElement(IndirectObject obj)
CalGrayColorSpaceAttributesElement(Element relation, CreationOptions options)
```
...
```
CalGrayColorSpaceAttributesElement()
CalGrayColorSpaceAttributesElement(atom As Atom, host As IndirectObject)
CalGrayColorSpaceAttributesElement(obj As IndirectObject)
CalGrayColorSpaceAttributesElement(relation As Element, options As CreationOptions)
```
