...
```csharp
Type2PatternElement()
Type2PatternElement(Atom atom, IndirectObject host)
Type2PatternElement(IndirectObject obj)
Type2PatternElement(Element relation, CreationOptions options)
```
...
```
Type2PatternElement()
Type2PatternElement(atom As Atom, host As IndirectObject)
Type2PatternElement(obj As IndirectObject)
Type2PatternElement(relation As Element, options As CreationOptions)
```
