...
```csharp
AlternateImageElement()
AlternateImageElement(Atom atom, IndirectObject host)
AlternateImageElement(IndirectObject obj)
AlternateImageElement(Element relation, CreationOptions options)
```
...
```
AlternateImageElement()
AlternateImageElement(atom As Atom, host As IndirectObject)
AlternateImageElement(obj As IndirectObject)
AlternateImageElement(relation As Element, options As CreationOptions)
```
