...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new CalGrayColorSpaceElement. |  |  | 
...
| **[C#]** ```csharp CalGrayColorSpaceElement() CalGrayColorSpaceElement(Atom atom, IndirectObject host) CalGrayColorSpaceElement(IndirectObject obj) CalGrayColorSpaceElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` CalGrayColorSpaceElement() CalGrayColorSpaceElement(atom As Atom, host As IndirectObject) CalGrayColorSpaceElement(obj As IndirectObject) CalGrayColorSpaceElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
