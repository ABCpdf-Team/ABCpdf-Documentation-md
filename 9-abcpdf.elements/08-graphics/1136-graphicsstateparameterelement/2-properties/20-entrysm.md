...
| --- | --- | --- | --- |
| **[C#]** ```csharp double? ``` [Visual Basic] `Double?` | null | No | Represents the "SM" entry of the graphics state parameter dictionary object. | 

## Notes

Represents the "SM" entry of the graphics state parameter dictionary object.
