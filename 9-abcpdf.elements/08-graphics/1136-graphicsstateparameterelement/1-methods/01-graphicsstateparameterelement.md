...
```csharp
GraphicsStateParameterElement()
GraphicsStateParameterElement(Atom atom, IndirectObject host)
GraphicsStateParameterElement(IndirectObject obj)
GraphicsStateParameterElement(Element relation, CreationOptions options)
```
...
```
GraphicsStateParameterElement()
GraphicsStateParameterElement(atom As Atom, host As IndirectObject)
GraphicsStateParameterElement(obj As IndirectObject)
GraphicsStateParameterElement(relation As Element, options As CreationOptions)
```
