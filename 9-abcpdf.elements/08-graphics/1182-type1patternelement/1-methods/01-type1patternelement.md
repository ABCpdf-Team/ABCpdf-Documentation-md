...
```csharp
<a href="../default.htm">Type1PatternElement</a>()<a href="../default.htm">Type1PatternElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">Type1PatternElement</a>(IndirectObject obj)<a href="../default.htm">Type1PatternElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">Type1PatternElement</a>()<a href="../default.htm">Type1PatternElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">Type1PatternElement</a>(obj As IndirectObject)<a href="../default.htm">Type1PatternElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
Create a new [Type1PatternElement](default.md).
