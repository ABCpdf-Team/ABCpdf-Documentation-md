...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new Type1PatternElement. |  |  | 
...
| **[C#]** ```csharp Type1PatternElement() Type1PatternElement(Atom atom, IndirectObject host) Type1PatternElement(IndirectObject obj) Type1PatternElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` Type1PatternElement() Type1PatternElement(atom As Atom, host As IndirectObject) Type1PatternElement(obj As IndirectObject) Type1PatternElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
