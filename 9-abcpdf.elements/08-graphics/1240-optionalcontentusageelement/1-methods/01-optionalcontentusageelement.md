...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new OptionalContentUsageElement. |  |  | 
...
| **[C#]** ```csharp OptionalContentUsageElement() OptionalContentUsageElement(Atom atom, IndirectObject host) OptionalContentUsageElement(IndirectObject obj) OptionalContentUsageElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` OptionalContentUsageElement() OptionalContentUsageElement(atom As Atom, host As IndirectObject) OptionalContentUsageElement(obj As IndirectObject) OptionalContentUsageElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
