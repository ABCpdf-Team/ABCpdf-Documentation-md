...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new LabColorSpaceAttributesElement. |  |  | 
...
| **[C#]** ```csharp LabColorSpaceAttributesElement() LabColorSpaceAttributesElement(Atom atom, IndirectObject host) LabColorSpaceAttributesElement(IndirectObject obj) LabColorSpaceAttributesElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` LabColorSpaceAttributesElement() LabColorSpaceAttributesElement(atom As Atom, host As IndirectObject) LabColorSpaceAttributesElement(obj As IndirectObject) LabColorSpaceAttributesElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
