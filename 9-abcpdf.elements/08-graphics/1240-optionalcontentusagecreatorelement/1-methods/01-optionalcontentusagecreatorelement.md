---
title: "01-optionalcontentusagecreatorelement"
css: "abcpdf-docs.css"
---
...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new OptionalContentUsageCreatorElement. |  |  | 
...
| **[C#]** ```csharp OptionalContentUsageCreatorElement() OptionalContentUsageCreatorElement(Atom atom, IndirectObject host) OptionalContentUsageCreatorElement(IndirectObject obj) OptionalContentUsageCreatorElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` OptionalContentUsageCreatorElement() OptionalContentUsageCreatorElement(atom As Atom, host As IndirectObject) OptionalContentUsageCreatorElement(obj As IndirectObject) OptionalContentUsageCreatorElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
