# CalRGBColorSpaceAttributesElement Function
...
```csharp
<a href="../default.htm">CalRGBColorSpaceAttributesElement</a>()<a href="../default.htm">CalRGBColorSpaceAttributesElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">CalRGBColorSpaceAttributesElement</a>(IndirectObject obj)<a href="../default.htm">CalRGBColorSpaceAttributesElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">CalRGBColorSpaceAttributesElement</a>()<a href="../default.htm">CalRGBColorSpaceAttributesElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">CalRGBColorSpaceAttributesElement</a>(obj As IndirectObject)<a href="../default.htm">CalRGBColorSpaceAttributesElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
Create a new [CalRGBColorSpaceAttributesElement](default.md).
