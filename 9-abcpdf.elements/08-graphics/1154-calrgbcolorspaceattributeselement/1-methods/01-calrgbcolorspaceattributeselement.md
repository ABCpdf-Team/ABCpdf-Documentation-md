---
title: "01-calrgbcolorspaceattributeselement"
css: "abcpdf-docs.css"
---
...
```csharp
CalRGBColorSpaceAttributesElement()
CalRGBColorSpaceAttributesElement(Atom atom, IndirectObject host)
CalRGBColorSpaceAttributesElement(IndirectObject obj)
CalRGBColorSpaceAttributesElement(Element relation, CreationOptions options)
```
...
```
CalRGBColorSpaceAttributesElement()
CalRGBColorSpaceAttributesElement(atom As Atom, host As IndirectObject)
CalRGBColorSpaceAttributesElement(obj As IndirectObject)
CalRGBColorSpaceAttributesElement(relation As Element, options As CreationOptions)
```
