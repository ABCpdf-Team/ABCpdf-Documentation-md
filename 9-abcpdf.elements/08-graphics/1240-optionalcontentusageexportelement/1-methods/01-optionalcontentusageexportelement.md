...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new OptionalContentUsageExportElement. |  |  | 
...
| **[C#]** ```csharp OptionalContentUsageExportElement() OptionalContentUsageExportElement(Atom atom, IndirectObject host) OptionalContentUsageExportElement(IndirectObject obj) OptionalContentUsageExportElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` OptionalContentUsageExportElement() OptionalContentUsageExportElement(atom As Atom, host As IndirectObject) OptionalContentUsageExportElement(obj As IndirectObject) OptionalContentUsageExportElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
