...
```csharp
DeviceNColorSpaceAttributesElement()
DeviceNColorSpaceAttributesElement(Atom atom, IndirectObject host)
DeviceNColorSpaceAttributesElement(IndirectObject obj)
DeviceNColorSpaceAttributesElement(Element relation, CreationOptions options)
```
...
```
DeviceNColorSpaceAttributesElement()
DeviceNColorSpaceAttributesElement(atom As Atom, host As IndirectObject)
DeviceNColorSpaceAttributesElement(obj As IndirectObject)
DeviceNColorSpaceAttributesElement(relation As Element, options As CreationOptions)
```
