---
title: "01-devicencolorspaceattributeselement"
css: "abcpdf-docs.css"
---
...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new DeviceNColorSpaceAttributesElement. |  |  | 
...
| **[C#]** ```csharp DeviceNColorSpaceAttributesElement() DeviceNColorSpaceAttributesElement(Atom atom, IndirectObject host) DeviceNColorSpaceAttributesElement(IndirectObject obj) DeviceNColorSpaceAttributesElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` DeviceNColorSpaceAttributesElement() DeviceNColorSpaceAttributesElement(atom As Atom, host As IndirectObject) DeviceNColorSpaceAttributesElement(obj As IndirectObject) DeviceNColorSpaceAttributesElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
