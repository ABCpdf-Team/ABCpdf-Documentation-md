...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new OptionalContentConfigElement. |  |  | 
...
| **[C#]** ```csharp OptionalContentConfigElement() OptionalContentConfigElement(Atom atom, IndirectObject host) OptionalContentConfigElement(IndirectObject obj) OptionalContentConfigElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` OptionalContentConfigElement() OptionalContentConfigElement(atom As Atom, host As IndirectObject) OptionalContentConfigElement(obj As IndirectObject) OptionalContentConfigElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
