...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new OptionalContentUsagePrintElement. |  |  | 
...
| **[C#]** ```csharp OptionalContentUsagePrintElement() OptionalContentUsagePrintElement(Atom atom, IndirectObject host) OptionalContentUsagePrintElement(IndirectObject obj) OptionalContentUsagePrintElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` OptionalContentUsagePrintElement() OptionalContentUsagePrintElement(atom As Atom, host As IndirectObject) OptionalContentUsagePrintElement(obj As IndirectObject) OptionalContentUsagePrintElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
