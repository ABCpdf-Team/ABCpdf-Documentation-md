...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new DeviceColorSpaceElement. |  |  | 
...
| **[C#]** ```csharp DeviceColorSpaceElement() DeviceColorSpaceElement(Atom atom, IndirectObject host) DeviceColorSpaceElement(IndirectObject obj) DeviceColorSpaceElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` DeviceColorSpaceElement() DeviceColorSpaceElement(atom As Atom, host As IndirectObject) DeviceColorSpaceElement(obj As IndirectObject) DeviceColorSpaceElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
