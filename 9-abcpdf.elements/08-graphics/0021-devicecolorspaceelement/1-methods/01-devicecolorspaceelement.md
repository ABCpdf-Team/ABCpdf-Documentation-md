...
```csharp
DeviceColorSpaceElement()
DeviceColorSpaceElement(Atom atom, IndirectObject host)
DeviceColorSpaceElement(IndirectObject obj)
DeviceColorSpaceElement(Element relation, CreationOptions options)
```
...
```
DeviceColorSpaceElement()
DeviceColorSpaceElement(atom As Atom, host As IndirectObject)
DeviceColorSpaceElement(obj As IndirectObject)
DeviceColorSpaceElement(relation As Element, options As CreationOptions)
```
