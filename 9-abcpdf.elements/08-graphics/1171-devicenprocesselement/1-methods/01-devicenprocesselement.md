...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new DeviceNProcessElement. |  |  | 
...
| **[C#]** ```csharp DeviceNProcessElement() DeviceNProcessElement(Atom atom, IndirectObject host) DeviceNProcessElement(IndirectObject obj) DeviceNProcessElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` DeviceNProcessElement() DeviceNProcessElement(atom As Atom, host As IndirectObject) DeviceNProcessElement(obj As IndirectObject) DeviceNProcessElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
