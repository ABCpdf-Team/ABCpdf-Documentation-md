...
```csharp
DeviceNProcessElement()
DeviceNProcessElement(Atom atom, IndirectObject host)
DeviceNProcessElement(IndirectObject obj)
DeviceNProcessElement(Element relation, CreationOptions options)
```
...
```
DeviceNProcessElement()
DeviceNProcessElement(atom As Atom, host As IndirectObject)
DeviceNProcessElement(obj As IndirectObject)
DeviceNProcessElement(relation As Element, options As CreationOptions)
```
