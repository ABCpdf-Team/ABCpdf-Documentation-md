...
| **[C#]** ```csharp XObjectElement() XObjectElement(Atom atom, IndirectObject host) XObjectElement(IndirectObject obj) XObjectElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` XObjectElement() XObjectElement(atom As Atom, host As IndirectObject) XObjectElement(obj As IndirectObject) XObjectElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
