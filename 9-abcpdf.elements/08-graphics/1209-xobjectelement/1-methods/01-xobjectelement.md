...
```csharp
XObjectElement()
XObjectElement(Atom atom, IndirectObject host)
XObjectElement(IndirectObject obj)
XObjectElement(Element relation, CreationOptions options)
```
...
```
XObjectElement()
XObjectElement(atom As Atom, host As IndirectObject)
XObjectElement(obj As IndirectObject)
XObjectElement(relation As Element, options As CreationOptions)
```
