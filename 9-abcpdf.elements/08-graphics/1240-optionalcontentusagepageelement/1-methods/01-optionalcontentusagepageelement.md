...
```csharp
OptionalContentUsagePageElement()
OptionalContentUsagePageElement(Atom atom, IndirectObject host)
OptionalContentUsagePageElement(IndirectObject obj)
OptionalContentUsagePageElement(Element relation, CreationOptions options)
```
...
```
OptionalContentUsagePageElement()
OptionalContentUsagePageElement(atom As Atom, host As IndirectObject)
OptionalContentUsagePageElement(obj As IndirectObject)
OptionalContentUsagePageElement(relation As Element, options As CreationOptions)
```
