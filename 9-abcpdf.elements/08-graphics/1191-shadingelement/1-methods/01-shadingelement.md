...
| **[C#]** ```csharp ShadingElement() ShadingElement(Atom atom, IndirectObject host) ShadingElement(IndirectObject obj) ShadingElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` ShadingElement() ShadingElement(atom As Atom, host As IndirectObject) ShadingElement(obj As IndirectObject) ShadingElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
