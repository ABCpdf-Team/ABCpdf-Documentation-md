...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new PatternColorSpaceElement. |  |  | 
...
| **[C#]** ```csharp PatternColorSpaceElement() PatternColorSpaceElement(Atom atom, IndirectObject host) PatternColorSpaceElement(IndirectObject obj) PatternColorSpaceElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` PatternColorSpaceElement() PatternColorSpaceElement(atom As Atom, host As IndirectObject) PatternColorSpaceElement(obj As IndirectObject) PatternColorSpaceElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
