...
```csharp
ICCBasedColorSpaceElement()
ICCBasedColorSpaceElement(Atom atom, IndirectObject host)
ICCBasedColorSpaceElement(IndirectObject obj)
ICCBasedColorSpaceElement(Element relation, CreationOptions options)
```
...
```
ICCBasedColorSpaceElement()
ICCBasedColorSpaceElement(atom As Atom, host As IndirectObject)
ICCBasedColorSpaceElement(obj As IndirectObject)
ICCBasedColorSpaceElement(relation As Element, options As CreationOptions)
```
