...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new ColorSpaceElement. |  |  | 
...
| **[C#]** ```csharp ColorSpaceElement() ColorSpaceElement(Atom atom, IndirectObject host) ColorSpaceElement(IndirectObject obj) ColorSpaceElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` ColorSpaceElement() ColorSpaceElement(atom As Atom, host As IndirectObject) ColorSpaceElement(obj As IndirectObject) ColorSpaceElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
