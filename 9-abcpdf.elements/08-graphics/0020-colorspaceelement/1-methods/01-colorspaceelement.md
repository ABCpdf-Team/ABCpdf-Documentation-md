...
```csharp
ColorSpaceElement()
ColorSpaceElement(Atom atom, IndirectObject host)
ColorSpaceElement(IndirectObject obj)
ColorSpaceElement(Element relation, CreationOptions options)
```
...
```
ColorSpaceElement()
ColorSpaceElement(atom As Atom, host As IndirectObject)
ColorSpaceElement(obj As IndirectObject)
ColorSpaceElement(relation As Element, options As CreationOptions)
```
