...
```csharp
CalRGBColorSpaceElement()
CalRGBColorSpaceElement(Atom atom, IndirectObject host)
CalRGBColorSpaceElement(IndirectObject obj)
CalRGBColorSpaceElement(Element relation, CreationOptions options)
```
...
```
CalRGBColorSpaceElement()
CalRGBColorSpaceElement(atom As Atom, host As IndirectObject)
CalRGBColorSpaceElement(obj As IndirectObject)
CalRGBColorSpaceElement(relation As Element, options As CreationOptions)
```
