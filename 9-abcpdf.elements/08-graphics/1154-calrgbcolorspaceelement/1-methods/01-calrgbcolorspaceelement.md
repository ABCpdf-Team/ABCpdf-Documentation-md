...
```csharp
<a href="../default.htm">CalRGBColorSpaceElement</a>()<a href="../default.htm">CalRGBColorSpaceElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">CalRGBColorSpaceElement</a>(IndirectObject obj)<a href="../default.htm">CalRGBColorSpaceElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">CalRGBColorSpaceElement</a>()<a href="../default.htm">CalRGBColorSpaceElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">CalRGBColorSpaceElement</a>(obj As IndirectObject)<a href="../default.htm">CalRGBColorSpaceElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
