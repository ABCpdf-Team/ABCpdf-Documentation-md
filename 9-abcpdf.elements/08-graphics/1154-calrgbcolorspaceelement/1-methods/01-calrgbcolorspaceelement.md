...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new CalRGBColorSpaceElement. |  |  | 
...
| **[C#]** ```csharp CalRGBColorSpaceElement() CalRGBColorSpaceElement(Atom atom, IndirectObject host) CalRGBColorSpaceElement(IndirectObject obj) CalRGBColorSpaceElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` CalRGBColorSpaceElement() CalRGBColorSpaceElement(atom As Atom, host As IndirectObject) CalRGBColorSpaceElement(obj As IndirectObject) CalRGBColorSpaceElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
