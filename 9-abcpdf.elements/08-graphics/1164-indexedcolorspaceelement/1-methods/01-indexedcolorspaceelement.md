...
```csharp
IndexedColorSpaceElement()
IndexedColorSpaceElement(Atom atom, IndirectObject host)
IndexedColorSpaceElement(IndirectObject obj)
IndexedColorSpaceElement(Element relation, CreationOptions options)
```
...
```
IndexedColorSpaceElement()
IndexedColorSpaceElement(atom As Atom, host As IndirectObject)
IndexedColorSpaceElement(obj As IndirectObject)
IndexedColorSpaceElement(relation As Element, options As CreationOptions)
```
