...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new Type1ShadingElement. |  |  | 
...
| **[C#]** ```csharp Type1ShadingElement() Type1ShadingElement(Atom atom, IndirectObject host) Type1ShadingElement(IndirectObject obj) Type1ShadingElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` Type1ShadingElement() Type1ShadingElement(atom As Atom, host As IndirectObject) Type1ShadingElement(obj As IndirectObject) Type1ShadingElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
