...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new OptionalContentGroupElement. |  |  | 
...
| **[C#]** ```csharp OptionalContentGroupElement() OptionalContentGroupElement(Atom atom, IndirectObject host) OptionalContentGroupElement(IndirectObject obj) OptionalContentGroupElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` OptionalContentGroupElement() OptionalContentGroupElement(atom As Atom, host As IndirectObject) OptionalContentGroupElement(obj As IndirectObject) OptionalContentGroupElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
