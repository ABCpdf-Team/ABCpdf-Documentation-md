...
| --- | --- | --- | --- |
| **[C#]** ```csharp string ``` [Visual Basic] `string` | null | No | Represents the "Name" entry of the optional content group dictionary object. | 

## Notes

Represents the "Name" entry of the optional content group dictionary object.
