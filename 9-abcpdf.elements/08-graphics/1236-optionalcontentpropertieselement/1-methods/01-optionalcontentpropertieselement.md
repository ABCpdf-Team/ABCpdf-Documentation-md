...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new OptionalContentPropertiesElement. |  |  | 
...
| **[C#]** ```csharp OptionalContentPropertiesElement() OptionalContentPropertiesElement(Atom atom, IndirectObject host) OptionalContentPropertiesElement(IndirectObject obj) OptionalContentPropertiesElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` OptionalContentPropertiesElement() OptionalContentPropertiesElement(atom As Atom, host As IndirectObject) OptionalContentPropertiesElement(obj As IndirectObject) OptionalContentPropertiesElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
