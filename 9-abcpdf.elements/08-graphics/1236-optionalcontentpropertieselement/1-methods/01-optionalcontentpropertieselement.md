...
```csharp
OptionalContentPropertiesElement()
OptionalContentPropertiesElement(Atom atom, IndirectObject host)
OptionalContentPropertiesElement(IndirectObject obj)
OptionalContentPropertiesElement(Element relation, CreationOptions options)
```
...
```
OptionalContentPropertiesElement()
OptionalContentPropertiesElement(atom As Atom, host As IndirectObject)
OptionalContentPropertiesElement(obj As IndirectObject)
OptionalContentPropertiesElement(relation As Element, options As CreationOptions)
```
