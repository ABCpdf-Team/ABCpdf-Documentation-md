...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new DeviceNMixingHintsElement. |  |  | 
...
| **[C#]** ```csharp DeviceNMixingHintsElement() DeviceNMixingHintsElement(Atom atom, IndirectObject host) DeviceNMixingHintsElement(IndirectObject obj) DeviceNMixingHintsElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` DeviceNMixingHintsElement() DeviceNMixingHintsElement(atom As Atom, host As IndirectObject) DeviceNMixingHintsElement(obj As IndirectObject) DeviceNMixingHintsElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
