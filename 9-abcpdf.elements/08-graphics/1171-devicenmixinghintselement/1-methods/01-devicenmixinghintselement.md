...
```csharp
DeviceNMixingHintsElement()
DeviceNMixingHintsElement(Atom atom, IndirectObject host)
DeviceNMixingHintsElement(IndirectObject obj)
DeviceNMixingHintsElement(Element relation, CreationOptions options)
```
...
```
DeviceNMixingHintsElement()
DeviceNMixingHintsElement(atom As Atom, host As IndirectObject)
DeviceNMixingHintsElement(obj As IndirectObject)
DeviceNMixingHintsElement(relation As Element, options As CreationOptions)
```
