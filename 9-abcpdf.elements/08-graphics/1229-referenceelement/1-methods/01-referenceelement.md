...
```csharp
ReferenceElement()
ReferenceElement(Atom atom, IndirectObject host)
ReferenceElement(IndirectObject obj)
ReferenceElement(Element relation, CreationOptions options)
```
...
```
ReferenceElement()
ReferenceElement(atom As Atom, host As IndirectObject)
ReferenceElement(obj As IndirectObject)
ReferenceElement(relation As Element, options As CreationOptions)
```
