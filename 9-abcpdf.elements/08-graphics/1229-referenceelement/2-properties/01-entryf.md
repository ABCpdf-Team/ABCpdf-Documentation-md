...
| --- | --- | --- | --- |
| **[C#]** ```csharp FileSpecificationElement ``` [Visual Basic] `FileSpecificationElement` | null | No | Represents the "F" entry of the reference dictionary object. | 

## Notes

Represents the "F" entry of the reference dictionary object.
