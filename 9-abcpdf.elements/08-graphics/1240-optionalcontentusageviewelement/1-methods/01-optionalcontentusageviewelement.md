---
title: "01-optionalcontentusageviewelement"
css: "abcpdf-docs.css"
---
...
```csharp
OptionalContentUsageViewElement()
OptionalContentUsageViewElement(Atom atom, IndirectObject host)
OptionalContentUsageViewElement(IndirectObject obj)
OptionalContentUsageViewElement(Element relation, CreationOptions options)
```
...
```
OptionalContentUsageViewElement()
OptionalContentUsageViewElement(atom As Atom, host As IndirectObject)
OptionalContentUsageViewElement(obj As IndirectObject)
OptionalContentUsageViewElement(relation As Element, options As CreationOptions)
```
