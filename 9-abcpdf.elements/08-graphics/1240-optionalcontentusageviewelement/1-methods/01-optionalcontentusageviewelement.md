...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new OptionalContentUsageViewElement. |  |  | 
...
| **[C#]** ```csharp OptionalContentUsageViewElement() OptionalContentUsageViewElement(Atom atom, IndirectObject host) OptionalContentUsageViewElement(IndirectObject obj) OptionalContentUsageViewElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` OptionalContentUsageViewElement() OptionalContentUsageViewElement(atom As Atom, host As IndirectObject) OptionalContentUsageViewElement(obj As IndirectObject) OptionalContentUsageViewElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
