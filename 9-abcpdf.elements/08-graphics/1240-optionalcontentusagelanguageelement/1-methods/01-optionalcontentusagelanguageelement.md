...
```csharp
OptionalContentUsageLanguageElement()
OptionalContentUsageLanguageElement(Atom atom, IndirectObject host)
OptionalContentUsageLanguageElement(IndirectObject obj)
OptionalContentUsageLanguageElement(Element relation, CreationOptions options)
```
...
```
OptionalContentUsageLanguageElement()
OptionalContentUsageLanguageElement(atom As Atom, host As IndirectObject)
OptionalContentUsageLanguageElement(obj As IndirectObject)
OptionalContentUsageLanguageElement(relation As Element, options As CreationOptions)
```
