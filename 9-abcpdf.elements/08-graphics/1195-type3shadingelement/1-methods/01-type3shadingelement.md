...
```csharp
Type3ShadingElement()
Type3ShadingElement(Atom atom, IndirectObject host)
Type3ShadingElement(IndirectObject obj)
Type3ShadingElement(Element relation, CreationOptions options)
```
...
```
Type3ShadingElement()
Type3ShadingElement(atom As Atom, host As IndirectObject)
Type3ShadingElement(obj As IndirectObject)
Type3ShadingElement(relation As Element, options As CreationOptions)
```
