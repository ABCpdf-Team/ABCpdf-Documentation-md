...
| **[C#]** ```csharp HalftoneElement() HalftoneElement(Atom atom, IndirectObject host) HalftoneElement(IndirectObject obj) HalftoneElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` HalftoneElement() HalftoneElement(atom As Atom, host As IndirectObject) HalftoneElement(obj As IndirectObject) HalftoneElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
