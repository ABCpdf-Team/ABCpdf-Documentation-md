...
```csharp
Type10HalftoneElement()
Type10HalftoneElement(Atom atom, IndirectObject host)
Type10HalftoneElement(IndirectObject obj)
Type10HalftoneElement(Element relation, CreationOptions options)
```
...
```
Type10HalftoneElement()
Type10HalftoneElement(atom As Atom, host As IndirectObject)
Type10HalftoneElement(obj As IndirectObject)
Type10HalftoneElement(relation As Element, options As CreationOptions)
```
