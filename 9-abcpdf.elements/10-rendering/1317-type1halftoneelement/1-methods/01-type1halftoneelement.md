...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new Type1HalftoneElement. |  |  | 
...
| **[C#]** ```csharp Type1HalftoneElement() Type1HalftoneElement(Atom atom, IndirectObject host) Type1HalftoneElement(IndirectObject obj) Type1HalftoneElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` Type1HalftoneElement() Type1HalftoneElement(atom As Atom, host As IndirectObject) Type1HalftoneElement(obj As IndirectObject) Type1HalftoneElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
