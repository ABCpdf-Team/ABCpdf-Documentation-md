...
```csharp
<a href="../default.htm">Type1HalftoneElement</a>()<a href="../default.htm">Type1HalftoneElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">Type1HalftoneElement</a>(IndirectObject obj)<a href="../default.htm">Type1HalftoneElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">Type1HalftoneElement</a>()<a href="../default.htm">Type1HalftoneElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">Type1HalftoneElement</a>(obj As IndirectObject)<a href="../default.htm">Type1HalftoneElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
Create a new [Type1HalftoneElement](default.md).
