...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new Type5HalftoneElement. |  |  | 
...
| **[C#]** ```csharp Type5HalftoneElement() Type5HalftoneElement(Atom atom, IndirectObject host) Type5HalftoneElement(IndirectObject obj) Type5HalftoneElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` Type5HalftoneElement() Type5HalftoneElement(atom As Atom, host As IndirectObject) Type5HalftoneElement(obj As IndirectObject) Type5HalftoneElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
