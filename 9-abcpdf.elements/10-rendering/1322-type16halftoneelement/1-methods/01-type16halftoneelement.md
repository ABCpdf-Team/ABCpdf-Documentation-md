...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new Type16HalftoneElement. |  |  | 
...
| **[C#]** ```csharp Type16HalftoneElement() Type16HalftoneElement(Atom atom, IndirectObject host) Type16HalftoneElement(IndirectObject obj) Type16HalftoneElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` Type16HalftoneElement() Type16HalftoneElement(atom As Atom, host As IndirectObject) Type16HalftoneElement(obj As IndirectObject) Type16HalftoneElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
