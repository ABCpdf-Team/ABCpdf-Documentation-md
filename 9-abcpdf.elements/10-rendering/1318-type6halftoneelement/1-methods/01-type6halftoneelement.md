...
```csharp
<a href="../default.htm">Type6HalftoneElement</a>()<a href="../default.htm">Type6HalftoneElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">Type6HalftoneElement</a>(IndirectObject obj)<a href="../default.htm">Type6HalftoneElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">Type6HalftoneElement</a>()<a href="../default.htm">Type6HalftoneElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">Type6HalftoneElement</a>(obj As IndirectObject)<a href="../default.htm">Type6HalftoneElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
Create a new [Type6HalftoneElement](default.md).
