...
```csharp
Type6HalftoneElement()
Type6HalftoneElement(Atom atom, IndirectObject host)
Type6HalftoneElement(IndirectObject obj)
Type6HalftoneElement(Element relation, CreationOptions options)
```
...
```
Type6HalftoneElement()
Type6HalftoneElement(atom As Atom, host As IndirectObject)
Type6HalftoneElement(obj As IndirectObject)
Type6HalftoneElement(relation As Element, options As CreationOptions)
```
