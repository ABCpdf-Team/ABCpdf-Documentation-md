...
```csharp
SignatureFieldTimeStampElement()
SignatureFieldTimeStampElement(Atom atom, IndirectObject host)
SignatureFieldTimeStampElement(IndirectObject obj)
SignatureFieldTimeStampElement(Element relation, CreationOptions options)
```
...
```
SignatureFieldTimeStampElement()
SignatureFieldTimeStampElement(atom As Atom, host As IndirectObject)
SignatureFieldTimeStampElement(obj As IndirectObject)
SignatureFieldTimeStampElement(relation As Element, options As CreationOptions)
```
