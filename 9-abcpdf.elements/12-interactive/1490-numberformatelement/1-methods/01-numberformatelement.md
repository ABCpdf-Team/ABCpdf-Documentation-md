...
```csharp
NumberFormatElement()
NumberFormatElement(Atom atom, IndirectObject host)
NumberFormatElement(IndirectObject obj)
NumberFormatElement(Element relation, CreationOptions options)
```
...
```
NumberFormatElement()
NumberFormatElement(atom As Atom, host As IndirectObject)
NumberFormatElement(obj As IndirectObject)
NumberFormatElement(relation As Element, options As CreationOptions)
```
