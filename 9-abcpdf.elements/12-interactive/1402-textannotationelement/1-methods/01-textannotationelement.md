...
```vb
<a href="../default.htm">TextAnnotationElement</a>()<a href="../default.htm">TextAnnotationElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">TextAnnotationElement</a>(obj As IndirectObject)<a href="../default.htm">TextAnnotationElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
