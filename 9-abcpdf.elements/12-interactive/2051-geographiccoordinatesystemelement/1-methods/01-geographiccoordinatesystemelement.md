...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new GeographicCoordinateSystemElement. |  |  | 
...
| **[C#]** ```csharp GeographicCoordinateSystemElement() GeographicCoordinateSystemElement(Atom atom, IndirectObject host) GeographicCoordinateSystemElement(IndirectObject obj) GeographicCoordinateSystemElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` GeographicCoordinateSystemElement() GeographicCoordinateSystemElement(atom As Atom, host As IndirectObject) GeographicCoordinateSystemElement(obj As IndirectObject) GeographicCoordinateSystemElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
