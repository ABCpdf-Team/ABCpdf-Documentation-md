...
| **[C#]** ```csharp TargetElement() TargetElement(Atom atom, IndirectObject host) TargetElement(IndirectObject obj) TargetElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` TargetElement() TargetElement(atom As Atom, host As IndirectObject) TargetElement(obj As IndirectObject) TargetElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
