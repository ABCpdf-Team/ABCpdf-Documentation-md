...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new CollectionElement. |  |  | 
...
| **[C#]** ```csharp CollectionElement() CollectionElement(Atom atom, IndirectObject host) CollectionElement(IndirectObject obj) CollectionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` CollectionElement() CollectionElement(atom As Atom, host As IndirectObject) CollectionElement(obj As IndirectObject) CollectionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
