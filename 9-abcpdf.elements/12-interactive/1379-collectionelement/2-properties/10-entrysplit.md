...
| --- | --- | --- | --- |
| **[C#]** ```csharp CollectionSplitElement ``` [Visual Basic] `CollectionSplitElement` | null | No | Represents the "Split" entry of the collection dictionary object. | 

## Notes

Represents the "Split" entry of the collection dictionary object.

It is an optional entry defined as part of the PDF 1.7 Extension Level 3 specification.

It contains a [CollectionSplitElement](../../2031-collectionsplitelement/default.md).
