...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new CatalogUriElement. |  |  | 
...
| **[C#]** ```csharp CatalogUriElement() CatalogUriElement(Atom atom, IndirectObject host) CatalogUriElement(IndirectObject obj) CatalogUriElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` CatalogUriElement() CatalogUriElement(atom As Atom, host As IndirectObject) CatalogUriElement(obj As IndirectObject) CatalogUriElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
