...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new RequirementElement. |  |  | 
...
| **[C#]** ```csharp RequirementElement() RequirementElement(Atom atom, IndirectObject host) RequirementElement(IndirectObject obj) RequirementElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` RequirementElement() RequirementElement(atom As Atom, host As IndirectObject) RequirementElement(obj As IndirectObject) RequirementElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
