...
```vb
<a href="../default.htm">RichMediaInstanceElement</a>()<a href="../default.htm">RichMediaInstanceElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">RichMediaInstanceElement</a>(obj As IndirectObject)<a href="../default.htm">RichMediaInstanceElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
