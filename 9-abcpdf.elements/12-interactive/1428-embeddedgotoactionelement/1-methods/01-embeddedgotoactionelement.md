...
EmbeddedGoToActionElement(Atom atom, IndirectObject host)
EmbeddedGoToActionElement(IndirectObject obj)
EmbeddedGoToActionElement(Element relation, CreationOptions options)
```
...
```
EmbeddedGoToActionElement()
EmbeddedGoToActionElement(atom As Atom, host As IndirectObject)
EmbeddedGoToActionElement(obj As IndirectObject)
EmbeddedGoToActionElement(relation As Element, options As CreationOptions)
```
