...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new EmbeddedGoToActionElement. |  |  | 
...
| **[C#]** ```csharp EmbeddedGoToActionElement() EmbeddedGoToActionElement(Atom atom, IndirectObject host) EmbeddedGoToActionElement(IndirectObject obj) EmbeddedGoToActionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` EmbeddedGoToActionElement() EmbeddedGoToActionElement(atom As Atom, host As IndirectObject) EmbeddedGoToActionElement(obj As IndirectObject) EmbeddedGoToActionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
