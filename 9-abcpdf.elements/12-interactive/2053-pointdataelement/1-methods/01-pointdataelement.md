...
| **[C#]** ```csharp PointDataElement() PointDataElement(Atom atom, IndirectObject host) PointDataElement(IndirectObject obj) PointDataElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` PointDataElement() PointDataElement(atom As Atom, host As IndirectObject) PointDataElement(obj As IndirectObject) PointDataElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
