...
| --- | --- | --- | --- |
| **[C#]** ```csharp string ``` [Visual Basic] `string` | null | No | Represents the "Subtype" entry of the point data dictionary object. | 

## Notes

Represents the "Subtype" entry of the point data dictionary object.
...
This item must always be provided and must always take the value "Cloud".
