...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new GoTo3DViewActionElement. |  |  | 
...
| **[C#]** ```csharp GoTo3DViewActionElement() GoTo3DViewActionElement(Atom atom, IndirectObject host) GoTo3DViewActionElement(IndirectObject obj) GoTo3DViewActionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` GoTo3DViewActionElement() GoTo3DViewActionElement(atom As Atom, host As IndirectObject) GoTo3DViewActionElement(obj As IndirectObject) GoTo3DViewActionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
