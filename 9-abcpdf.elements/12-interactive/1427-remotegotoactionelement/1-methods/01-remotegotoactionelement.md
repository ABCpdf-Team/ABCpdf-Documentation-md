...
```csharp
RemoteGoToActionElement()
RemoteGoToActionElement(Atom atom, IndirectObject host)
RemoteGoToActionElement(IndirectObject obj)
RemoteGoToActionElement(Element relation, CreationOptions options)
```
...
```
RemoteGoToActionElement()
RemoteGoToActionElement(atom As Atom, host As IndirectObject)
RemoteGoToActionElement(obj As IndirectObject)
RemoteGoToActionElement(relation As Element, options As CreationOptions)
```
