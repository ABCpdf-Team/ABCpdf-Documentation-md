...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new ViewerPreferencesElement. |  |  | 
...
| **[C#]** ```csharp ViewerPreferencesElement() ViewerPreferencesElement(Atom atom, IndirectObject host) ViewerPreferencesElement(IndirectObject obj) ViewerPreferencesElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` ViewerPreferencesElement() ViewerPreferencesElement(atom As Atom, host As IndirectObject) ViewerPreferencesElement(obj As IndirectObject) ViewerPreferencesElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
