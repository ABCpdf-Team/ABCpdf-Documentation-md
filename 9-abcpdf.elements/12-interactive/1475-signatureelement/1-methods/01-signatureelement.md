...
```csharp
<a href="../default.htm">SignatureElement</a>()<a href="../default.htm">SignatureElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">SignatureElement</a>(IndirectObject obj)<a href="../default.htm">SignatureElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">SignatureElement</a>()<a href="../default.htm">SignatureElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">SignatureElement</a>(obj As IndirectObject)<a href="../default.htm">SignatureElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
Create a new [SignatureElement](default.md).
...
<a href="../default.htm">SignatureElement</a> signature = new <a href="../default.htm">SignatureElement</a>(Doc.ObjectSoup[sigDictID]);
if (inLocked) {
