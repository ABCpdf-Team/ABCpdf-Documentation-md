...
```csharp
SignatureElement()
SignatureElement(Atom atom, IndirectObject host)
SignatureElement(IndirectObject obj)
SignatureElement(Element relation, CreationOptions options)
```
...
```
SignatureElement()
SignatureElement(atom As Atom, host As IndirectObject)
SignatureElement(obj As IndirectObject)
SignatureElement(relation As Element, options As CreationOptions)
```
