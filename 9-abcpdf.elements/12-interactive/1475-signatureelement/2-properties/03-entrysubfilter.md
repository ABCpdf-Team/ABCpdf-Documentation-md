...
| --- | --- | --- | --- |
| **[C#]** ```csharp string ``` [Visual Basic] `string` | null | No | Represents the "SubFilter" entry of the signature dictionary object. | 

## Notes

Represents the "SubFilter" entry of the signature dictionary object.
