---
title: "08-entrychanges"
css: "abcpdf-docs.css"
---

# EntryChanges Property

| Type | Default Value | Read Only | Description | 
| --- | --- | --- | --- |
| **[C#]** ```csharp IList ``` [Visual Basic] `IList` | null | No | Represents the "Changes" entry of the signature dictionary object. | 

## Notes

Represents the "Changes" entry of the signature dictionary object.
