...
```csharp
OutlineItemElement()
OutlineItemElement(Atom atom, IndirectObject host)
OutlineItemElement(IndirectObject obj)
OutlineItemElement(Element relation, CreationOptions options)
```
...
```
OutlineItemElement()
OutlineItemElement(atom As Atom, host As IndirectObject)
OutlineItemElement(obj As IndirectObject)
OutlineItemElement(relation As Element, options As CreationOptions)
```
