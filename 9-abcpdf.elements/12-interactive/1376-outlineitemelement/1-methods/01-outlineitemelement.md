...
```csharp
<a href="../default.htm">OutlineItemElement</a>()<a href="../default.htm">OutlineItemElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">OutlineItemElement</a>(IndirectObject obj)<a href="../default.htm">OutlineItemElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">OutlineItemElement</a>()<a href="../default.htm">OutlineItemElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">OutlineItemElement</a>(obj As IndirectObject)<a href="../default.htm">OutlineItemElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
Create a new [OutlineItemElement](default.md).
