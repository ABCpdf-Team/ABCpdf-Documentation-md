...
| --- | --- | --- | --- |
| **[C#]** ```csharp string ``` [Visual Basic] `string` | null | No | Represents the "Title" entry of the outline item dictionary object. | 

## Notes

Represents the "Title" entry of the outline item dictionary object.
