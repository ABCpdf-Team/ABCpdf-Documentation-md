...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new RequirementHandlerElement. |  |  | 
...
| **[C#]** ```csharp RequirementHandlerElement() RequirementHandlerElement(Atom atom, IndirectObject host) RequirementHandlerElement(IndirectObject obj) RequirementHandlerElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` RequirementHandlerElement() RequirementHandlerElement(atom As Atom, host As IndirectObject) RequirementHandlerElement(obj As IndirectObject) RequirementHandlerElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
