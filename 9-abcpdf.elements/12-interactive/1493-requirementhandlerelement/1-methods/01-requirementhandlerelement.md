...
```csharp
RequirementHandlerElement()
RequirementHandlerElement(Atom atom, IndirectObject host)
RequirementHandlerElement(IndirectObject obj)
RequirementHandlerElement(Element relation, CreationOptions options)
```
...
```
RequirementHandlerElement()
RequirementHandlerElement(atom As Atom, host As IndirectObject)
RequirementHandlerElement(obj As IndirectObject)
RequirementHandlerElement(relation As Element, options As CreationOptions)
```
