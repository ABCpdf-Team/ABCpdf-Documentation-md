...
RubberStampAnnotationElement(Atom atom, IndirectObject host)
RubberStampAnnotationElement(IndirectObject obj)
RubberStampAnnotationElement(Element relation, CreationOptions options)
```
...
```
RubberStampAnnotationElement()
RubberStampAnnotationElement(atom As Atom, host As IndirectObject)
RubberStampAnnotationElement(obj As IndirectObject)
RubberStampAnnotationElement(relation As Element, options As CreationOptions)
```
...
RubberStampAnnotationElement annot = new RubberStampAnnotationElement(AnnotationElement.Object);
annot.EntrySubtype = "Stamp";
annot.EntryRect = new RectangleElement(ArrayAtom.FromXRect(xrect), annot.Host);
annot.EntryContents = caption;
annot.EntryAP = new AppearanceElement(annot);
annot.EntryAP.EntryN = new FormXObjectElement(formXObject);
