...
```csharp
<a href="../default.htm">RubberStampAnnotationElement</a>()<a href="../default.htm">RubberStampAnnotationElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">RubberStampAnnotationElement</a>(IndirectObject obj)<a href="../default.htm">RubberStampAnnotationElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">RubberStampAnnotationElement</a>()<a href="../default.htm">RubberStampAnnotationElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">RubberStampAnnotationElement</a>(obj As IndirectObject)<a href="../default.htm">RubberStampAnnotationElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
This code snippet is taken from Annotations.cs line 1370 in the Annotations example project.

[C#]

```csharp
double aspectRatio;
FormXObject formXObject = GenerateAppearanceStream(form.Doc, caption, color, out aspectRatio);
XRect xrect = new XRect(rect);
xrect.Width = xrect.Height * aspectRatio;
<a href="../default.htm">RubberStampAnnotationElement</a> annot = new <a href="../default.htm">RubberStampAnnotationElement</a>(AnnotationElement.Object);
annot.EntrySubtype = "Stamp";
annot.EntryRect = new <a href="../../../07-syntax/0017-rectangleelement/default.htm">RectangleElement</a>(ArrayAtom.FromXRect(xrect), annot.Host);
annot.EntryContents = caption;
annot.EntryAP = new <a href="../../1397-appearanceelement/default.htm">AppearanceElement</a>(annot);
annot.EntryAP.EntryN = new <a href="../../../08-graphics/1226-formxobjectelement/default.htm">FormXObjectElement</a>(formXObject);
