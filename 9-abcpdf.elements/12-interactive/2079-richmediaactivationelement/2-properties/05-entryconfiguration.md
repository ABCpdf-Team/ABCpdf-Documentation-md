...
Represents the "Configuration" entry of the richmediaactivation dictionary object.

It is an optional entry defined as part of the PDF 1.7 Extension Level 3 specification.

It contains a [RichMediaConfigElement](../../2088-richmediaconfigelement/default.md).
