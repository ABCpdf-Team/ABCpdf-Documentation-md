...
Represents the "Animation" entry of the richmediaactivation dictionary object.

It is an optional entry defined as part of the PDF 1.7 Extension Level 3 specification.

It contains a [RichMediaAnimationElement](../../2081-richmediaanimationelement/default.md).
