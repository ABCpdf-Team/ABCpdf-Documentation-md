...
```csharp
RichMediaActivationElement()
RichMediaActivationElement(Atom atom, IndirectObject host)
RichMediaActivationElement(IndirectObject obj)
RichMediaActivationElement(Element relation, CreationOptions options)
```
...
```
RichMediaActivationElement()
RichMediaActivationElement(atom As Atom, host As IndirectObject)
RichMediaActivationElement(obj As IndirectObject)
RichMediaActivationElement(relation As Element, options As CreationOptions)
```
