...
```csharp
<a href="../default.htm">RichMediaActivationElement</a>()<a href="../default.htm">RichMediaActivationElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">RichMediaActivationElement</a>(IndirectObject obj)<a href="../default.htm">RichMediaActivationElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">RichMediaActivationElement</a>()<a href="../default.htm">RichMediaActivationElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">RichMediaActivationElement</a>(obj As IndirectObject)<a href="../default.htm">RichMediaActivationElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
settings.EntryActivation = new <a href="../default.htm">RichMediaActivationElement</a>(annot);
