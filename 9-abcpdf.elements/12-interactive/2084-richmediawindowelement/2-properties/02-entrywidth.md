...
| **[C#]** ```csharp RichMediaDimensionsElement ``` [Visual Basic] `RichMediaDimensionsElement` | null | No | Represents the "Width" entry of the richmediawindow dictionary object. | 
