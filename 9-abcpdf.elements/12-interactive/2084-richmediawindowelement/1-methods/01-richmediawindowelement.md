...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new RichMediaWindowElement. |  |  | 
...
| **[C#]** ```csharp RichMediaWindowElement() RichMediaWindowElement(Atom atom, IndirectObject host) RichMediaWindowElement(IndirectObject obj) RichMediaWindowElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` RichMediaWindowElement() RichMediaWindowElement(atom As Atom, host As IndirectObject) RichMediaWindowElement(obj As IndirectObject) RichMediaWindowElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
