...
```csharp
CollectionSchemaElement()
CollectionSchemaElement(Atom atom, IndirectObject host)
CollectionSchemaElement(IndirectObject obj)
CollectionSchemaElement(Element relation, CreationOptions options)
```
...
```
CollectionSchemaElement()
CollectionSchemaElement(atom As Atom, host As IndirectObject)
CollectionSchemaElement(obj As IndirectObject)
CollectionSchemaElement(relation As Element, options As CreationOptions)
```
