...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new CollectionSchemaElement. |  |  | 
...
| **[C#]** ```csharp CollectionSchemaElement() CollectionSchemaElement(Atom atom, IndirectObject host) CollectionSchemaElement(IndirectObject obj) CollectionSchemaElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` CollectionSchemaElement() CollectionSchemaElement(atom As Atom, host As IndirectObject) CollectionSchemaElement(obj As IndirectObject) CollectionSchemaElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
