...
```csharp
FDFJavaScriptElement()
FDFJavaScriptElement(Atom atom, IndirectObject host)
FDFJavaScriptElement(IndirectObject obj)
FDFJavaScriptElement(Element relation, CreationOptions options)
```
...
```
FDFJavaScriptElement()
FDFJavaScriptElement(atom As Atom, host As IndirectObject)
FDFJavaScriptElement(obj As IndirectObject)
FDFJavaScriptElement(relation As Element, options As CreationOptions)
```
