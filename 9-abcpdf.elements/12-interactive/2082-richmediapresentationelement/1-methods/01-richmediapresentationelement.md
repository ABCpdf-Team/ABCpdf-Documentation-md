...
```csharp
RichMediaPresentationElement()
RichMediaPresentationElement(Atom atom, IndirectObject host)
RichMediaPresentationElement(IndirectObject obj)
RichMediaPresentationElement(Element relation, CreationOptions options)
```
...
```
RichMediaPresentationElement()
RichMediaPresentationElement(atom As Atom, host As IndirectObject)
RichMediaPresentationElement(obj As IndirectObject)
RichMediaPresentationElement(relation As Element, options As CreationOptions)
```
