...
```csharp
<a href="../default.htm">TransitionElement</a>()<a href="../default.htm">TransitionElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">TransitionElement</a>(IndirectObject obj)<a href="../default.htm">TransitionElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">TransitionElement</a>()<a href="../default.htm">TransitionElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">TransitionElement</a>(obj As IndirectObject)<a href="../default.htm">TransitionElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
Create a new [TransitionElement](default.md).
