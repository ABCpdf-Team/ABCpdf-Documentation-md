...
```csharp
TransitionElement()
TransitionElement(Atom atom, IndirectObject host)
TransitionElement(IndirectObject obj)
TransitionElement(Element relation, CreationOptions options)
```
...
```
TransitionElement()
TransitionElement(atom As Atom, host As IndirectObject)
TransitionElement(obj As IndirectObject)
TransitionElement(relation As Element, options As CreationOptions)
```
