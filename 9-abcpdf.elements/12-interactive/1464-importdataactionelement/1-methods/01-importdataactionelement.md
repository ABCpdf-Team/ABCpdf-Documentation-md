...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new ImportDataActionElement. |  |  | 
...
| **[C#]** ```csharp ImportDataActionElement() ImportDataActionElement(Atom atom, IndirectObject host) ImportDataActionElement(IndirectObject obj) ImportDataActionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` ImportDataActionElement() ImportDataActionElement(atom As Atom, host As IndirectObject) ImportDataActionElement(obj As IndirectObject) ImportDataActionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
