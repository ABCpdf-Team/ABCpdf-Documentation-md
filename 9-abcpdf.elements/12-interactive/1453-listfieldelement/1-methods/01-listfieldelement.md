...
| **[C#]** ```csharp ListFieldElement() ListFieldElement(Atom atom, IndirectObject host) ListFieldElement(IndirectObject obj) ListFieldElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` ListFieldElement() ListFieldElement(atom As Atom, host As IndirectObject) ListFieldElement(obj As IndirectObject) ListFieldElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
