...
```csharp
<a href="../default.htm">MeasureElement</a>()<a href="../default.htm">MeasureElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">MeasureElement</a>(IndirectObject obj)<a href="../default.htm">MeasureElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">MeasureElement</a>()<a href="../default.htm">MeasureElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">MeasureElement</a>(obj As IndirectObject)<a href="../default.htm">MeasureElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
