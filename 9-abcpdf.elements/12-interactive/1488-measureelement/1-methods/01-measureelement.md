...
```csharp
MeasureElement()
MeasureElement(Atom atom, IndirectObject host)
MeasureElement(IndirectObject obj)
MeasureElement(Element relation, CreationOptions options)
```
...
```
MeasureElement()
MeasureElement(atom As Atom, host As IndirectObject)
MeasureElement(obj As IndirectObject)
MeasureElement(relation As Element, options As CreationOptions)
```
