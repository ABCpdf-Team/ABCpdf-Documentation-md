...
```csharp
<a href="../default.htm">JavaScriptActionElement</a>()<a href="../default.htm">JavaScriptActionElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">JavaScriptActionElement</a>(IndirectObject obj)<a href="../default.htm">JavaScriptActionElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">JavaScriptActionElement</a>()<a href="../default.htm">JavaScriptActionElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">JavaScriptActionElement</a>(obj As IndirectObject)<a href="../default.htm">JavaScriptActionElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
This code snippet is taken from NameTree.cs line 115 in the Annotations example project.
...
if (cat.EntryNames == null)
  cat.EntryNames = new <a href="../../../07-syntax/1088-namedictionaryelement/default.htm">NameDictionaryElement</a>(cat);
if (cat.EntryNames.EntryJavaScript == null) {
  cat.EntryNames.EntryJavaScript = new <a href="../../../07-syntax/1097-nametreenodeelement_t_/default.htm">NameTreeNodeElement</a><<a href="../default.htm">JavaScriptActionElement</a>>(cat);
  cat.EntryNames.EntryJavaScript.EntryNames = new <a href="../../../01-base/0001-arrayelement_t_/default.htm">ArrayElement</a><<a href="../../../01-base/1086-element/default.htm">Element</a>>(cat);
}
