...
| --- | --- | --- | --- |
| **[C#]** ```csharp PageObjectElement ``` [Visual Basic] `PageObjectElement` | null | No | Represents the "P" entry of the annotation dictionary object. | 

## Notes

Represents the "P" entry of the annotation dictionary object.
