...
| --- | --- | --- | --- |
| **[C#]** ```csharp ArrayElementFileSpecificationElement> ``` [Visual Basic] `ArrayElementFileSpecificationElement>` | null | No | Represents the "AF" entry of the annotation dictionary object. | 

## Notes

Represents the "AF" entry of the annotation dictionary object.
