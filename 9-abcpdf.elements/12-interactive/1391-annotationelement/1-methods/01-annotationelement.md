...
| **[C#]** ```csharp AnnotationElement() AnnotationElement(Atom atom, IndirectObject host) AnnotationElement(IndirectObject obj) AnnotationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` AnnotationElement() AnnotationElement(atom As Atom, host As IndirectObject) AnnotationElement(obj As IndirectObject) AnnotationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
