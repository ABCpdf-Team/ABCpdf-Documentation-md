...
```csharp
<a href="../default.htm">AnnotationElement</a>()<a href="../default.htm">AnnotationElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">AnnotationElement</a>(IndirectObject obj)<a href="../default.htm">AnnotationElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">AnnotationElement</a>()<a href="../default.htm">AnnotationElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">AnnotationElement</a>(obj As IndirectObject)<a href="../default.htm">AnnotationElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
Create a new [AnnotationElement](default.md).
