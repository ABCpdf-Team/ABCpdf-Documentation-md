...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new MarkupAnnotationElement. |  |  | 
...
| **[C#]** ```csharp MarkupAnnotationElement() MarkupAnnotationElement(Atom atom, IndirectObject host) MarkupAnnotationElement(IndirectObject obj) MarkupAnnotationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` MarkupAnnotationElement() MarkupAnnotationElement(atom As Atom, host As IndirectObject) MarkupAnnotationElement(obj As IndirectObject) MarkupAnnotationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
