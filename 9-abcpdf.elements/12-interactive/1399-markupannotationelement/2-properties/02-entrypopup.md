...
| --- | --- | --- | --- |
| **[C#]** ```csharp PopUpAnnotationElement ``` [Visual Basic] `PopUpAnnotationElement` | null | No | Represents the "Popup" entry of the markup annotation object. | 

## Notes

Represents the "Popup" entry of the markup annotation object.

It is an optional entry defined as part of the PDF 1.3 specification.

It contains a [PopUpAnnotationElement](../../1414-popupannotationelement/default.md).
