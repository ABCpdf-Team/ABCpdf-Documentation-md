...
```csharp
FixedPrintElement()
FixedPrintElement(Atom atom, IndirectObject host)
FixedPrintElement(IndirectObject obj)
FixedPrintElement(Element relation, CreationOptions options)
```
...
```
FixedPrintElement()
FixedPrintElement(atom As Atom, host As IndirectObject)
FixedPrintElement(obj As IndirectObject)
FixedPrintElement(relation As Element, options As CreationOptions)
```
