...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new SoundAnnotationElement. |  |  | 
...
| **[C#]** ```csharp SoundAnnotationElement() SoundAnnotationElement(Atom atom, IndirectObject host) SoundAnnotationElement(IndirectObject obj) SoundAnnotationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` SoundAnnotationElement() SoundAnnotationElement(atom As Atom, host As IndirectObject) SoundAnnotationElement(obj As IndirectObject) SoundAnnotationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
