...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new RichMediaDeactivationElement. |  |  | 
...
| **[C#]** ```csharp RichMediaDeactivationElement() RichMediaDeactivationElement(Atom atom, IndirectObject host) RichMediaDeactivationElement(IndirectObject obj) RichMediaDeactivationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` RichMediaDeactivationElement() RichMediaDeactivationElement(atom As Atom, host As IndirectObject) RichMediaDeactivationElement(obj As IndirectObject) RichMediaDeactivationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
...
| This code snippet is taken from Annotations.cs line 1935 in the Annotations example project. [C#] ```csharp if (RichMediaElement.EntryRichMediaSettings.EntryDeactivation == null) RichMediaElement.EntryRichMediaSettings.EntryDeactivation = new RichMediaDeactivationElement(AnnotationElement); RichMediaElement.EntryRichMediaSettings.EntryDeactivation.EntryCondition = value; ``` |  |  | 
| --- | --- | --- |
