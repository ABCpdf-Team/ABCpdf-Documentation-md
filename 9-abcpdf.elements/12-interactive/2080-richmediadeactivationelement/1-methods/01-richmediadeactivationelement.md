...
```csharp
RichMediaDeactivationElement()
RichMediaDeactivationElement(Atom atom, IndirectObject host)
RichMediaDeactivationElement(IndirectObject obj)
RichMediaDeactivationElement(Element relation, CreationOptions options)
```
...
```
RichMediaDeactivationElement()
RichMediaDeactivationElement(atom As Atom, host As IndirectObject)
RichMediaDeactivationElement(obj As IndirectObject)
RichMediaDeactivationElement(relation As Element, options As CreationOptions)
```
...
if (RichMediaElement.EntryRichMediaSettings.EntryDeactivation == null)
  RichMediaElement.EntryRichMediaSettings.EntryDeactivation = new RichMediaDeactivationElement(AnnotationElement);
