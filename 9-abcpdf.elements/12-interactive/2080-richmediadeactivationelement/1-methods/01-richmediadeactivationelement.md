...
```csharp
<a href="../default.htm">RichMediaDeactivationElement</a>()<a href="../default.htm">RichMediaDeactivationElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">RichMediaDeactivationElement</a>(IndirectObject obj)<a href="../default.htm">RichMediaDeactivationElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">RichMediaDeactivationElement</a>()<a href="../default.htm">RichMediaDeactivationElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">RichMediaDeactivationElement</a>(obj As IndirectObject)<a href="../default.htm">RichMediaDeactivationElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
This code snippet is taken from Annotations.cs line 1935 in the Annotations example project.

[C#]

```csharp
if (RichMediaElement.EntryRichMediaSettings.EntryDeactivation == null)
  RichMediaElement.EntryRichMediaSettings.EntryDeactivation = new <a href="../default.htm">RichMediaDeactivationElement</a>(<a href="../../1391-annotationelement/default.htm">AnnotationElement</a>);
RichMediaElement.EntryRichMediaSettings.EntryDeactivation.EntryCondition = value;
```
