...
LegalAttestationElement(Atom atom, IndirectObject host)
LegalAttestationElement(IndirectObject obj)
LegalAttestationElement(Element relation, CreationOptions options)
```
...
```
LegalAttestationElement()
LegalAttestationElement(atom As Atom, host As IndirectObject)
LegalAttestationElement(obj As IndirectObject)
LegalAttestationElement(relation As Element, options As CreationOptions)
```
