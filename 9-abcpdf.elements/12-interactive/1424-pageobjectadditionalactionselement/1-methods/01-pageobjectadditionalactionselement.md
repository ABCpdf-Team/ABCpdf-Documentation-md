...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new PageObjectAdditionalActionsElement. |  |  | 
...
| **[C#]** ```csharp PageObjectAdditionalActionsElement() PageObjectAdditionalActionsElement(Atom atom, IndirectObject host) PageObjectAdditionalActionsElement(IndirectObject obj) PageObjectAdditionalActionsElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` PageObjectAdditionalActionsElement() PageObjectAdditionalActionsElement(atom As Atom, host As IndirectObject) PageObjectAdditionalActionsElement(obj As IndirectObject) PageObjectAdditionalActionsElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
