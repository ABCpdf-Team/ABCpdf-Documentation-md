...
RichMediaAnnotationElement(Atom atom, IndirectObject host)
RichMediaAnnotationElement(IndirectObject obj)
RichMediaAnnotationElement(Element relation, CreationOptions options)
```
...
```
RichMediaAnnotationElement()
RichMediaAnnotationElement(atom As Atom, host As IndirectObject)
RichMediaAnnotationElement(obj As IndirectObject)
RichMediaAnnotationElement(relation As Element, options As CreationOptions)
```
