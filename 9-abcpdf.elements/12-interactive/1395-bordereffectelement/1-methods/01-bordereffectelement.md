...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new BorderEffectElement. |  |  | 
...
| **[C#]** ```csharp BorderEffectElement() BorderEffectElement(Atom atom, IndirectObject host) BorderEffectElement(IndirectObject obj) BorderEffectElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` BorderEffectElement() BorderEffectElement(atom As Atom, host As IndirectObject) BorderEffectElement(obj As IndirectObject) BorderEffectElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
...
| This code snippet is taken from Annotations.cs line 1347 in the Annotations example project. [C#] ```csharp PolygonAnnotationElement annot = new PolygonAnnotationElement(AnnotationElement.Object); if (annot.EntryBE == null) annot.EntryBE = new BorderEffectElement(annot); annot.EntryBE.EntryS = "C"; annot.EntryBE.EntryI = value; ``` |  |  | 
| --- | --- | --- |
