...
```csharp
BorderEffectElement()
BorderEffectElement(Atom atom, IndirectObject host)
BorderEffectElement(IndirectObject obj)
BorderEffectElement(Element relation, CreationOptions options)
```
...
```
BorderEffectElement()
BorderEffectElement(atom As Atom, host As IndirectObject)
BorderEffectElement(obj As IndirectObject)
BorderEffectElement(relation As Element, options As CreationOptions)
```
...
if (annot.EntryBE == null)
  annot.EntryBE = new BorderEffectElement(annot);
