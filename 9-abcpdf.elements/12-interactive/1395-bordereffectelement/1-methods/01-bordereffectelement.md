...
```csharp
<a href="../default.htm">BorderEffectElement</a>()<a href="../default.htm">BorderEffectElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">BorderEffectElement</a>(IndirectObject obj)<a href="../default.htm">BorderEffectElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">BorderEffectElement</a>()<a href="../default.htm">BorderEffectElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">BorderEffectElement</a>(obj As IndirectObject)<a href="../default.htm">BorderEffectElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
This code snippet is taken from Annotations.cs line 1347 in the Annotations example project.

[C#]

```csharp
<a href="../../1410-polygonannotationelement/default.htm">PolygonAnnotationElement</a> annot = new <a href="../../1410-polygonannotationelement/default.htm">PolygonAnnotationElement</a>(AnnotationElement.Object);
if (annot.EntryBE == null)
  annot.EntryBE = new <a href="../default.htm">BorderEffectElement</a>(annot);
annot.EntryBE.EntryS = "C";
annot.EntryBE.EntryI = value;
```
