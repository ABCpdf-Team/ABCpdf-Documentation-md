...
```csharp
<a href="../default.htm">NavigatorElement</a>()<a href="../default.htm">NavigatorElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">NavigatorElement</a>(IndirectObject obj)<a href="../default.htm">NavigatorElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">NavigatorElement</a>()<a href="../default.htm">NavigatorElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">NavigatorElement</a>(obj As IndirectObject)<a href="../default.htm">NavigatorElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
