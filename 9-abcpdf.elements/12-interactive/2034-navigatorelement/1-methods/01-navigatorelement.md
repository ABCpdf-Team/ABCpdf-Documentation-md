...
```csharp
NavigatorElement()
NavigatorElement(Atom atom, IndirectObject host)
NavigatorElement(IndirectObject obj)
NavigatorElement(Element relation, CreationOptions options)
```
...
```
NavigatorElement()
NavigatorElement(atom As Atom, host As IndirectObject)
NavigatorElement(obj As IndirectObject)
NavigatorElement(relation As Element, options As CreationOptions)
```
