...
| **[C#]** ```csharp NavigatorElement() NavigatorElement(Atom atom, IndirectObject host) NavigatorElement(IndirectObject obj) NavigatorElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` NavigatorElement() NavigatorElement(atom As Atom, host As IndirectObject) NavigatorElement(obj As IndirectObject) NavigatorElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
