...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new RichMediaExecuteActionElement. |  |  | 
...
| **[C#]** ```csharp RichMediaExecuteActionElement() RichMediaExecuteActionElement(Atom atom, IndirectObject host) RichMediaExecuteActionElement(IndirectObject obj) RichMediaExecuteActionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` RichMediaExecuteActionElement() RichMediaExecuteActionElement(atom As Atom, host As IndirectObject) RichMediaExecuteActionElement(obj As IndirectObject) RichMediaExecuteActionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
