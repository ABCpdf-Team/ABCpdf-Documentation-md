...
```csharp
ExternalDataElement()
ExternalDataElement(Atom atom, IndirectObject host)
ExternalDataElement(IndirectObject obj)
ExternalDataElement(Element relation, CreationOptions options)
```
...
```
ExternalDataElement()
ExternalDataElement(atom As Atom, host As IndirectObject)
ExternalDataElement(obj As IndirectObject)
ExternalDataElement(relation As Element, options As CreationOptions)
```
