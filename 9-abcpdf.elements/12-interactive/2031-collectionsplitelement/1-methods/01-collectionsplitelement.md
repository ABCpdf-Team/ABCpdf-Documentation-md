...
```csharp
CollectionSplitElement()
CollectionSplitElement(Atom atom, IndirectObject host)
CollectionSplitElement(IndirectObject obj)
CollectionSplitElement(Element relation, CreationOptions options)
```
...
```
CollectionSplitElement()
CollectionSplitElement(atom As Atom, host As IndirectObject)
CollectionSplitElement(obj As IndirectObject)
CollectionSplitElement(relation As Element, options As CreationOptions)
```
