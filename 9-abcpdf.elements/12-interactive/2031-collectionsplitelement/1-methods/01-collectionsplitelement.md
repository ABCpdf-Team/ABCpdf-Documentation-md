...
```csharp
<a href="../default.htm">CollectionSplitElement</a>()<a href="../default.htm">CollectionSplitElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">CollectionSplitElement</a>(IndirectObject obj)<a href="../default.htm">CollectionSplitElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">CollectionSplitElement</a>()<a href="../default.htm">CollectionSplitElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">CollectionSplitElement</a>(obj As IndirectObject)<a href="../default.htm">CollectionSplitElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
