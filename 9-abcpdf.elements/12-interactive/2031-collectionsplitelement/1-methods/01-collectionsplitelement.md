...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new CollectionSplitElement. |  |  | 
...
| **[C#]** ```csharp CollectionSplitElement() CollectionSplitElement(Atom atom, IndirectObject host) CollectionSplitElement(IndirectObject obj) CollectionSplitElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` CollectionSplitElement() CollectionSplitElement(atom As Atom, host As IndirectObject) CollectionSplitElement(obj As IndirectObject) CollectionSplitElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
