...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new SubmitFormActionElement. |  |  | 
...
| **[C#]** ```csharp SubmitFormActionElement() SubmitFormActionElement(Atom atom, IndirectObject host) SubmitFormActionElement(IndirectObject obj) SubmitFormActionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` SubmitFormActionElement() SubmitFormActionElement(atom As Atom, host As IndirectObject) SubmitFormActionElement(obj As IndirectObject) SubmitFormActionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
