...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new ViewParamsElement. |  |  | 
...
| **[C#]** ```csharp ViewParamsElement() ViewParamsElement(Atom atom, IndirectObject host) ViewParamsElement(IndirectObject obj) ViewParamsElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` ViewParamsElement() ViewParamsElement(atom As Atom, host As IndirectObject) ViewParamsElement(obj As IndirectObject) ViewParamsElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
