...
```csharp
ViewParamsElement()
ViewParamsElement(Atom atom, IndirectObject host)
ViewParamsElement(IndirectObject obj)
ViewParamsElement(Element relation, CreationOptions options)
```
...
```
ViewParamsElement()
ViewParamsElement(atom As Atom, host As IndirectObject)
ViewParamsElement(obj As IndirectObject)
ViewParamsElement(relation As Element, options As CreationOptions)
```
