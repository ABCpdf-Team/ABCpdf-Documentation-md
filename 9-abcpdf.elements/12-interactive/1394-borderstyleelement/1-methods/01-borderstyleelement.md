...
```csharp
<a href="../default.htm">BorderStyleElement</a>()<a href="../default.htm">BorderStyleElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">BorderStyleElement</a>(IndirectObject obj)<a href="../default.htm">BorderStyleElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">BorderStyleElement</a>()<a href="../default.htm">BorderStyleElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">BorderStyleElement</a>(obj As IndirectObject)<a href="../default.htm">BorderStyleElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
<a href="../../1409-circleannotationelement/default.htm">CircleAnnotationElement</a> element = new <a href="../../1409-circleannotationelement/default.htm">CircleAnnotationElement</a>(AnnotationElement.Object);
if (element.EntryBS == null)
  element.EntryBS = new <a href="../default.htm">BorderStyleElement</a>(<a href="../../1391-annotationelement/default.htm">AnnotationElement</a>);
