...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new BorderStyleElement. |  |  | 
...
| **[C#]** ```csharp BorderStyleElement() BorderStyleElement(Atom atom, IndirectObject host) BorderStyleElement(IndirectObject obj) BorderStyleElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` BorderStyleElement() BorderStyleElement(atom As Atom, host As IndirectObject) BorderStyleElement(obj As IndirectObject) BorderStyleElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
