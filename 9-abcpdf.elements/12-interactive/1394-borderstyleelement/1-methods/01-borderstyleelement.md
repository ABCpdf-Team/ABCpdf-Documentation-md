...
```csharp
BorderStyleElement()
BorderStyleElement(Atom atom, IndirectObject host)
BorderStyleElement(IndirectObject obj)
BorderStyleElement(Element relation, CreationOptions options)
```
...
```
BorderStyleElement()
BorderStyleElement(atom As Atom, host As IndirectObject)
BorderStyleElement(obj As IndirectObject)
BorderStyleElement(relation As Element, options As CreationOptions)
```
