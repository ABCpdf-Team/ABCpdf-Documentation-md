...
| --- | --- | --- | --- |
| **[C#]** ```csharp ArrayElementElement> ``` [Visual Basic] `ArrayElementElement>` | null | No | Represents the "Opt" entry of the field dictionary object. | 

## Notes

Represents the "Opt" entry of the field dictionary object.
