...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new GoToActionElement. |  |  | 
...
| **[C#]** ```csharp GoToActionElement() GoToActionElement(Atom atom, IndirectObject host) GoToActionElement(IndirectObject obj) GoToActionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` GoToActionElement() GoToActionElement(atom As Atom, host As IndirectObject) GoToActionElement(obj As IndirectObject) GoToActionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
