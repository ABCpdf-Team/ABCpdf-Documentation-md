---
title: "01-redactionannotationelement"
css: "abcpdf-docs.css"
---
...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new RedactionAnnotationElement. |  |  | 
...
| **[C#]** ```csharp RedactionAnnotationElement() RedactionAnnotationElement(Atom atom, IndirectObject host) RedactionAnnotationElement(IndirectObject obj) RedactionAnnotationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` RedactionAnnotationElement() RedactionAnnotationElement(atom As Atom, host As IndirectObject) RedactionAnnotationElement(obj As IndirectObject) RedactionAnnotationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
