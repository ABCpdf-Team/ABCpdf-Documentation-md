...
```csharp
RedactionAnnotationElement()
RedactionAnnotationElement(Atom atom, IndirectObject host)
RedactionAnnotationElement(IndirectObject obj)
RedactionAnnotationElement(Element relation, CreationOptions options)
```
...
```
RedactionAnnotationElement()
RedactionAnnotationElement(atom As Atom, host As IndirectObject)
RedactionAnnotationElement(obj As IndirectObject)
RedactionAnnotationElement(relation As Element, options As CreationOptions)
```
