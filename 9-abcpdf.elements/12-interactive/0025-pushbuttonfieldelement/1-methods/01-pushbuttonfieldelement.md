...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new PushbuttonFieldElement. |  |  | 
...
| **[C#]** ```csharp PushbuttonFieldElement() PushbuttonFieldElement(Atom atom, IndirectObject host) PushbuttonFieldElement(IndirectObject obj) PushbuttonFieldElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` PushbuttonFieldElement() PushbuttonFieldElement(atom As Atom, host As IndirectObject) PushbuttonFieldElement(obj As IndirectObject) PushbuttonFieldElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
