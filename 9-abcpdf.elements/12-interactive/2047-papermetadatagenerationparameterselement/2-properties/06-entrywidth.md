...
| --- | --- | --- | --- |
| **[C#]** ```csharp double? ``` [Visual Basic] `Double?` | null | No | Represents the "Width" entry of the papermetadata generation parameters dictionary object. | 

## Notes

Represents the "Width" entry of the papermetadata generation parameters dictionary object.
