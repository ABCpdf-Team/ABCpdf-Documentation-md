...
Represents the "Type" entry of the papermetadata generation parameters dictionary object.
...
This item must always be provided and must always take the value "PaperMetaData".
