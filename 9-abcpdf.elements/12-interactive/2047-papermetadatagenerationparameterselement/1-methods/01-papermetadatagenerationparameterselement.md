...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new PaperMetaDataGenerationParametersElement. |  |  | 
...
| **[C#]** ```csharp PaperMetaDataGenerationParametersElement() PaperMetaDataGenerationParametersElement(Atom atom, IndirectObject host) PaperMetaDataGenerationParametersElement(IndirectObject obj) PaperMetaDataGenerationParametersElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` PaperMetaDataGenerationParametersElement() PaperMetaDataGenerationParametersElement(atom As Atom, host As IndirectObject) PaperMetaDataGenerationParametersElement(obj As IndirectObject) PaperMetaDataGenerationParametersElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
