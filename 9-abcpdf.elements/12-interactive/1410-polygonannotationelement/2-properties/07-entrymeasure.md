...
| --- | --- | --- | --- |
| **[C#]** ```csharp MeasureElement ``` [Visual Basic] `MeasureElement` | null | No | Represents the "Measure" entry of the polygon annotation object. | 

## Notes

Represents the "Measure" entry of the polygon annotation object.
