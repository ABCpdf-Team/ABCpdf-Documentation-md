...
```csharp
<a href="../default.htm">PolygonAnnotationElement</a>()<a href="../default.htm">PolygonAnnotationElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">PolygonAnnotationElement</a>(IndirectObject obj)<a href="../default.htm">PolygonAnnotationElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">PolygonAnnotationElement</a>()<a href="../default.htm">PolygonAnnotationElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">PolygonAnnotationElement</a>(obj As IndirectObject)<a href="../default.htm">PolygonAnnotationElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
```csharp
<a href="../default.htm">PolygonAnnotationElement</a> annot = new <a href="../default.htm">PolygonAnnotationElement</a>(AnnotationElement.Object);
