...
| **[C#]** ```csharp FDFFieldElement() FDFFieldElement(Atom atom, IndirectObject host) FDFFieldElement(IndirectObject obj) FDFFieldElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` FDFFieldElement() FDFFieldElement(atom As Atom, host As IndirectObject) FDFFieldElement(obj As IndirectObject) FDFFieldElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
