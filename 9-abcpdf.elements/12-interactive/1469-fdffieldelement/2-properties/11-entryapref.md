...
| --- | --- | --- | --- |
| **[C#]** ```csharp AppearanceElement ``` [Visual Basic] `AppearanceElement` | null | No | Represents the "APRef" entry of the fdf field dictionary object. | 

## Notes

Represents the "APRef" entry of the fdf field dictionary object.
