...
```csharp
ThreadActionElement()
ThreadActionElement(Atom atom, IndirectObject host)
ThreadActionElement(IndirectObject obj)
ThreadActionElement(Element relation, CreationOptions options)
```
...
```
ThreadActionElement()
ThreadActionElement(atom As Atom, host As IndirectObject)
ThreadActionElement(obj As IndirectObject)
ThreadActionElement(relation As Element, options As CreationOptions)
```
