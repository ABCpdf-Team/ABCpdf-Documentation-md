...
```csharp
ScreenAnnotationElement()
ScreenAnnotationElement(Atom atom, IndirectObject host)
ScreenAnnotationElement(IndirectObject obj)
ScreenAnnotationElement(Element relation, CreationOptions options)
```
...
```
ScreenAnnotationElement()
ScreenAnnotationElement(atom As Atom, host As IndirectObject)
ScreenAnnotationElement(obj As IndirectObject)
ScreenAnnotationElement(relation As Element, options As CreationOptions)
```
