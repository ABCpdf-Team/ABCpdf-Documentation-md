...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new ScreenAnnotationElement. |  |  | 
...
| **[C#]** ```csharp ScreenAnnotationElement() ScreenAnnotationElement(Atom atom, IndirectObject host) ScreenAnnotationElement(IndirectObject obj) ScreenAnnotationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` ScreenAnnotationElement() ScreenAnnotationElement(atom As Atom, host As IndirectObject) ScreenAnnotationElement(obj As IndirectObject) ScreenAnnotationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
