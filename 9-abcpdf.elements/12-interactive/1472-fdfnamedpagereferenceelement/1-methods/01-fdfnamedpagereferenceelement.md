---
title: "01-fdfnamedpagereferenceelement"
css: "abcpdf-docs.css"
---
...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new FDFNamedPageReferenceElement. |  |  | 
...
| **[C#]** ```csharp FDFNamedPageReferenceElement() FDFNamedPageReferenceElement(Atom atom, IndirectObject host) FDFNamedPageReferenceElement(IndirectObject obj) FDFNamedPageReferenceElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` FDFNamedPageReferenceElement() FDFNamedPageReferenceElement(atom As Atom, host As IndirectObject) FDFNamedPageReferenceElement(obj As IndirectObject) FDFNamedPageReferenceElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
