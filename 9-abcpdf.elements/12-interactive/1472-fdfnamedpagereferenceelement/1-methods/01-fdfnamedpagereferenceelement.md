...
```csharp
FDFNamedPageReferenceElement()
FDFNamedPageReferenceElement(Atom atom, IndirectObject host)
FDFNamedPageReferenceElement(IndirectObject obj)
FDFNamedPageReferenceElement(Element relation, CreationOptions options)
```
...
```
FDFNamedPageReferenceElement()
FDFNamedPageReferenceElement(atom As Atom, host As IndirectObject)
FDFNamedPageReferenceElement(obj As IndirectObject)
FDFNamedPageReferenceElement(relation As Element, options As CreationOptions)
```
