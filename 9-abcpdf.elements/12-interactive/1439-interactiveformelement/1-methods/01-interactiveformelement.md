...
```csharp
<a href="../default.htm">InteractiveFormElement</a>()<a href="../default.htm">InteractiveFormElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">InteractiveFormElement</a>(IndirectObject obj)<a href="../default.htm">InteractiveFormElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">InteractiveFormElement</a>()<a href="../default.htm">InteractiveFormElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">InteractiveFormElement</a>(obj As IndirectObject)<a href="../default.htm">InteractiveFormElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
if (cat.EntryAcroForm == null) {
  cat.EntryAcroForm = new <a href="../default.htm">InteractiveFormElement</a>(cat, CreationOptions.Indirect);
  cat.EntryAcroForm.EntryFields = new <a href="../../../01-base/0001-arrayelement_t_/default.htm">ArrayElement</a><<a href="../../1440-fieldelement/default.htm">FieldElement</a>>(cat);
}
...
if (cat.EntryAcroForm.EntryDR == null)
  cat.EntryAcroForm.EntryDR = new <a href="../../../07-syntax/1091-resourceelement/default.htm">ResourceElement</a>(cat);
