...
```csharp
GeospatialMeasureElement()
GeospatialMeasureElement(Atom atom, IndirectObject host)
GeospatialMeasureElement(IndirectObject obj)
GeospatialMeasureElement(Element relation, CreationOptions options)
```
...
```
GeospatialMeasureElement()
GeospatialMeasureElement(atom As Atom, host As IndirectObject)
GeospatialMeasureElement(obj As IndirectObject)
GeospatialMeasureElement(relation As Element, options As CreationOptions)
```
