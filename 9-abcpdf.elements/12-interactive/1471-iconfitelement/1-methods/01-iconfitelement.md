...
| **[C#]** ```csharp IconFitElement() IconFitElement(Atom atom, IndirectObject host) IconFitElement(IndirectObject obj) IconFitElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` IconFitElement() IconFitElement(atom As Atom, host As IndirectObject) IconFitElement(obj As IndirectObject) IconFitElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
