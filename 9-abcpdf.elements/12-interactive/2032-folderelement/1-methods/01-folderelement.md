...
```csharp
FolderElement()
FolderElement(Atom atom, IndirectObject host)
FolderElement(IndirectObject obj)
FolderElement(Element relation, CreationOptions options)
```
...
```
FolderElement()
FolderElement(atom As Atom, host As IndirectObject)
FolderElement(obj As IndirectObject)
FolderElement(relation As Element, options As CreationOptions)
```
