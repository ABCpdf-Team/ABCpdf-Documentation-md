...
| --- | --- | --- | --- |
| **[C#]** ```csharp int? ``` [Visual Basic] `Integer?` | null | No | Represents the "ID" entry of the folder dictionary object. | 

## Notes

Represents the "ID" entry of the folder dictionary object.
