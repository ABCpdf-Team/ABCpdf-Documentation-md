...
```csharp
<a href="../default.htm">PopUpAnnotationElement</a>()<a href="../default.htm">PopUpAnnotationElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">PopUpAnnotationElement</a>(IndirectObject obj)<a href="../default.htm">PopUpAnnotationElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">PopUpAnnotationElement</a>()<a href="../default.htm">PopUpAnnotationElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">PopUpAnnotationElement</a>(obj As IndirectObject)<a href="../default.htm">PopUpAnnotationElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
This code snippet is taken from Annotations.cs line 1688 in the Annotations example project.

[C#]

```csharp
<a href="../default.htm">PopUpAnnotationElement</a> annot = new <a href="../default.htm">PopUpAnnotationElement</a>(AnnotationElement.Object);
annot.EntrySubtype = "Popup";
...
annot.EntryParent = parentID != 0 ? new <a href="../../1391-annotationelement/default.htm">AnnotationElement</a>(form.Doc.ObjectSoup[parentID]) : null;
annot.EntryOpen = true;
