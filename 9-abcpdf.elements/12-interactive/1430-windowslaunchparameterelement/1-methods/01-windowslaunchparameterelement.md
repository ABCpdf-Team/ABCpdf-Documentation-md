...
```csharp
WindowsLaunchParameterElement()
WindowsLaunchParameterElement(Atom atom, IndirectObject host)
WindowsLaunchParameterElement(IndirectObject obj)
WindowsLaunchParameterElement(Element relation, CreationOptions options)
```
...
```
WindowsLaunchParameterElement()
WindowsLaunchParameterElement(atom As Atom, host As IndirectObject)
WindowsLaunchParameterElement(obj As IndirectObject)
WindowsLaunchParameterElement(relation As Element, options As CreationOptions)
```
