...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new RichMediaAnimationElement. |  |  | 
...
| **[C#]** ```csharp RichMediaAnimationElement() RichMediaAnimationElement(Atom atom, IndirectObject host) RichMediaAnimationElement(IndirectObject obj) RichMediaAnimationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` RichMediaAnimationElement() RichMediaAnimationElement(atom As Atom, host As IndirectObject) RichMediaAnimationElement(obj As IndirectObject) RichMediaAnimationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
