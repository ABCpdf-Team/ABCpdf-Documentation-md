...
```csharp
RichMediaAnimationElement()
RichMediaAnimationElement(Atom atom, IndirectObject host)
RichMediaAnimationElement(IndirectObject obj)
RichMediaAnimationElement(Element relation, CreationOptions options)
```
...
```
RichMediaAnimationElement()
RichMediaAnimationElement(atom As Atom, host As IndirectObject)
RichMediaAnimationElement(obj As IndirectObject)
RichMediaAnimationElement(relation As Element, options As CreationOptions)
```
