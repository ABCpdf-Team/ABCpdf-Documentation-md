...
NavigationNodeElement(Atom atom, IndirectObject host)
NavigationNodeElement(IndirectObject obj)
NavigationNodeElement(Element relation, CreationOptions options)
```
...
```
NavigationNodeElement()
NavigationNodeElement(atom As Atom, host As IndirectObject)
NavigationNodeElement(obj As IndirectObject)
NavigationNodeElement(relation As Element, options As CreationOptions)
```
