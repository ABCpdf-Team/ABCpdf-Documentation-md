...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new ProjectedCoordinateSystemElement. |  |  | 
...
| **[C#]** ```csharp ProjectedCoordinateSystemElement() ProjectedCoordinateSystemElement(Atom atom, IndirectObject host) ProjectedCoordinateSystemElement(IndirectObject obj) ProjectedCoordinateSystemElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` ProjectedCoordinateSystemElement() ProjectedCoordinateSystemElement(atom As Atom, host As IndirectObject) ProjectedCoordinateSystemElement(obj As IndirectObject) ProjectedCoordinateSystemElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
