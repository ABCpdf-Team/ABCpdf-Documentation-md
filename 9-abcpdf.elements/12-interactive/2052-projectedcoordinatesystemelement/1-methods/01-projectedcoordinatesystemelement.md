...
```csharp
ProjectedCoordinateSystemElement()
ProjectedCoordinateSystemElement(Atom atom, IndirectObject host)
ProjectedCoordinateSystemElement(IndirectObject obj)
ProjectedCoordinateSystemElement(Element relation, CreationOptions options)
```
...
```
ProjectedCoordinateSystemElement()
ProjectedCoordinateSystemElement(atom As Atom, host As IndirectObject)
ProjectedCoordinateSystemElement(obj As IndirectObject)
ProjectedCoordinateSystemElement(relation As Element, options As CreationOptions)
```
