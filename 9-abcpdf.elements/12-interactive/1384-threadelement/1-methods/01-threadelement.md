...
| **[C#]** ```csharp ThreadElement() ThreadElement(Atom atom, IndirectObject host) ThreadElement(IndirectObject obj) ThreadElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` ThreadElement() ThreadElement(atom As Atom, host As IndirectObject) ThreadElement(obj As IndirectObject) ThreadElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
