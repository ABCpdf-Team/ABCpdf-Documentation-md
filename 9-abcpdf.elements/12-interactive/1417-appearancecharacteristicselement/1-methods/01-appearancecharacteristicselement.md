...
```csharp
<a href="../default.htm">AppearanceCharacteristicsElement</a>()<a href="../default.htm">AppearanceCharacteristicsElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">AppearanceCharacteristicsElement</a>(IndirectObject obj)<a href="../default.htm">AppearanceCharacteristicsElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">AppearanceCharacteristicsElement</a>()<a href="../default.htm">AppearanceCharacteristicsElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">AppearanceCharacteristicsElement</a>(obj As IndirectObject)<a href="../default.htm">AppearanceCharacteristicsElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
```csharp
<a href="../../1416-widgetannotationelement/default.htm">WidgetAnnotationElement</a> annot = WidgetElement;
