---
title: "01-docmdptransformparameterselement"
css: "abcpdf-docs.css"
---
...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new DocMDPTransformParametersElement. |  |  | 
...
| **[C#]** ```csharp DocMDPTransformParametersElement() DocMDPTransformParametersElement(Atom atom, IndirectObject host) DocMDPTransformParametersElement(IndirectObject obj) DocMDPTransformParametersElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` DocMDPTransformParametersElement() DocMDPTransformParametersElement(atom As Atom, host As IndirectObject) DocMDPTransformParametersElement(obj As IndirectObject) DocMDPTransformParametersElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
