...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new LaunchActionElement. |  |  | 
...
| **[C#]** ```csharp LaunchActionElement() LaunchActionElement(Atom atom, IndirectObject host) LaunchActionElement(IndirectObject obj) LaunchActionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` LaunchActionElement() LaunchActionElement(atom As Atom, host As IndirectObject) LaunchActionElement(obj As IndirectObject) LaunchActionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
