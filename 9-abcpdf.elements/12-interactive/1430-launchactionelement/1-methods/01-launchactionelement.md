...
```csharp
<a href="../default.htm">LaunchActionElement</a>()<a href="../default.htm">LaunchActionElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">LaunchActionElement</a>(IndirectObject obj)<a href="../default.htm">LaunchActionElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">LaunchActionElement</a>()<a href="../default.htm">LaunchActionElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">LaunchActionElement</a>(obj As IndirectObject)<a href="../default.htm">LaunchActionElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
