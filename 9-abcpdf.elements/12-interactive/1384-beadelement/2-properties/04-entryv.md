...
| --- | --- | --- | --- |
| **[C#]** ```csharp BeadElement ``` [Visual Basic] `BeadElement` | null | No | Represents the "V" entry of the bead dictionary object. | 

## Notes

Represents the "V" entry of the bead dictionary object.
