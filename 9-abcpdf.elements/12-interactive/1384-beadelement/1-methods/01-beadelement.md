...
| **[C#]** ```csharp BeadElement() BeadElement(Atom atom, IndirectObject host) BeadElement(IndirectObject obj) BeadElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` BeadElement() BeadElement(atom As Atom, host As IndirectObject) BeadElement(obj As IndirectObject) BeadElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
