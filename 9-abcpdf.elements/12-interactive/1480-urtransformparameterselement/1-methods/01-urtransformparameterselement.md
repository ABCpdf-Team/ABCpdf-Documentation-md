...
```csharp
UrTransformParametersElement()
UrTransformParametersElement(Atom atom, IndirectObject host)
UrTransformParametersElement(IndirectObject obj)
UrTransformParametersElement(Element relation, CreationOptions options)
```
...
```
UrTransformParametersElement()
UrTransformParametersElement(atom As Atom, host As IndirectObject)
UrTransformParametersElement(obj As IndirectObject)
UrTransformParametersElement(relation As Element, options As CreationOptions)
```
