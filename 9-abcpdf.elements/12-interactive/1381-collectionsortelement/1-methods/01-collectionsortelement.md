...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new CollectionSortElement. |  |  | 
...
| **[C#]** ```csharp CollectionSortElement() CollectionSortElement(Atom atom, IndirectObject host) CollectionSortElement(IndirectObject obj) CollectionSortElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` CollectionSortElement() CollectionSortElement(atom As Atom, host As IndirectObject) CollectionSortElement(obj As IndirectObject) CollectionSortElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
