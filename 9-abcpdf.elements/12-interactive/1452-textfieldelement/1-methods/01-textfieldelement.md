...
| **[C#]** ```csharp TextFieldElement() TextFieldElement(Atom atom, IndirectObject host) TextFieldElement(IndirectObject obj) TextFieldElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` TextFieldElement() TextFieldElement(atom As Atom, host As IndirectObject) TextFieldElement(obj As IndirectObject) TextFieldElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
