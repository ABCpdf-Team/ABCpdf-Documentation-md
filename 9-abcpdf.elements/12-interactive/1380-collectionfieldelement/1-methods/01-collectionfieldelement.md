...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new CollectionFieldElement. |  |  | 
...
| **[C#]** ```csharp CollectionFieldElement() CollectionFieldElement(Atom atom, IndirectObject host) CollectionFieldElement(IndirectObject obj) CollectionFieldElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` CollectionFieldElement() CollectionFieldElement(atom As Atom, host As IndirectObject) CollectionFieldElement(obj As IndirectObject) CollectionFieldElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
