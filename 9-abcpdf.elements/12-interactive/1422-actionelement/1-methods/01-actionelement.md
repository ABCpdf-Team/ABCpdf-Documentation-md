...
| **[C#]** ```csharp ActionElement() ActionElement(Atom atom, IndirectObject host) ActionElement(IndirectObject obj) ActionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` ActionElement() ActionElement(atom As Atom, host As IndirectObject) ActionElement(obj As IndirectObject) ActionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
