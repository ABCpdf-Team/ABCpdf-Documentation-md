...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new CertificateSeedValueElement. |  |  | 
...
| **[C#]** ```csharp CertificateSeedValueElement() CertificateSeedValueElement(Atom atom, IndirectObject host) CertificateSeedValueElement(IndirectObject obj) CertificateSeedValueElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` CertificateSeedValueElement() CertificateSeedValueElement(atom As Atom, host As IndirectObject) CertificateSeedValueElement(obj As IndirectObject) CertificateSeedValueElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
