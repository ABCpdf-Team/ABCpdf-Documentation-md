---
title: "04-entrysubjectdn"
css: "abcpdf-docs.css"
---

# EntrySubjectDN Property

| Type | Default Value | Read Only | Description | 
| --- | --- | --- | --- |
| **[C#]** ```csharp ArrayElementElement> ``` [Visual Basic] `ArrayElementElement>` | null | No | Represents the "SubjectDN" entry of the certificate seed value dictionary object. | 

## Notes

Represents the "SubjectDN" entry of the certificate seed value dictionary object.
