...
```csharp
MovieAnnotationElement()
MovieAnnotationElement(Atom atom, IndirectObject host)
MovieAnnotationElement(IndirectObject obj)
MovieAnnotationElement(Element relation, CreationOptions options)
```
...
```
MovieAnnotationElement()
MovieAnnotationElement(atom As Atom, host As IndirectObject)
MovieAnnotationElement(obj As IndirectObject)
MovieAnnotationElement(relation As Element, options As CreationOptions)
```
