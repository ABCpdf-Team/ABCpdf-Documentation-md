...
```csharp
UriActionElement()
UriActionElement(Atom atom, IndirectObject host)
UriActionElement(IndirectObject obj)
UriActionElement(Element relation, CreationOptions options)
```
...
```
UriActionElement()
UriActionElement(atom As Atom, host As IndirectObject)
UriActionElement(obj As IndirectObject)
UriActionElement(relation As Element, options As CreationOptions)
```
