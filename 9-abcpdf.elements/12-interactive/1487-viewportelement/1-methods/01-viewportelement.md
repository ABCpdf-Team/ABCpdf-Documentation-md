...
| **[C#]** ```csharp ViewportElement() ViewportElement(Atom atom, IndirectObject host) ViewportElement(IndirectObject obj) ViewportElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` ViewportElement() ViewportElement(atom As Atom, host As IndirectObject) ViewportElement(obj As IndirectObject) ViewportElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
