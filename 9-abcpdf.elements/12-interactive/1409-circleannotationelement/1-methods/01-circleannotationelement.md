...
CircleAnnotationElement(Atom atom, IndirectObject host)
CircleAnnotationElement(IndirectObject obj)
CircleAnnotationElement(Element relation, CreationOptions options)
```
...
```
CircleAnnotationElement()
CircleAnnotationElement(atom As Atom, host As IndirectObject)
CircleAnnotationElement(obj As IndirectObject)
CircleAnnotationElement(relation As Element, options As CreationOptions)
```
...
CircleAnnotationElement element = new CircleAnnotationElement(AnnotationElement.Object);
if (element.EntryBS == null)
  element.EntryBS = new BorderStyleElement(AnnotationElement);
