...
```csharp
<a href="../default.htm">CircleAnnotationElement</a>()<a href="../default.htm">CircleAnnotationElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">CircleAnnotationElement</a>(IndirectObject obj)<a href="../default.htm">CircleAnnotationElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">CircleAnnotationElement</a>()<a href="../default.htm">CircleAnnotationElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">CircleAnnotationElement</a>(obj As IndirectObject)<a href="../default.htm">CircleAnnotationElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
This code snippet is taken from Annotations.cs line 90 in the Annotations example project.

[C#]

```csharp
// The BS entry is not applicable for all Annotation types. However we coerce it into a type which supports it.
<a href="../default.htm">CircleAnnotationElement</a> element = new <a href="../default.htm">CircleAnnotationElement</a>(AnnotationElement.Object);
if (element.EntryBS == null)
  element.EntryBS = new <a href="../../1394-borderstyleelement/default.htm">BorderStyleElement</a>(<a href="../../1391-annotationelement/default.htm">AnnotationElement</a>);
return element.EntryBS;
```
