...
```csharp
SoundActionElement()
SoundActionElement(Atom atom, IndirectObject host)
SoundActionElement(IndirectObject obj)
SoundActionElement(Element relation, CreationOptions options)
```
...
```
SoundActionElement()
SoundActionElement(atom As Atom, host As IndirectObject)
SoundActionElement(obj As IndirectObject)
SoundActionElement(relation As Element, options As CreationOptions)
```
