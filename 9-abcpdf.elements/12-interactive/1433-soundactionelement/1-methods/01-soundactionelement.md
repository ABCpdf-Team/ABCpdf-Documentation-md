...
```csharp
<a href="../default.htm">SoundActionElement</a>()<a href="../default.htm">SoundActionElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">SoundActionElement</a>(IndirectObject obj)<a href="../default.htm">SoundActionElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">SoundActionElement</a>()<a href="../default.htm">SoundActionElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">SoundActionElement</a>(obj As IndirectObject)<a href="../default.htm">SoundActionElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
