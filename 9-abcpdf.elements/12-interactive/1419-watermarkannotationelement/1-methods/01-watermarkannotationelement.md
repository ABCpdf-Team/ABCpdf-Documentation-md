...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new WatermarkAnnotationElement. |  |  | 
...
| **[C#]** ```csharp WatermarkAnnotationElement() WatermarkAnnotationElement(Atom atom, IndirectObject host) WatermarkAnnotationElement(IndirectObject obj) WatermarkAnnotationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` WatermarkAnnotationElement() WatermarkAnnotationElement(atom As Atom, host As IndirectObject) WatermarkAnnotationElement(obj As IndirectObject) WatermarkAnnotationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
