...
```csharp
<a href="../default.htm">RichMediaConfigElement</a>()<a href="../default.htm">RichMediaConfigElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">RichMediaConfigElement</a>(IndirectObject obj)<a href="../default.htm">RichMediaConfigElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">RichMediaConfigElement</a>()<a href="../default.htm">RichMediaConfigElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">RichMediaConfigElement</a>(obj As IndirectObject)<a href="../default.htm">RichMediaConfigElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
<a href="../default.htm">RichMediaConfigElement</a> configuration = new <a href="../default.htm">RichMediaConfigElement</a>(annot, CreationOptions.Indirect);
configuration.EntryType = "RichMediaConfiguration";
configuration.EntrySubtype = mediaType;
<a href="../../2089-richmediainstanceelement/default.htm">RichMediaInstanceElement</a> instance = new <a href="../../2089-richmediainstanceelement/default.htm">RichMediaInstanceElement</a>(annot, CreationOptions.Indirect);
...
configuration.EntryInstances = new <a href="../../../01-base/0001-arrayelement_t_/default.htm">ArrayElement</a><<a href="../../2089-richmediainstanceelement/default.htm">RichMediaInstanceElement</a>>(annot);
configuration.EntryInstances.Add(instance);

content.EntryConfigurations = new <a href="../../../01-base/0001-arrayelement_t_/default.htm">ArrayElement</a><<a href="../default.htm">RichMediaConfigElement</a>>(annot);
