...
Create a new [RichMediaConfigElement](../default.md).
...
```csharp
RichMediaConfigElement()
RichMediaConfigElement(Atom atom, IndirectObject host)
RichMediaConfigElement(IndirectObject obj)
RichMediaConfigElement(Element relation, CreationOptions options)
```
...
```
RichMediaConfigElement()
RichMediaConfigElement(atom As Atom, host As IndirectObject)
RichMediaConfigElement(obj As IndirectObject)
RichMediaConfigElement(relation As Element, options As CreationOptions)
```
