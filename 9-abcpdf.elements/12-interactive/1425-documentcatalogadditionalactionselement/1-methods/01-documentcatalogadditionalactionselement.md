...
DocumentCatalogAdditionalActionsElement(Atom atom, IndirectObject host)
DocumentCatalogAdditionalActionsElement(IndirectObject obj)
DocumentCatalogAdditionalActionsElement(Element relation, CreationOptions options)
```
...
```
DocumentCatalogAdditionalActionsElement()
DocumentCatalogAdditionalActionsElement(atom As Atom, host As IndirectObject)
DocumentCatalogAdditionalActionsElement(obj As IndirectObject)
DocumentCatalogAdditionalActionsElement(relation As Element, options As CreationOptions)
```
