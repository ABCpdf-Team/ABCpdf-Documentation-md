...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new DocumentCatalogAdditionalActionsElement. |  |  | 
...
| **[C#]** ```csharp DocumentCatalogAdditionalActionsElement() DocumentCatalogAdditionalActionsElement(Atom atom, IndirectObject host) DocumentCatalogAdditionalActionsElement(IndirectObject obj) DocumentCatalogAdditionalActionsElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` DocumentCatalogAdditionalActionsElement() DocumentCatalogAdditionalActionsElement(atom As Atom, host As IndirectObject) DocumentCatalogAdditionalActionsElement(obj As IndirectObject) DocumentCatalogAdditionalActionsElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
