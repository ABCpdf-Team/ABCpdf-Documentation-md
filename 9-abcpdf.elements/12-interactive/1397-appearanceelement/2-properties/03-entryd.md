...
| --- | --- | --- | --- |
| **[C#]** ```csharp Element ``` [Visual Basic] `Element` | null | No | Represents the "D" entry of the appearance dictionary object. | 

## Notes

Represents the "D" entry of the appearance dictionary object.
