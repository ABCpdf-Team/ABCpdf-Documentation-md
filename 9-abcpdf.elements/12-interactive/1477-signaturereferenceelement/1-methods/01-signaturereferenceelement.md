...
```csharp
SignatureReferenceElement()
SignatureReferenceElement(Atom atom, IndirectObject host)
SignatureReferenceElement(IndirectObject obj)
SignatureReferenceElement(Element relation, CreationOptions options)
```
...
```
SignatureReferenceElement()
SignatureReferenceElement(atom As Atom, host As IndirectObject)
SignatureReferenceElement(obj As IndirectObject)
SignatureReferenceElement(relation As Element, options As CreationOptions)
```
