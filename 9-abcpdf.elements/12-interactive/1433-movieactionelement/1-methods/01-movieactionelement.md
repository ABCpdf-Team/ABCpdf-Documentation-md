...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new MovieActionElement. |  |  | 
...
| **[C#]** ```csharp MovieActionElement() MovieActionElement(Atom atom, IndirectObject host) MovieActionElement(IndirectObject obj) MovieActionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` MovieActionElement() MovieActionElement(atom As Atom, host As IndirectObject) MovieActionElement(obj As IndirectObject) MovieActionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
