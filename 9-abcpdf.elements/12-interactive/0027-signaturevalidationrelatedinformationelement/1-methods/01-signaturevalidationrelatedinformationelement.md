---
title: "01-signaturevalidationrelatedinformationelement"
css: "abcpdf-docs.css"
---
...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new SignatureValidationRelatedInformationElement. |  |  | 
...
| **[C#]** ```csharp SignatureValidationRelatedInformationElement() SignatureValidationRelatedInformationElement(Atom atom, IndirectObject host) SignatureValidationRelatedInformationElement(IndirectObject obj) SignatureValidationRelatedInformationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` SignatureValidationRelatedInformationElement() SignatureValidationRelatedInformationElement(atom As Atom, host As IndirectObject) SignatureValidationRelatedInformationElement(obj As IndirectObject) SignatureValidationRelatedInformationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
