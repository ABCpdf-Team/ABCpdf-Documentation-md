...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new WidgetAnnotationElement. |  |  | 
...
| **[C#]** ```csharp WidgetAnnotationElement() WidgetAnnotationElement(Atom atom, IndirectObject host) WidgetAnnotationElement(IndirectObject obj) WidgetAnnotationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` WidgetAnnotationElement() WidgetAnnotationElement(atom As Atom, host As IndirectObject) WidgetAnnotationElement(obj As IndirectObject) WidgetAnnotationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
...
| This code snippet is taken from Annotations.cs line 1164 in the Annotations example project. [C#] ```csharp WidgetAnnotationElement annot = new WidgetAnnotationElement(AnnotationElement.Object); annot.EntrySubtype = "Widget"; AnnotationElement = annot; ``` This code snippet is taken from Annotations.cs line 1171 in the Annotations example project. [C#] ```csharp WidgetAnnotationElement annot = new WidgetAnnotationElement(AnnotationElement.Object); annot.EntrySubtype = "Widget"; AnnotationElement = annot; ``` |  |  | 
| --- | --- | --- |
