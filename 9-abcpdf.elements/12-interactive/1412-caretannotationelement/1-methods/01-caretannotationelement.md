...
CaretAnnotationElement(Atom atom, IndirectObject host)
CaretAnnotationElement(IndirectObject obj)
CaretAnnotationElement(Element relation, CreationOptions options)
```
...
```
CaretAnnotationElement()
CaretAnnotationElement(atom As Atom, host As IndirectObject)
CaretAnnotationElement(obj As IndirectObject)
CaretAnnotationElement(relation As Element, options As CreationOptions)
```
