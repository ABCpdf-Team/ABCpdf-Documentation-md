...
```csharp
RenditionActionElement()
RenditionActionElement(Atom atom, IndirectObject host)
RenditionActionElement(IndirectObject obj)
RenditionActionElement(Element relation, CreationOptions options)
```
...
```
RenditionActionElement()
RenditionActionElement(atom As Atom, host As IndirectObject)
RenditionActionElement(obj As IndirectObject)
RenditionActionElement(relation As Element, options As CreationOptions)
```
