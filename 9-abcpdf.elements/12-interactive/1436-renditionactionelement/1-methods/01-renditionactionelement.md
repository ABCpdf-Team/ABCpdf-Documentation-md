---
title: "01-renditionactionelement"
css: "abcpdf-docs.css"
---
...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new RenditionActionElement. |  |  | 
...
| **[C#]** ```csharp RenditionActionElement() RenditionActionElement(Atom atom, IndirectObject host) RenditionActionElement(IndirectObject obj) RenditionActionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` RenditionActionElement() RenditionActionElement(atom As Atom, host As IndirectObject) RenditionActionElement(obj As IndirectObject) RenditionActionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
