# RichMediaCommandElement Function
...
```csharp
<a href="../default.htm">RichMediaCommandElement</a>()<a href="../default.htm">RichMediaCommandElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">RichMediaCommandElement</a>(IndirectObject obj)<a href="../default.htm">RichMediaCommandElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">RichMediaCommandElement</a>()<a href="../default.htm">RichMediaCommandElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">RichMediaCommandElement</a>(obj As IndirectObject)<a href="../default.htm">RichMediaCommandElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
Create a new [RichMediaCommandElement](default.md).
