---
title: "01-richmediacommandelement"
css: "abcpdf-docs.css"
---
...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new RichMediaCommandElement. |  |  | 
...
| **[C#]** ```csharp RichMediaCommandElement() RichMediaCommandElement(Atom atom, IndirectObject host) RichMediaCommandElement(IndirectObject obj) RichMediaCommandElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` RichMediaCommandElement() RichMediaCommandElement(atom As Atom, host As IndirectObject) RichMediaCommandElement(obj As IndirectObject) RichMediaCommandElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
