...
```csharp
RichMediaCommandElement()
RichMediaCommandElement(Atom atom, IndirectObject host)
RichMediaCommandElement(IndirectObject obj)
RichMediaCommandElement(Element relation, CreationOptions options)
```
...
```
RichMediaCommandElement()
RichMediaCommandElement(atom As Atom, host As IndirectObject)
RichMediaCommandElement(obj As IndirectObject)
RichMediaCommandElement(relation As Element, options As CreationOptions)
```
