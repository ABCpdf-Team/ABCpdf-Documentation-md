...
```csharp
DocumentSecurityStoreElement()
DocumentSecurityStoreElement(Atom atom, IndirectObject host)
DocumentSecurityStoreElement(IndirectObject obj)
DocumentSecurityStoreElement(Element relation, CreationOptions options)
```
...
```
DocumentSecurityStoreElement()
DocumentSecurityStoreElement(atom As Atom, host As IndirectObject)
DocumentSecurityStoreElement(obj As IndirectObject)
DocumentSecurityStoreElement(relation As Element, options As CreationOptions)
```
