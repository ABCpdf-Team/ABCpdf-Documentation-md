...
```csharp
RichMediaDimensionsElement()
RichMediaDimensionsElement(Atom atom, IndirectObject host)
RichMediaDimensionsElement(IndirectObject obj)
RichMediaDimensionsElement(Element relation, CreationOptions options)
```
...
```
RichMediaDimensionsElement()
RichMediaDimensionsElement(atom As Atom, host As IndirectObject)
RichMediaDimensionsElement(obj As IndirectObject)
RichMediaDimensionsElement(relation As Element, options As CreationOptions)
```
