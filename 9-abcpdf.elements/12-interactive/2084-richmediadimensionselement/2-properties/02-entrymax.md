...
| --- | --- | --- | --- |
| **[C#]** ```csharp double? ``` [Visual Basic] `Double?` | null | No | Represents the "Max" entry of the richmediadimensions dictionary object. | 

## Notes

Represents the "Max" entry of the richmediadimensions dictionary object.
