...
```csharp
NamedActionElement()
NamedActionElement(Atom atom, IndirectObject host)
NamedActionElement(IndirectObject obj)
NamedActionElement(Element relation, CreationOptions options)
```
...
```
NamedActionElement()
NamedActionElement(atom As Atom, host As IndirectObject)
NamedActionElement(obj As IndirectObject)
NamedActionElement(relation As Element, options As CreationOptions)
```
