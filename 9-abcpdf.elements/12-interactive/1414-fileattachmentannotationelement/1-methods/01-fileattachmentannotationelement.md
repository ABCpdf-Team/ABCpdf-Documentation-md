...
FileAttachmentAnnotationElement(Atom atom, IndirectObject host)
FileAttachmentAnnotationElement(IndirectObject obj)
FileAttachmentAnnotationElement(Element relation, CreationOptions options)
```
...
```
FileAttachmentAnnotationElement()
FileAttachmentAnnotationElement(atom As Atom, host As IndirectObject)
FileAttachmentAnnotationElement(obj As IndirectObject)
FileAttachmentAnnotationElement(relation As Element, options As CreationOptions)
```
...
```csharp
FileAttachmentAnnotationElement annot = new FileAttachmentAnnotationElement(AnnotationElement.Object);
