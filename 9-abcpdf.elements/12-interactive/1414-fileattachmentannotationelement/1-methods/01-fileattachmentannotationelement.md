...
```csharp
<a href="../default.htm">FileAttachmentAnnotationElement</a>()<a href="../default.htm">FileAttachmentAnnotationElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">FileAttachmentAnnotationElement</a>(IndirectObject obj)<a href="../default.htm">FileAttachmentAnnotationElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">FileAttachmentAnnotationElement</a>()<a href="../default.htm">FileAttachmentAnnotationElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">FileAttachmentAnnotationElement</a>(obj As IndirectObject)<a href="../default.htm">FileAttachmentAnnotationElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
This code snippet is taken from Annotations.cs line 1656 in the Annotations example project.

[C#]

```csharp
<a href="../default.htm">FileAttachmentAnnotationElement</a> annot = new <a href="../default.htm">FileAttachmentAnnotationElement</a>(AnnotationElement.Object);
annot.EntrySubtype = "FileAttachment";
