...
```csharp
<a href="../default.htm">RichMediaParamsElement</a>()<a href="../default.htm">RichMediaParamsElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">RichMediaParamsElement</a>(IndirectObject obj)<a href="../default.htm">RichMediaParamsElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">RichMediaParamsElement</a>()<a href="../default.htm">RichMediaParamsElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">RichMediaParamsElement</a>(obj As IndirectObject)<a href="../default.htm">RichMediaParamsElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
instance.EntryParams = new <a href="../default.htm">RichMediaParamsElement</a>(annot);
