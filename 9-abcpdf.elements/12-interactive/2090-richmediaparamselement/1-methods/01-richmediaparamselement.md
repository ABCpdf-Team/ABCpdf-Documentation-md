...
```csharp
RichMediaParamsElement()
RichMediaParamsElement(Atom atom, IndirectObject host)
RichMediaParamsElement(IndirectObject obj)
RichMediaParamsElement(Element relation, CreationOptions options)
```
...
```
RichMediaParamsElement()
RichMediaParamsElement(atom As Atom, host As IndirectObject)
RichMediaParamsElement(obj As IndirectObject)
RichMediaParamsElement(relation As Element, options As CreationOptions)
```
