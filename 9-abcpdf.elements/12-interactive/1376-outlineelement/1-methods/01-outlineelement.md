...
```csharp
OutlineElement()
OutlineElement(Atom atom, IndirectObject host)
OutlineElement(IndirectObject obj)
OutlineElement(Element relation, CreationOptions options)
```
...
```
OutlineElement()
OutlineElement(atom As Atom, host As IndirectObject)
OutlineElement(obj As IndirectObject)
OutlineElement(relation As Element, options As CreationOptions)
```
