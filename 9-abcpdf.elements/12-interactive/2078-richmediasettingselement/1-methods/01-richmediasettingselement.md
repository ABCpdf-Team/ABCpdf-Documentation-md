...
```csharp
RichMediaSettingsElement()
RichMediaSettingsElement(Atom atom, IndirectObject host)
RichMediaSettingsElement(IndirectObject obj)
RichMediaSettingsElement(Element relation, CreationOptions options)
```
...
```
RichMediaSettingsElement()
RichMediaSettingsElement(atom As Atom, host As IndirectObject)
RichMediaSettingsElement(obj As IndirectObject)
RichMediaSettingsElement(relation As Element, options As CreationOptions)
```
