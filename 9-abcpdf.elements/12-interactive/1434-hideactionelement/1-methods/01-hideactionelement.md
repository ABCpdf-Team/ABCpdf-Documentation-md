...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new HideActionElement. |  |  | 
...
| **[C#]** ```csharp HideActionElement() HideActionElement(Atom atom, IndirectObject host) HideActionElement(IndirectObject obj) HideActionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` HideActionElement() HideActionElement(atom As Atom, host As IndirectObject) HideActionElement(obj As IndirectObject) HideActionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
