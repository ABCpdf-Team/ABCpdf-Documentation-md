...
```csharp
<a href="../default.htm">LineAnnotationElement</a>()<a href="../default.htm">LineAnnotationElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">LineAnnotationElement</a>(IndirectObject obj)<a href="../default.htm">LineAnnotationElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">LineAnnotationElement</a>()<a href="../default.htm">LineAnnotationElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">LineAnnotationElement</a>(obj As IndirectObject)<a href="../default.htm">LineAnnotationElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
```csharp
<a href="../default.htm">LineAnnotationElement</a> annot = new <a href="../default.htm">LineAnnotationElement</a>(AnnotationElement.Object);
annot.EntrySubtype = "Line";
annot.EntryRect = new <a href="../../../07-syntax/0017-rectangleelement/default.htm">RectangleElement</a>(ArrayAtom.FromXRect(new XRect(line)), annot.Host);
