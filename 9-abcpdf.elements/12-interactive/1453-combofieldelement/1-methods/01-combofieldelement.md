...
```csharp
<a href="../default.htm">ComboFieldElement</a>()<a href="../default.htm">ComboFieldElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">ComboFieldElement</a>(IndirectObject obj)<a href="../default.htm">ComboFieldElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">ComboFieldElement</a>()<a href="../default.htm">ComboFieldElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">ComboFieldElement</a>(obj As IndirectObject)<a href="../default.htm">ComboFieldElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
This code snippet is taken from Annotations.cs line 269 in the Annotations example project.

[C#]

```csharp
<a href="../default.htm">ComboFieldElement</a> choice = new <a href="../default.htm">ComboFieldElement</a>(FieldElement.Object);
if (options != null)
  choice.EntryOpt = new <a href="../../../01-base/0001-arrayelement_t_/default.htm">ArrayElement</a><<a href="../../../01-base/1086-element/default.htm">Element</a>>(ArrayAtom.FromStrings(options), Host);
if (selected != null)
  choice.EntryI = selected;
```
