...
```csharp
PageLabelElement()
PageLabelElement(Atom atom, IndirectObject host)
PageLabelElement(IndirectObject obj)
PageLabelElement(Element relation, CreationOptions options)
```
...
```
PageLabelElement()
PageLabelElement(atom As Atom, host As IndirectObject)
PageLabelElement(obj As IndirectObject)
PageLabelElement(relation As Element, options As CreationOptions)
```
