...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new DocumentPartGoToActionElement. |  |  | 
...
| **[C#]** ```csharp DocumentPartGoToActionElement() DocumentPartGoToActionElement(Atom atom, IndirectObject host) DocumentPartGoToActionElement(IndirectObject obj) DocumentPartGoToActionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` DocumentPartGoToActionElement() DocumentPartGoToActionElement(atom As Atom, host As IndirectObject) DocumentPartGoToActionElement(obj As IndirectObject) DocumentPartGoToActionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
