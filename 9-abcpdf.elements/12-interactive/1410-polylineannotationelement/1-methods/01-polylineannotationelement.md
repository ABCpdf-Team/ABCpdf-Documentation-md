...
PolylineAnnotationElement(Atom atom, IndirectObject host)
PolylineAnnotationElement(IndirectObject obj)
PolylineAnnotationElement(Element relation, CreationOptions options)
```
...
```
PolylineAnnotationElement()
PolylineAnnotationElement(atom As Atom, host As IndirectObject)
PolylineAnnotationElement(obj As IndirectObject)
PolylineAnnotationElement(relation As Element, options As CreationOptions)
```
...
```csharp
PolylineAnnotationElement annot = new PolylineAnnotationElement(AnnotationElement.Object);
