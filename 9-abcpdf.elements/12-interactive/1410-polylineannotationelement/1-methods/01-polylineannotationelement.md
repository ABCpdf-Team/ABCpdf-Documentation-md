...
```csharp
<a href="../default.htm">PolylineAnnotationElement</a>()<a href="../default.htm">PolylineAnnotationElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">PolylineAnnotationElement</a>(IndirectObject obj)<a href="../default.htm">PolylineAnnotationElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">PolylineAnnotationElement</a>()<a href="../default.htm">PolylineAnnotationElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">PolylineAnnotationElement</a>(obj As IndirectObject)<a href="../default.htm">PolylineAnnotationElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
This code snippet is taken from Annotations.cs line 1298 in the Annotations example project.

[C#]

```csharp
<a href="../default.htm">PolylineAnnotationElement</a> annot = new <a href="../default.htm">PolylineAnnotationElement</a>(AnnotationElement.Object);
double[] vertices = Array.ConvertAll(polygon.Split(new char[] { ' ' }), s => double.Parse(s, NumberFormatInfo.InvariantInfo));
annot.EntrySubtype = "PolyLine";
annot.EntryVertices = vertices;
annot.EntryRect = new <a href="../../../07-syntax/0017-rectangleelement/default.htm">RectangleElement</a>(ArrayAtom.FromXRect(InteractiveForm.GetBoundingRect(vertices)), annot.Host);
