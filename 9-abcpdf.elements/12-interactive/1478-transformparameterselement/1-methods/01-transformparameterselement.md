...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new TransformParametersElement. |  |  | 
...
| **[C#]** ```csharp TransformParametersElement() TransformParametersElement(Atom atom, IndirectObject host) TransformParametersElement(IndirectObject obj) TransformParametersElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` TransformParametersElement() TransformParametersElement(atom As Atom, host As IndirectObject) TransformParametersElement(obj As IndirectObject) TransformParametersElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
