...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new CollectionColorsElement. |  |  | 
...
| **[C#]** ```csharp CollectionColorsElement() CollectionColorsElement(Atom atom, IndirectObject host) CollectionColorsElement(IndirectObject obj) CollectionColorsElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` CollectionColorsElement() CollectionColorsElement(atom As Atom, host As IndirectObject) CollectionColorsElement(obj As IndirectObject) CollectionColorsElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
