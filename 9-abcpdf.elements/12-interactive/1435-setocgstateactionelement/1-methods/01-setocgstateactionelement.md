...
```csharp
SetOcgStateActionElement()
SetOcgStateActionElement(Atom atom, IndirectObject host)
SetOcgStateActionElement(IndirectObject obj)
SetOcgStateActionElement(Element relation, CreationOptions options)
```
...
```
SetOcgStateActionElement()
SetOcgStateActionElement(atom As Atom, host As IndirectObject)
SetOcgStateActionElement(obj As IndirectObject)
SetOcgStateActionElement(relation As Element, options As CreationOptions)
```
