...
FreeTextAnnotationElement(Atom atom, IndirectObject host)
FreeTextAnnotationElement(IndirectObject obj)
FreeTextAnnotationElement(Element relation, CreationOptions options)
```
...
```
FreeTextAnnotationElement()
FreeTextAnnotationElement(atom As Atom, host As IndirectObject)
FreeTextAnnotationElement(obj As IndirectObject)
FreeTextAnnotationElement(relation As Element, options As CreationOptions)
```
