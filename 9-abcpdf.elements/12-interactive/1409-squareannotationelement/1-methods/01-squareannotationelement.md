...
```csharp
<a href="../default.htm">SquareAnnotationElement</a>()<a href="../default.htm">SquareAnnotationElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">SquareAnnotationElement</a>(IndirectObject obj)<a href="../default.htm">SquareAnnotationElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">SquareAnnotationElement</a>()<a href="../default.htm">SquareAnnotationElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">SquareAnnotationElement</a>(obj As IndirectObject)<a href="../default.htm">SquareAnnotationElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
This code snippet is taken from Annotations.cs line 1519 in the Annotations example project.

[C#]

```csharp
<a href="../default.htm">SquareAnnotationElement</a> annot = new <a href="../default.htm">SquareAnnotationElement</a>(AnnotationElement.Object);
annot.EntrySubtype = "Square";
...
annot.EntryC = Array.ConvertAll(borderColor.Split(new char[] { ' ' }), s => double.Parse(s, NumberFormatInfo.InvariantInfo) / 255.0);
annot.EntryIC = Array.ConvertAll(fillColor.Split(new char[] { ' ' }), s => double.Parse(s, NumberFormatInfo.InvariantInfo) / 255.0);
