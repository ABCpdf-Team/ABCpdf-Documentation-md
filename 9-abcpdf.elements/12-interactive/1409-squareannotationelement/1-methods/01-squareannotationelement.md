...
SquareAnnotationElement(Atom atom, IndirectObject host)
SquareAnnotationElement(IndirectObject obj)
SquareAnnotationElement(Element relation, CreationOptions options)
```
...
```
SquareAnnotationElement()
SquareAnnotationElement(atom As Atom, host As IndirectObject)
SquareAnnotationElement(obj As IndirectObject)
SquareAnnotationElement(relation As Element, options As CreationOptions)
```
...
```csharp
SquareAnnotationElement annot = new SquareAnnotationElement(AnnotationElement.Object);
