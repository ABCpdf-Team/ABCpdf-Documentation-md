...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new RichMediaPositionElement. |  |  | 
...
| **[C#]** ```csharp RichMediaPositionElement() RichMediaPositionElement(Atom atom, IndirectObject host) RichMediaPositionElement(IndirectObject obj) RichMediaPositionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` RichMediaPositionElement() RichMediaPositionElement(atom As Atom, host As IndirectObject) RichMediaPositionElement(obj As IndirectObject) RichMediaPositionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
