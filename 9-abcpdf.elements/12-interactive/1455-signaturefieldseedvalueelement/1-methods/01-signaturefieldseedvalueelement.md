...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new SignatureFieldSeedValueElement. |  |  | 
...
| **[C#]** ```csharp SignatureFieldSeedValueElement() SignatureFieldSeedValueElement(Atom atom, IndirectObject host) SignatureFieldSeedValueElement(IndirectObject obj) SignatureFieldSeedValueElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` SignatureFieldSeedValueElement() SignatureFieldSeedValueElement(atom As Atom, host As IndirectObject) SignatureFieldSeedValueElement(obj As IndirectObject) SignatureFieldSeedValueElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
