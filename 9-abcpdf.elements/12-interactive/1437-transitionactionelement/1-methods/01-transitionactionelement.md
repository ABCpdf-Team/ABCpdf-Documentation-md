...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new TransitionActionElement. |  |  | 
...
| **[C#]** ```csharp TransitionActionElement() TransitionActionElement(Atom atom, IndirectObject host) TransitionActionElement(IndirectObject obj) TransitionActionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` TransitionActionElement() TransitionActionElement(atom As Atom, host As IndirectObject) TransitionActionElement(obj As IndirectObject) TransitionActionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
