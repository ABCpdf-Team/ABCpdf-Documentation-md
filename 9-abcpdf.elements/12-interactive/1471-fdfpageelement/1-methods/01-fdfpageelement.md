...
| **[C#]** ```csharp FDFPageElement() FDFPageElement(Atom atom, IndirectObject host) FDFPageElement(IndirectObject obj) FDFPageElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` FDFPageElement() FDFPageElement(atom As Atom, host As IndirectObject) FDFPageElement(obj As IndirectObject) FDFPageElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
