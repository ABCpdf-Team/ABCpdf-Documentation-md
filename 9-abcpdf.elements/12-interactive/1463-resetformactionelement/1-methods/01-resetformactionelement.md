...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new ResetFormActionElement. |  |  | 
...
| **[C#]** ```csharp ResetFormActionElement() ResetFormActionElement(Atom atom, IndirectObject host) ResetFormActionElement(IndirectObject obj) ResetFormActionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` ResetFormActionElement() ResetFormActionElement(atom As Atom, host As IndirectObject) ResetFormActionElement(obj As IndirectObject) ResetFormActionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
