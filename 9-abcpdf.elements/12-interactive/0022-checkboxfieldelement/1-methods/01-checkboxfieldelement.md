...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new CheckboxFieldElement. |  |  | 
...
| **[C#]** ```csharp CheckboxFieldElement() CheckboxFieldElement(Atom atom, IndirectObject host) CheckboxFieldElement(IndirectObject obj) CheckboxFieldElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` CheckboxFieldElement() CheckboxFieldElement(atom As Atom, host As IndirectObject) CheckboxFieldElement(obj As IndirectObject) CheckboxFieldElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
