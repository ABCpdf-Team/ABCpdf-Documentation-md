...
CheckboxFieldElement(Atom atom, IndirectObject host)
CheckboxFieldElement(IndirectObject obj)
CheckboxFieldElement(Element relation, CreationOptions options)
```
...
```
CheckboxFieldElement()
CheckboxFieldElement(atom As Atom, host As IndirectObject)
CheckboxFieldElement(obj As IndirectObject)
CheckboxFieldElement(relation As Element, options As CreationOptions)
```
