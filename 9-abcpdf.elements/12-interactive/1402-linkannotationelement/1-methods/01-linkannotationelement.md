...
LinkAnnotationElement(Atom atom, IndirectObject host)
LinkAnnotationElement(IndirectObject obj)
LinkAnnotationElement(Element relation, CreationOptions options)
```
...
```
LinkAnnotationElement()
LinkAnnotationElement(atom As Atom, host As IndirectObject)
LinkAnnotationElement(obj As IndirectObject)
LinkAnnotationElement(relation As Element, options As CreationOptions)
```
