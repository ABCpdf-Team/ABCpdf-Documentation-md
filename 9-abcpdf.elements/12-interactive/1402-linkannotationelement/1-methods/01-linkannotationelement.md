...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new LinkAnnotationElement. |  |  | 
...
| **[C#]** ```csharp LinkAnnotationElement() LinkAnnotationElement(Atom atom, IndirectObject host) LinkAnnotationElement(IndirectObject obj) LinkAnnotationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` LinkAnnotationElement() LinkAnnotationElement(atom As Atom, host As IndirectObject) LinkAnnotationElement(obj As IndirectObject) LinkAnnotationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
