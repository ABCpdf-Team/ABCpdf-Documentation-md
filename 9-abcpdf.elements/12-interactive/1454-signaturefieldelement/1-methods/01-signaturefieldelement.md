...
SignatureFieldElement(Atom atom, IndirectObject host)
SignatureFieldElement(IndirectObject obj)
SignatureFieldElement(Element relation, CreationOptions options)
```
...
```
SignatureFieldElement()
SignatureFieldElement(atom As Atom, host As IndirectObject)
SignatureFieldElement(obj As IndirectObject)
SignatureFieldElement(relation As Element, options As CreationOptions)
```
