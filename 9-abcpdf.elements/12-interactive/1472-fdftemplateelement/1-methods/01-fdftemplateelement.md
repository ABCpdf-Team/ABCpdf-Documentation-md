...
```csharp
FDFTemplateElement()
FDFTemplateElement(Atom atom, IndirectObject host)
FDFTemplateElement(IndirectObject obj)
FDFTemplateElement(Element relation, CreationOptions options)
```
...
```
FDFTemplateElement()
FDFTemplateElement(atom As Atom, host As IndirectObject)
FDFTemplateElement(obj As IndirectObject)
FDFTemplateElement(relation As Element, options As CreationOptions)
```
