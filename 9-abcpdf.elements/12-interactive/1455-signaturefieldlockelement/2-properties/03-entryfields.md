...
| --- | --- | --- | --- |
| **[C#]** ```csharp IList ``` [Visual Basic] `IList` | null | No | Represents the "Fields" entry of the signature field lock dictionary object. | 

## Notes

Represents the "Fields" entry of the signature field lock dictionary object.
