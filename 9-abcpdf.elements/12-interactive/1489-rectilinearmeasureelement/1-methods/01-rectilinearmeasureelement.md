...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new RectilinearMeasureElement. |  |  | 
...
| **[C#]** ```csharp RectilinearMeasureElement() RectilinearMeasureElement(Atom atom, IndirectObject host) RectilinearMeasureElement(IndirectObject obj) RectilinearMeasureElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` RectilinearMeasureElement() RectilinearMeasureElement(atom As Atom, host As IndirectObject) RectilinearMeasureElement(obj As IndirectObject) RectilinearMeasureElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
