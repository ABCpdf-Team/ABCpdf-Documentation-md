...
```csharp
ProjectionAnnotationElement()
ProjectionAnnotationElement(Atom atom, IndirectObject host)
ProjectionAnnotationElement(IndirectObject obj)
ProjectionAnnotationElement(Element relation, CreationOptions options)
```
...
```
ProjectionAnnotationElement()
ProjectionAnnotationElement(atom As Atom, host As IndirectObject)
ProjectionAnnotationElement(obj As IndirectObject)
ProjectionAnnotationElement(relation As Element, options As CreationOptions)
```
