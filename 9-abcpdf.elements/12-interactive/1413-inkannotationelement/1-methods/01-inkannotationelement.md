...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new InkAnnotationElement. |  |  | 
...
| **[C#]** ```csharp InkAnnotationElement() InkAnnotationElement(Atom atom, IndirectObject host) InkAnnotationElement(IndirectObject obj) InkAnnotationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` InkAnnotationElement() InkAnnotationElement(atom As Atom, host As IndirectObject) InkAnnotationElement(obj As IndirectObject) InkAnnotationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
