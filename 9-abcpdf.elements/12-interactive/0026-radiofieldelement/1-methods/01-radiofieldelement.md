...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new RadioFieldElement. |  |  | 
...
| **[C#]** ```csharp RadioFieldElement() RadioFieldElement(Atom atom, IndirectObject host) RadioFieldElement(IndirectObject obj) RadioFieldElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` RadioFieldElement() RadioFieldElement(atom As Atom, host As IndirectObject) RadioFieldElement(obj As IndirectObject) RadioFieldElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
