...
| --- | --- | --- | --- |
| **[C#]** ```csharp ImageXObjectElement ``` [Visual Basic] `ImageXObjectElement` | null | No | Represents the "Thumb" entry of the full file specification dictionary object. | 

## Notes

Represents the "Thumb" entry of the full file specification dictionary object.
