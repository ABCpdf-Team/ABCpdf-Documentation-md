---
title: "01-fullfilespecificationelement"
css: "abcpdf-docs.css"
---
...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new FullFileSpecificationElement. |  |  | 
...
| **[C#]** ```csharp FullFileSpecificationElement() FullFileSpecificationElement(Atom atom, IndirectObject host) FullFileSpecificationElement(IndirectObject obj) FullFileSpecificationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` FullFileSpecificationElement() FullFileSpecificationElement(atom As Atom, host As IndirectObject) FullFileSpecificationElement(obj As IndirectObject) FullFileSpecificationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
