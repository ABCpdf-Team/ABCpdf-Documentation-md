...
```csharp
FullFileSpecificationElement()
FullFileSpecificationElement(Atom atom, IndirectObject host)
FullFileSpecificationElement(IndirectObject obj)
FullFileSpecificationElement(Element relation, CreationOptions options)
```
...
```
FullFileSpecificationElement()
FullFileSpecificationElement(atom As Atom, host As IndirectObject)
FullFileSpecificationElement(obj As IndirectObject)
FullFileSpecificationElement(relation As Element, options As CreationOptions)
```
