...
| **[C#]** ```csharp TreeNodeElement() TreeNodeElement(Atom atom, IndirectObject host) TreeNodeElement(IndirectObject obj) TreeNodeElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` TreeNodeElement() TreeNodeElement(atom As Atom, host As IndirectObject) TreeNodeElement(obj As IndirectObject) TreeNodeElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
