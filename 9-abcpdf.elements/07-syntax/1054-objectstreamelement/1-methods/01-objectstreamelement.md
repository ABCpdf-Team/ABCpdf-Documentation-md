...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new ObjectStreamElement. |  |  | 
...
| **[C#]** ```csharp ObjectStreamElement() ObjectStreamElement(Atom atom, IndirectObject host) ObjectStreamElement(IndirectObject obj) ObjectStreamElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` ObjectStreamElement() ObjectStreamElement(atom As Atom, host As IndirectObject) ObjectStreamElement(obj As IndirectObject) ObjectStreamElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
