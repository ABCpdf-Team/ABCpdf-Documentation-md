...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new Type3FunctionElement. |  |  | 
...
| **[C#]** ```csharp Type3FunctionElement() Type3FunctionElement(Atom atom, IndirectObject host) Type3FunctionElement(IndirectObject obj) Type3FunctionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` Type3FunctionElement() Type3FunctionElement(atom As Atom, host As IndirectObject) Type3FunctionElement(obj As IndirectObject) Type3FunctionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
