...
| **[C#]** ```csharp StreamElement() StreamElement(Atom atom, IndirectObject host) StreamElement(IndirectObject obj) StreamElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` StreamElement() StreamElement(atom As Atom, host As IndirectObject) StreamElement(obj As IndirectObject) StreamElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
