...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new DeveloperExtensionsElement. |  |  | 
...
| **[C#]** ```csharp DeveloperExtensionsElement() DeveloperExtensionsElement(Atom atom, IndirectObject host) DeveloperExtensionsElement(IndirectObject obj) DeveloperExtensionsElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` DeveloperExtensionsElement() DeveloperExtensionsElement(atom As Atom, host As IndirectObject) DeveloperExtensionsElement(obj As IndirectObject) DeveloperExtensionsElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
