# EntryBaseVersion Property

| Type | Default Value | Read Only | Description | 
| --- | --- | --- | --- |
| **[C#]** ```csharp string ``` [Visual Basic] `string` | null | No | Represents the "BaseVersion" entry of the developer extensions dictionary object. | 

## Notes

Represents the "BaseVersion" entry of the developer extensions dictionary object.
