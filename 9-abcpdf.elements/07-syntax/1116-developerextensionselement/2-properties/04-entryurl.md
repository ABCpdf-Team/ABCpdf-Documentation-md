...
| --- | --- | --- | --- |
| **[C#]** ```csharp string ``` [Visual Basic] `string` | null | No | Represents the "URL" entry of the developer extensions dictionary object. | 

## Notes

Represents the "URL" entry of the developer extensions dictionary object.
