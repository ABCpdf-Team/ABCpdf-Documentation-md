...
```csharp
CollectionSubItemElement()
CollectionSubItemElement(Atom atom, IndirectObject host)
CollectionSubItemElement(IndirectObject obj)
CollectionSubItemElement(Element relation, CreationOptions options)
```
...
```
CollectionSubItemElement()
CollectionSubItemElement(atom As Atom, host As IndirectObject)
CollectionSubItemElement(obj As IndirectObject)
CollectionSubItemElement(relation As Element, options As CreationOptions)
```
