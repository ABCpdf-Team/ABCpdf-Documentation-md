...
```csharp
NameTreeNodeElement()
NameTreeNodeElement(Atom atom, IndirectObject host)
NameTreeNodeElement(IndirectObject obj)
NameTreeNodeElement(Element relation, CreationOptions options)
```
...
```
NameTreeNodeElement()
NameTreeNodeElement(atom As Atom, host As IndirectObject)
NameTreeNodeElement(obj As IndirectObject)
NameTreeNodeElement(relation As Element, options As CreationOptions)
```
