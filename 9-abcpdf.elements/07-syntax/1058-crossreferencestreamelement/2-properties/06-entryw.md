...
| --- | --- | --- | --- |
| **[C#]** ```csharp IList ``` [Visual Basic] `IList` | null | No | Represents the "W" entry of the cross-reference stream dictionary object. | 
...
[The ISO PDF Specification, ISO 32000-2:2017 PDF 2.0; Table: 17, page 66.](https://www.iso.org/standard/63534.md)
