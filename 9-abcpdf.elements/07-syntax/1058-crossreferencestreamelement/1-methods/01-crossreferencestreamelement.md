...
```csharp
CrossReferenceStreamElement()
CrossReferenceStreamElement(Atom atom, IndirectObject host)
CrossReferenceStreamElement(IndirectObject obj)
CrossReferenceStreamElement(Element relation, CreationOptions options)
```
...
```
CrossReferenceStreamElement()
CrossReferenceStreamElement(atom As Atom, host As IndirectObject)
CrossReferenceStreamElement(obj As IndirectObject)
CrossReferenceStreamElement(relation As Element, options As CreationOptions)
```
