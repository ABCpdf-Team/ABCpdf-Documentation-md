...
| --- | --- | --- | --- |
| **[C#]** ```csharp ArrayElementElement> ``` [Visual Basic] `ArrayElementElement>` | null | No | Represents the "UF" entry of the related file set dictionary object. | 

## Notes

Represents the "UF" entry of the related file set dictionary object.
