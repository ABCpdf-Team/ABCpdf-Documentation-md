...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new RelatedFileSetElement. |  |  | 
...
| **[C#]** ```csharp RelatedFileSetElement() RelatedFileSetElement(Atom atom, IndirectObject host) RelatedFileSetElement(IndirectObject obj) RelatedFileSetElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` RelatedFileSetElement() RelatedFileSetElement(atom As Atom, host As IndirectObject) RelatedFileSetElement(obj As IndirectObject) RelatedFileSetElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
