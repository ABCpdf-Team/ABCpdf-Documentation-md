...
```csharp
ExtensionsElement()
ExtensionsElement(Atom atom, IndirectObject host)
ExtensionsElement(IndirectObject obj)
ExtensionsElement(Element relation, CreationOptions options)
```
...
```
ExtensionsElement()
ExtensionsElement(atom As Atom, host As IndirectObject)
ExtensionsElement(obj As IndirectObject)
ExtensionsElement(relation As Element, options As CreationOptions)
```
