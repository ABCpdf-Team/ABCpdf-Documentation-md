...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new PublicKeyEncryptionElement. |  |  | 
...
| **[C#]** ```csharp PublicKeyEncryptionElement() PublicKeyEncryptionElement(Atom atom, IndirectObject host) PublicKeyEncryptionElement(IndirectObject obj) PublicKeyEncryptionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` PublicKeyEncryptionElement() PublicKeyEncryptionElement(atom As Atom, host As IndirectObject) PublicKeyEncryptionElement(obj As IndirectObject) PublicKeyEncryptionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
