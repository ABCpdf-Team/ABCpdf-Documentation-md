...
```csharp
<a href="../default.htm">PublicKeyEncryptionElement</a>()<a href="../default.htm">PublicKeyEncryptionElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">PublicKeyEncryptionElement</a>(IndirectObject obj)<a href="../default.htm">PublicKeyEncryptionElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">PublicKeyEncryptionElement</a>()<a href="../default.htm">PublicKeyEncryptionElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">PublicKeyEncryptionElement</a>(obj As IndirectObject)<a href="../default.htm">PublicKeyEncryptionElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
