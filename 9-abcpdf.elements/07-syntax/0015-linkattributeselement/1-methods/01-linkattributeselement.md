...
```csharp
LinkAttributesElement()
LinkAttributesElement(Atom atom, IndirectObject host)
LinkAttributesElement(IndirectObject obj)
LinkAttributesElement(Element relation, CreationOptions options)
```
...
```
LinkAttributesElement()
LinkAttributesElement(atom As Atom, host As IndirectObject)
LinkAttributesElement(obj As IndirectObject)
LinkAttributesElement(relation As Element, options As CreationOptions)
```
