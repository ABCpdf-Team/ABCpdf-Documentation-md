...
| **[C#]** ```csharp MatrixElement() MatrixElement(Atom atom, IndirectObject host) MatrixElement(IndirectObject obj) MatrixElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` MatrixElement() MatrixElement(atom As Atom, host As IndirectObject) MatrixElement(obj As IndirectObject) MatrixElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
