...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new FileSpecificationElement. |  |  | 
...
| **[C#]** ```csharp FileSpecificationElement() FileSpecificationElement(Atom atom, IndirectObject host) FileSpecificationElement(IndirectObject obj) FileSpecificationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` FileSpecificationElement() FileSpecificationElement(atom As Atom, host As IndirectObject) FileSpecificationElement(obj As IndirectObject) FileSpecificationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
