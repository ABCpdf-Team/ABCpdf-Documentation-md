...
```csharp
MacOSFileInformationElement()
MacOSFileInformationElement(Atom atom, IndirectObject host)
MacOSFileInformationElement(IndirectObject obj)
MacOSFileInformationElement(Element relation, CreationOptions options)
```
...
```
MacOSFileInformationElement()
MacOSFileInformationElement(atom As Atom, host As IndirectObject)
MacOSFileInformationElement(obj As IndirectObject)
MacOSFileInformationElement(relation As Element, options As CreationOptions)
```
