...
```csharp
FunctionElement()
FunctionElement(Atom atom, IndirectObject host)
FunctionElement(IndirectObject obj)
FunctionElement(Element relation, CreationOptions options)
```
...
```
FunctionElement()
FunctionElement(atom As Atom, host As IndirectObject)
FunctionElement(obj As IndirectObject)
FunctionElement(relation As Element, options As CreationOptions)
```
