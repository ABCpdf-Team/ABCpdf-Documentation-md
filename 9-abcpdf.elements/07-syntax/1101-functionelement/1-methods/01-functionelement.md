...
| **[C#]** ```csharp FunctionElement() FunctionElement(Atom atom, IndirectObject host) FunctionElement(IndirectObject obj) FunctionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` FunctionElement() FunctionElement(atom As Atom, host As IndirectObject) FunctionElement(obj As IndirectObject) FunctionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
