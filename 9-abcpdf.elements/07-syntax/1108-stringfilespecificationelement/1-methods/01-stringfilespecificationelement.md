...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new StringFileSpecificationElement. |  |  | 
...
| **[C#]** ```csharp StringFileSpecificationElement() StringFileSpecificationElement(Atom atom, IndirectObject host) StringFileSpecificationElement(IndirectObject obj) StringFileSpecificationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` StringFileSpecificationElement() StringFileSpecificationElement(atom As Atom, host As IndirectObject) StringFileSpecificationElement(obj As IndirectObject) StringFileSpecificationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
