...
```csharp
Type0FunctionElement()
Type0FunctionElement(Atom atom, IndirectObject host)
Type0FunctionElement(IndirectObject obj)
Type0FunctionElement(Element relation, CreationOptions options)
```
...
```
Type0FunctionElement()
Type0FunctionElement(atom As Atom, host As IndirectObject)
Type0FunctionElement(obj As IndirectObject)
Type0FunctionElement(relation As Element, options As CreationOptions)
```
