...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new Jbig2ParametersElement. |  |  | 
...
| **[C#]** ```csharp Jbig2ParametersElement() Jbig2ParametersElement(Atom atom, IndirectObject host) Jbig2ParametersElement(IndirectObject obj) Jbig2ParametersElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` Jbig2ParametersElement() Jbig2ParametersElement(atom As Atom, host As IndirectObject) Jbig2ParametersElement(obj As IndirectObject) Jbig2ParametersElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
