...
```csharp
<a href="../default.htm">NameDictionaryElement</a>()<a href="../default.htm">NameDictionaryElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">NameDictionaryElement</a>(IndirectObject obj)<a href="../default.htm">NameDictionaryElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">NameDictionaryElement</a>()<a href="../default.htm">NameDictionaryElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">NameDictionaryElement</a>(obj As IndirectObject)<a href="../default.htm">NameDictionaryElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
This code snippet is taken from NameTree.cs line 90 in the Annotations example project.
...
if (cat.EntryNames == null)
  cat.EntryNames = new <a href="../default.htm">NameDictionaryElement</a>(cat);
if (cat.EntryNames.EntryEmbeddedFiles == null) {
  cat.EntryNames.EntryEmbeddedFiles = new <a href="../../1097-nametreenodeelement_t_/default.htm">NameTreeNodeElement</a><<a href="../../0011-filespecificationelement/default.htm">FileSpecificationElement</a>>(cat);
  cat.EntryNames.EntryEmbeddedFiles.EntryNames = new <a href="../../../01-base/0001-arrayelement_t_/default.htm">ArrayElement</a><<a href="../../../01-base/1086-element/default.htm">Element</a>>(cat);
}
