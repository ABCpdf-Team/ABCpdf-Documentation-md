...
```csharp
<a href="../default.htm">EmbeddedFileParameterElement</a>()<a href="../default.htm">EmbeddedFileParameterElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">EmbeddedFileParameterElement</a>(IndirectObject obj)<a href="../default.htm">EmbeddedFileParameterElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">EmbeddedFileParameterElement</a>()<a href="../default.htm">EmbeddedFileParameterElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">EmbeddedFileParameterElement</a>(obj As IndirectObject)<a href="../default.htm">EmbeddedFileParameterElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
This code snippet is taken from NameTree.cs line 53 in the Annotations example project.
...
if (obj.Length > 64)
  obj.CompressFlate();
<a href="../../1112-embeddedfilestreamelement/default.htm">EmbeddedFileStreamElement</a> fs = new <a href="../../1112-embeddedfilestreamelement/default.htm">EmbeddedFileStreamElement</a>(obj);
fs.EntryType = "EmbeddedFile";
fs.EntrySubtype = GetContentType(filePath);
fs.EntryParams = new <a href="../default.htm">EmbeddedFileParameterElement</a>(fs);
