...
```csharp
EmbeddedFileParameterElement()
EmbeddedFileParameterElement(Atom atom, IndirectObject host)
EmbeddedFileParameterElement(IndirectObject obj)
EmbeddedFileParameterElement(Element relation, CreationOptions options)
```
...
```
EmbeddedFileParameterElement()
EmbeddedFileParameterElement(atom As Atom, host As IndirectObject)
EmbeddedFileParameterElement(obj As IndirectObject)
EmbeddedFileParameterElement(relation As Element, options As CreationOptions)
```
