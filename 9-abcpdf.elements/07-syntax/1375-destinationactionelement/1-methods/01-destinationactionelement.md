...
```csharp
DestinationActionElement()
DestinationActionElement(Atom atom, IndirectObject host)
DestinationActionElement(IndirectObject obj)
DestinationActionElement(Element relation, CreationOptions options)
```
...
```
DestinationActionElement()
DestinationActionElement(atom As Atom, host As IndirectObject)
DestinationActionElement(obj As IndirectObject)
DestinationActionElement(relation As Element, options As CreationOptions)
```
