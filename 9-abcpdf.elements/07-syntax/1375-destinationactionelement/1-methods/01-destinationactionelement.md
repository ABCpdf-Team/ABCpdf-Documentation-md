...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new DestinationActionElement. |  |  | 
...
| **[C#]** ```csharp DestinationActionElement() DestinationActionElement(Atom atom, IndirectObject host) DestinationActionElement(IndirectObject obj) DestinationActionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` DestinationActionElement() DestinationActionElement(atom As Atom, host As IndirectObject) DestinationActionElement(obj As IndirectObject) DestinationActionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
