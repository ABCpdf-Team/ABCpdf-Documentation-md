...
```csharp
PageTreeNodeElement()
PageTreeNodeElement(Atom atom, IndirectObject host)
PageTreeNodeElement(IndirectObject obj)
PageTreeNodeElement(Element relation, CreationOptions options)
```
...
```
PageTreeNodeElement()
PageTreeNodeElement(atom As Atom, host As IndirectObject)
PageTreeNodeElement(obj As IndirectObject)
PageTreeNodeElement(relation As Element, options As CreationOptions)
```
