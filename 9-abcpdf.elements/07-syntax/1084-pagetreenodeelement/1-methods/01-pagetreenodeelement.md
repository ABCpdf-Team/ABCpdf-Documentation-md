...
```csharp
<a href="../default.htm">PageTreeNodeElement</a>()<a href="../default.htm">PageTreeNodeElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">PageTreeNodeElement</a>(IndirectObject obj)<a href="../default.htm">PageTreeNodeElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">PageTreeNodeElement</a>()<a href="../default.htm">PageTreeNodeElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">PageTreeNodeElement</a>(obj As IndirectObject)<a href="../default.htm">PageTreeNodeElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
