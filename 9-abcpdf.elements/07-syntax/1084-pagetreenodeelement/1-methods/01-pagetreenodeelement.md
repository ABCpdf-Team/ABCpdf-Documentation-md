...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new PageTreeNodeElement. |  |  | 
...
| **[C#]** ```csharp PageTreeNodeElement() PageTreeNodeElement(Atom atom, IndirectObject host) PageTreeNodeElement(IndirectObject obj) PageTreeNodeElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` PageTreeNodeElement() PageTreeNodeElement(atom As Atom, host As IndirectObject) PageTreeNodeElement(obj As IndirectObject) PageTreeNodeElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
