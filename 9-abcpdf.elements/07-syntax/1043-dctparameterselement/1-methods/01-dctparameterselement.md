...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new DctParametersElement. |  |  | 
...
| **[C#]** ```csharp DctParametersElement() DctParametersElement(Atom atom, IndirectObject host) DctParametersElement(IndirectObject obj) DctParametersElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` DctParametersElement() DctParametersElement(atom As Atom, host As IndirectObject) DctParametersElement(obj As IndirectObject) DctParametersElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
