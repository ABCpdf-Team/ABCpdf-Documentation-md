...
```csharp
DctParametersElement()
DctParametersElement(Atom atom, IndirectObject host)
DctParametersElement(IndirectObject obj)
DctParametersElement(Element relation, CreationOptions options)
```
...
```
DctParametersElement()
DctParametersElement(atom As Atom, host As IndirectObject)
DctParametersElement(obj As IndirectObject)
DctParametersElement(relation As Element, options As CreationOptions)
```
