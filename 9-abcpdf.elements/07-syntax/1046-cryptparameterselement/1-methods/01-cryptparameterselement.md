...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new CryptParametersElement. |  |  | 
...
| **[C#]** ```csharp CryptParametersElement() CryptParametersElement(Atom atom, IndirectObject host) CryptParametersElement(IndirectObject obj) CryptParametersElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` CryptParametersElement() CryptParametersElement(atom As Atom, host As IndirectObject) CryptParametersElement(obj As IndirectObject) CryptParametersElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
