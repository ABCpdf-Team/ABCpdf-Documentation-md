...
```csharp
StandardEncryptionElement()
StandardEncryptionElement(Atom atom, IndirectObject host)
StandardEncryptionElement(IndirectObject obj)
StandardEncryptionElement(Element relation, CreationOptions options)
```
...
```
StandardEncryptionElement()
StandardEncryptionElement(atom As Atom, host As IndirectObject)
StandardEncryptionElement(obj As IndirectObject)
StandardEncryptionElement(relation As Element, options As CreationOptions)
```
