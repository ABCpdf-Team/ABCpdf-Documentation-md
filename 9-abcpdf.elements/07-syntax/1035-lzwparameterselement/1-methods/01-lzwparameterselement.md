...
```csharp
LzwParametersElement()
LzwParametersElement(Atom atom, IndirectObject host)
LzwParametersElement(IndirectObject obj)
LzwParametersElement(Element relation, CreationOptions options)
```
...
```
LzwParametersElement()
LzwParametersElement(atom As Atom, host As IndirectObject)
LzwParametersElement(obj As IndirectObject)
LzwParametersElement(relation As Element, options As CreationOptions)
```
