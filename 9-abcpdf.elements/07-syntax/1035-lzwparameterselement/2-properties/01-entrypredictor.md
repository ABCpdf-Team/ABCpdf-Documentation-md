...
| --- | --- | --- | --- |
| **[C#]** ```csharp int? ``` [Visual Basic] `Integer?` | null | No | Represents the "Predictor" entry of the lzw parameters object. | 

## Notes

Represents the "Predictor" entry of the lzw parameters object.
