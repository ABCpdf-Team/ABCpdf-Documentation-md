...
| --- | --- | --- | --- |
| **[C#]** ```csharp ArrayElementElement> ``` [Visual Basic] `ArrayElementElement>` | null | No | This property represents the "Nums" entry of the number tree node dictionary object. | 

## Notes

This property represents the "Nums" entry of the number tree node dictionary object.
