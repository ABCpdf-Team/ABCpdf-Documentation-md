...
```csharp
NumberTreeNodeElement()
NumberTreeNodeElement(Atom atom, IndirectObject host)
NumberTreeNodeElement(IndirectObject obj)
NumberTreeNodeElement(Element relation, CreationOptions options)
```
...
```
NumberTreeNodeElement()
NumberTreeNodeElement(atom As Atom, host As IndirectObject)
NumberTreeNodeElement(obj As IndirectObject)
NumberTreeNodeElement(relation As Element, options As CreationOptions)
```
