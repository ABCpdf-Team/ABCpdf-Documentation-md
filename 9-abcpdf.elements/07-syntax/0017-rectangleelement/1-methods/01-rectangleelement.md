...
```csharp
<a href="../default.htm">RectangleElement</a>()<a href="../default.htm">RectangleElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">RectangleElement</a>(IndirectObject obj)<a href="../default.htm">RectangleElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">RectangleElement</a>()<a href="../default.htm">RectangleElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">RectangleElement</a>(obj As IndirectObject)<a href="../default.htm">RectangleElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
```csharp
<a href="../../../12-interactive/1391-annotationelement/2-properties/03-entryrect.htm">AnnotationElement.EntryRect</a> = new <a href="../default.htm">RectangleElement</a>(ArrayAtom.FromXRect(value), AnnotationElement.Host);
```
