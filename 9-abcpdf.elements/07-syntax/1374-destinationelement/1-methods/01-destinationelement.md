...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new DestinationElement. |  |  | 
...
| **[C#]** ```csharp DestinationElement() DestinationElement(Atom atom, IndirectObject host) DestinationElement(IndirectObject obj) DestinationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` DestinationElement() DestinationElement(atom As Atom, host As IndirectObject) DestinationElement(obj As IndirectObject) DestinationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
