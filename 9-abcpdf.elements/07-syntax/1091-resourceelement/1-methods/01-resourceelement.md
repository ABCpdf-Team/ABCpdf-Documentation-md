...
| **[C#]** ```csharp ResourceElement() ResourceElement(Atom atom, IndirectObject host) ResourceElement(IndirectObject obj) ResourceElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` ResourceElement() ResourceElement(atom As Atom, host As IndirectObject) ResourceElement(obj As IndirectObject) ResourceElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
