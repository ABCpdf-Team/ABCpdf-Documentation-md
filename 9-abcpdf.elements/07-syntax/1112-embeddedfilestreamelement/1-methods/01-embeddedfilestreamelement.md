...
```csharp
<a href="../default.htm">EmbeddedFileStreamElement</a>()<a href="../default.htm">EmbeddedFileStreamElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">EmbeddedFileStreamElement</a>(IndirectObject obj)<a href="../default.htm">EmbeddedFileStreamElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">EmbeddedFileStreamElement</a>()<a href="../default.htm">EmbeddedFileStreamElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">EmbeddedFileStreamElement</a>(obj As IndirectObject)<a href="../default.htm">EmbeddedFileStreamElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
This code snippet is taken from Annotations.cs line 128 in the Annotations example project.

[C#]

```csharp
string filePath = info.FullName;
StreamObject obj = new StreamObject(Form.Doc.ObjectSoup, filePath);
if (obj.Length > 64)
  obj.CompressFlate();
<a href="../default.htm">EmbeddedFileStreamElement</a> fs = new <a href="../default.htm">EmbeddedFileStreamElement</a>(obj);
fs.EntryType = "EmbeddedFile";
fs.EntrySubtype = GetContentType(filePath);
fs.EntryParams = new <a href="../../1112-embeddedfileparameterelement/default.htm">EmbeddedFileParameterElement</a>(fs);
fs.EntryParams.EntrySize = (int)info.Length;
fs.EntryParams.EntryModDate = <a href="../../../../../../PDF10000/Manual/7-abcpdf.atoms/stringatom/1-methods/datetostring.htm">StringAtom.DateToString</a>(info.LastWriteTimeUtc);
fs.EntryParams.EntryCreationDate = <a href="../../../../../../PDF10000/Manual/7-abcpdf.atoms/stringatom/1-methods/datetostring.htm">StringAtom.DateToString</a>(info.CreationTimeUtc);
return fs;
```
