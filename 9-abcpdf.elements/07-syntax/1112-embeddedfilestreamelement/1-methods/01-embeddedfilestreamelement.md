...
```csharp
EmbeddedFileStreamElement()
EmbeddedFileStreamElement(Atom atom, IndirectObject host)
EmbeddedFileStreamElement(IndirectObject obj)
EmbeddedFileStreamElement(Element relation, CreationOptions options)
```
...
```
EmbeddedFileStreamElement()
EmbeddedFileStreamElement(atom As Atom, host As IndirectObject)
EmbeddedFileStreamElement(obj As IndirectObject)
EmbeddedFileStreamElement(relation As Element, options As CreationOptions)
```
