...
```csharp
ColorElement()
ColorElement(Atom atom, IndirectObject host)
ColorElement(IndirectObject obj)
ColorElement(Element relation, CreationOptions options)
```
...
```
ColorElement()
ColorElement(atom As Atom, host As IndirectObject)
ColorElement(obj As IndirectObject)
ColorElement(relation As Element, options As CreationOptions)
```
