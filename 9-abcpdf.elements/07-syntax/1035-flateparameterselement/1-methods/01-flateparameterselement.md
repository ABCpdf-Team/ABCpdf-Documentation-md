...
FlateParametersElement(Atom atom, IndirectObject host)
FlateParametersElement(IndirectObject obj)
FlateParametersElement(Element relation, CreationOptions options)
```
...
```
FlateParametersElement()
FlateParametersElement(atom As Atom, host As IndirectObject)
FlateParametersElement(obj As IndirectObject)
FlateParametersElement(relation As Element, options As CreationOptions)
```
