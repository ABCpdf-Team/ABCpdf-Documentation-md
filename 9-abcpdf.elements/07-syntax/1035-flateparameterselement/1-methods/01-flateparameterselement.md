...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new FlateParametersElement. |  |  | 
...
| **[C#]** ```csharp FlateParametersElement() FlateParametersElement(Atom atom, IndirectObject host) FlateParametersElement(IndirectObject obj) FlateParametersElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` FlateParametersElement() FlateParametersElement(atom As Atom, host As IndirectObject) FlateParametersElement(obj As IndirectObject) FlateParametersElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
