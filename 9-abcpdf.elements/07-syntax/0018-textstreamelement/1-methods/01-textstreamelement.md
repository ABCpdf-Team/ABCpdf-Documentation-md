...
```csharp
<a href="../default.htm">TextStreamElement</a>()<a href="../default.htm">TextStreamElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">TextStreamElement</a>(IndirectObject obj)<a href="../default.htm">TextStreamElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">TextStreamElement</a>()<a href="../default.htm">TextStreamElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">TextStreamElement</a>(obj As IndirectObject)<a href="../default.htm">TextStreamElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
