...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new TextStreamElement. |  |  | 
...
| **[C#]** ```csharp TextStreamElement() TextStreamElement(Atom atom, IndirectObject host) TextStreamElement(IndirectObject obj) TextStreamElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` TextStreamElement() TextStreamElement(atom As Atom, host As IndirectObject) TextStreamElement(obj As IndirectObject) TextStreamElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
