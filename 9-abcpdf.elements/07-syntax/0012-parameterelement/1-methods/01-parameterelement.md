...
```csharp
ParameterElement()
ParameterElement(Atom atom, IndirectObject host)
ParameterElement(IndirectObject obj)
ParameterElement(Element relation, CreationOptions options)
```
...
```
ParameterElement()
ParameterElement(atom As Atom, host As IndirectObject)
ParameterElement(obj As IndirectObject)
ParameterElement(relation As Element, options As CreationOptions)
```
