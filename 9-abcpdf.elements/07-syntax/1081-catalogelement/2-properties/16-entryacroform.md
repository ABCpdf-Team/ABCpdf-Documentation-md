...
It contains an [InteractiveFormElement](../../../12-interactive/1439-interactiveformelement/default.md).

The [InteractiveFormElement](../../../12-interactive/1439-interactiveformelement/default.md) contains the root of any field information for the document.

Fields are represented as an abstract tree structure of [FieldElements](../../../12-interactive/1440-fieldelement/default.md), spanning the entire document.
...
So to make them visible, leaf [FieldElements](../../../12-interactive/1440-fieldelement/default.md) need to be linked to [WidgetAnnotationElements](../../../12-interactive/1416-widgetannotationelement/default.md) placed on individual pages of the document.
