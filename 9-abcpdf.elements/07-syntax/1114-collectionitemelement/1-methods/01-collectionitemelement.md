...
CollectionItemElement(Atom atom, IndirectObject host)
CollectionItemElement(IndirectObject obj)
CollectionItemElement(Element relation, CreationOptions options)
```
...
```
CollectionItemElement()
CollectionItemElement(atom As Atom, host As IndirectObject)
CollectionItemElement(obj As IndirectObject)
CollectionItemElement(relation As Element, options As CreationOptions)
```
