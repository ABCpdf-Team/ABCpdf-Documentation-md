---
title: "01-collectionitemelement"
css: "abcpdf-docs.css"
---
...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new CollectionItemElement. |  |  | 
...
| **[C#]** ```csharp CollectionItemElement() CollectionItemElement(Atom atom, IndirectObject host) CollectionItemElement(IndirectObject obj) CollectionItemElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` CollectionItemElement() CollectionItemElement(atom As Atom, host As IndirectObject) CollectionItemElement(obj As IndirectObject) CollectionItemElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
