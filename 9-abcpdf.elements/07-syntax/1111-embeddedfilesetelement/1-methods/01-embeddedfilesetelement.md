...
```csharp
EmbeddedFileSetElement()
EmbeddedFileSetElement(Atom atom, IndirectObject host)
EmbeddedFileSetElement(IndirectObject obj)
EmbeddedFileSetElement(Element relation, CreationOptions options)
```
...
```
EmbeddedFileSetElement()
EmbeddedFileSetElement(atom As Atom, host As IndirectObject)
EmbeddedFileSetElement(obj As IndirectObject)
EmbeddedFileSetElement(relation As Element, options As CreationOptions)
```
