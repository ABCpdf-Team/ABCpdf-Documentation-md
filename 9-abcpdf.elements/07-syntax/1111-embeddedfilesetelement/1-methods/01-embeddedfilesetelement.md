...
```csharp
<a href="../default.htm">EmbeddedFileSetElement</a>()<a href="../default.htm">EmbeddedFileSetElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">EmbeddedFileSetElement</a>(IndirectObject obj)<a href="../default.htm">EmbeddedFileSetElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">EmbeddedFileSetElement</a>()<a href="../default.htm">EmbeddedFileSetElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">EmbeddedFileSetElement</a>(obj As IndirectObject)<a href="../default.htm">EmbeddedFileSetElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
This code snippet is taken from NameTree.cs line 36 in the Annotations example project.

[C#]

```csharp
FileInfo info = new FileInfo(filePath);
<a href="../../1112-embeddedfilestreamelement/default.htm">EmbeddedFileStreamElement</a> stream = EmbedFileStream(info, soup);
<a href="../../1081-catalogelement/default.htm">CatalogElement</a> cat = new <a href="../../1081-catalogelement/default.htm">CatalogElement</a>(soup.Catalog);
<a href="../../1110-fullfilespecificationelement/default.htm">FullFileSpecificationElement</a> file = new <a href="../../1110-fullfilespecificationelement/default.htm">FullFileSpecificationElement</a>(cat);
file.EntryType = "Filespec";
file.EntryF = info.Name;
file.EntryUF = info.Name;
file.EntryEF = new <a href="../default.htm">EmbeddedFileSetElement</a>(file);
