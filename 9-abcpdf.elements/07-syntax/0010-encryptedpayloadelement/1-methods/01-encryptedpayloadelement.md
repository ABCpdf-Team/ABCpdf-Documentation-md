...
EncryptedPayloadElement(Atom atom, IndirectObject host)
EncryptedPayloadElement(IndirectObject obj)
EncryptedPayloadElement(Element relation, CreationOptions options)
```
...
```
EncryptedPayloadElement()
EncryptedPayloadElement(atom As Atom, host As IndirectObject)
EncryptedPayloadElement(obj As IndirectObject)
EncryptedPayloadElement(relation As Element, options As CreationOptions)
```
