...
```csharp
<a href="../default.htm">EncryptedPayloadElement</a>()<a href="../default.htm">EncryptedPayloadElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">EncryptedPayloadElement</a>(IndirectObject obj)<a href="../default.htm">EncryptedPayloadElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">EncryptedPayloadElement</a>()<a href="../default.htm">EncryptedPayloadElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">EncryptedPayloadElement</a>(obj As IndirectObject)<a href="../default.htm">EncryptedPayloadElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
