...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new EncryptedPayloadElement. |  |  | 
...
| **[C#]** ```csharp EncryptedPayloadElement() EncryptedPayloadElement(Atom atom, IndirectObject host) EncryptedPayloadElement(IndirectObject obj) EncryptedPayloadElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` EncryptedPayloadElement() EncryptedPayloadElement(atom As Atom, host As IndirectObject) EncryptedPayloadElement(obj As IndirectObject) EncryptedPayloadElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
