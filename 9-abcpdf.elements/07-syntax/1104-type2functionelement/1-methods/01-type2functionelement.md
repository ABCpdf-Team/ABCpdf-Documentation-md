...
Type2FunctionElement(Atom atom, IndirectObject host)
Type2FunctionElement(IndirectObject obj)
Type2FunctionElement(Element relation, CreationOptions options)
```
...
```
Type2FunctionElement()
Type2FunctionElement(atom As Atom, host As IndirectObject)
Type2FunctionElement(obj As IndirectObject)
Type2FunctionElement(relation As Element, options As CreationOptions)
```
