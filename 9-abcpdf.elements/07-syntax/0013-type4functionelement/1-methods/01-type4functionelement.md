...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new Type4FunctionElement. |  |  | 
...
| **[C#]** ```csharp Type4FunctionElement() Type4FunctionElement(Atom atom, IndirectObject host) Type4FunctionElement(IndirectObject obj) Type4FunctionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` Type4FunctionElement() Type4FunctionElement(atom As Atom, host As IndirectObject) Type4FunctionElement(obj As IndirectObject) Type4FunctionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
