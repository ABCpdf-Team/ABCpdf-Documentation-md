...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new CryptFilterElement. |  |  | 
...
| **[C#]** ```csharp CryptFilterElement() CryptFilterElement(Atom atom, IndirectObject host) CryptFilterElement(IndirectObject obj) CryptFilterElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` CryptFilterElement() CryptFilterElement(atom As Atom, host As IndirectObject) CryptFilterElement(obj As IndirectObject) CryptFilterElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
