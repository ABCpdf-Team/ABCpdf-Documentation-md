...
| --- | --- | --- | --- |
| **[C#]** ```csharp int? ``` [Visual Basic] `Integer?` | null | No | Represents the "Length" entry of the crypt filter dictionary object. | 
...
[The ISO PDF Specification, ISO 32000-2:2017 PDF 2.0; Table: 25, page 91.](https://www.iso.org/standard/63534.md)
