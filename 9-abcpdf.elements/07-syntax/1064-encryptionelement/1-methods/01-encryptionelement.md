...
```csharp
EncryptionElement()
EncryptionElement(Atom atom, IndirectObject host)
EncryptionElement(IndirectObject obj)
EncryptionElement(Element relation, CreationOptions options)
```
...
```
EncryptionElement()
EncryptionElement(atom As Atom, host As IndirectObject)
EncryptionElement(obj As IndirectObject)
EncryptionElement(relation As Element, options As CreationOptions)
```
