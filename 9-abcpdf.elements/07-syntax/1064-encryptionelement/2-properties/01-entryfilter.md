...
| --- | --- | --- | --- |
| **[C#]** ```csharp string ``` [Visual Basic] `string` | null | No | Represents the "Filter" entry of the encryption dictionary object. | 

## Notes

Represents the "Filter" entry of the encryption dictionary object.
