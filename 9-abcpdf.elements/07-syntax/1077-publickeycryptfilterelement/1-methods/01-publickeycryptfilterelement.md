...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new PublicKeyCryptFilterElement. |  |  | 
...
| **[C#]** ```csharp PublicKeyCryptFilterElement() PublicKeyCryptFilterElement(Atom atom, IndirectObject host) PublicKeyCryptFilterElement(IndirectObject obj) PublicKeyCryptFilterElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` PublicKeyCryptFilterElement() PublicKeyCryptFilterElement(atom As Atom, host As IndirectObject) PublicKeyCryptFilterElement(obj As IndirectObject) PublicKeyCryptFilterElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
