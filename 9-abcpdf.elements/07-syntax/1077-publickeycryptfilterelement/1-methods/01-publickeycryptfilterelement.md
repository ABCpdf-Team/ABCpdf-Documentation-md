...
```csharp
PublicKeyCryptFilterElement()
PublicKeyCryptFilterElement(Atom atom, IndirectObject host)
PublicKeyCryptFilterElement(IndirectObject obj)
PublicKeyCryptFilterElement(Element relation, CreationOptions options)
```
...
```
PublicKeyCryptFilterElement()
PublicKeyCryptFilterElement(atom As Atom, host As IndirectObject)
PublicKeyCryptFilterElement(obj As IndirectObject)
PublicKeyCryptFilterElement(relation As Element, options As CreationOptions)
```
