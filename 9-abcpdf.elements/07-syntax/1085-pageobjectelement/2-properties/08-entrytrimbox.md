...
| --- | --- | --- | --- |
| **[C#]** ```csharp RectangleElement ``` [Visual Basic] `RectangleElement` | null | No | Represents the "TrimBox" entry of the page object object. | 

## Notes

Represents the "TrimBox" entry of the page object object.
