...
| --- | --- | --- | --- |
| **[C#]** ```csharp ResourceElement ``` [Visual Basic] `ResourceElement` | null | No | Represents the "Resources" entry of the page object object. | 

## Notes

Represents the "Resources" entry of the page object object.
