...
```csharp
<a href="../default.htm">PageObjectElement</a>()<a href="../default.htm">PageObjectElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">PageObjectElement</a>(IndirectObject obj)<a href="../default.htm">PageObjectElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">PageObjectElement</a>()<a href="../default.htm">PageObjectElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">PageObjectElement</a>(obj As IndirectObject)<a href="../default.htm">PageObjectElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
This code snippet is taken from Annotations.cs line 191 in the Annotations example project.

[C#]

```csharp
if (Form.Doc.Page == 0)
  throw new ArgumentException("No page available");
var page = new <a href="../default.htm">PageObjectElement</a>(Form.Doc.ObjectSoup[Form.Doc.Page]);
<a href="../../../12-interactive/1391-annotationelement/2-properties/05-entryp.htm">AnnotationElement.EntryP</a> = page;
if (page.EntryAnnots == null)
  page.EntryAnnots = new <a href="../../../01-base/0001-arrayelement_t_/default.htm">ArrayElement</a><<a href="../../../12-interactive/1391-annotationelement/default.htm">AnnotationElement</a>>(<a href="../../../12-interactive/1391-annotationelement/default.htm">AnnotationElement</a>);
page.EntryAnnots.Add(<a href="../../../12-interactive/1391-annotationelement/default.htm">AnnotationElement</a>);
```
