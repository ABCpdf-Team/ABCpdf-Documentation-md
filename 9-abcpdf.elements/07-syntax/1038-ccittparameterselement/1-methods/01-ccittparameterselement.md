...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new CcittParametersElement. |  |  | 
...
| **[C#]** ```csharp CcittParametersElement() CcittParametersElement(Atom atom, IndirectObject host) CcittParametersElement(IndirectObject obj) CcittParametersElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` CcittParametersElement() CcittParametersElement(atom As Atom, host As IndirectObject) CcittParametersElement(obj As IndirectObject) CcittParametersElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
