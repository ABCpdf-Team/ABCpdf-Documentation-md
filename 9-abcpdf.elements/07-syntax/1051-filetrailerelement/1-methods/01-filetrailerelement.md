...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new FileTrailerElement. |  |  | 
...
| **[C#]** ```csharp FileTrailerElement() FileTrailerElement(Atom atom, IndirectObject host) FileTrailerElement(IndirectObject obj) FileTrailerElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` FileTrailerElement() FileTrailerElement(atom As Atom, host As IndirectObject) FileTrailerElement(obj As IndirectObject) FileTrailerElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
