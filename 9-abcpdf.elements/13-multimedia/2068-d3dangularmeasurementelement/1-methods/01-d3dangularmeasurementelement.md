...
```csharp
D3DAngularMeasurementElement()
D3DAngularMeasurementElement(Atom atom, IndirectObject host)
D3DAngularMeasurementElement(IndirectObject obj)
D3DAngularMeasurementElement(Element relation, CreationOptions options)
```
...
```
D3DAngularMeasurementElement()
D3DAngularMeasurementElement(atom As Atom, host As IndirectObject)
D3DAngularMeasurementElement(obj As IndirectObject)
D3DAngularMeasurementElement(relation As Element, options As CreationOptions)
```
