...
```csharp
D3DBackgroundElement()
D3DBackgroundElement(Atom atom, IndirectObject host)
D3DBackgroundElement(IndirectObject obj)
D3DBackgroundElement(Element relation, CreationOptions options)
```
...
```
D3DBackgroundElement()
D3DBackgroundElement(atom As Atom, host As IndirectObject)
D3DBackgroundElement(obj As IndirectObject)
D3DBackgroundElement(relation As Element, options As CreationOptions)
```
