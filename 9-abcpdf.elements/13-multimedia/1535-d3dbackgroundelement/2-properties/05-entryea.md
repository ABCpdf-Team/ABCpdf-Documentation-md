...
| --- | --- | --- | --- |
| **[C#]** ```csharp bool? ``` [Visual Basic] `Boolean?` | null | No | Represents the "EA" entry of the 3d background dictionary object. | 

## Notes

Represents the "EA" entry of the 3d background dictionary object.
