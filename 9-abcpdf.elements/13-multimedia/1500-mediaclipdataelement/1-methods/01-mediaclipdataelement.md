...
```csharp
<a href="../default.htm">MediaClipDataElement</a>()<a href="../default.htm">MediaClipDataElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">MediaClipDataElement</a>(IndirectObject obj)<a href="../default.htm">MediaClipDataElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">MediaClipDataElement</a>()<a href="../default.htm">MediaClipDataElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">MediaClipDataElement</a>(obj As IndirectObject)<a href="../default.htm">MediaClipDataElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
Create a new [MediaClipDataElement](default.md).
...
<a href="../default.htm">MediaClipDataElement</a> mediaClip = new <a href="../default.htm">MediaClipDataElement</a>(annot, CreationOptions.Indirect);
mediaClip.EntryS = "MCD";
mediaClip.EntryP = new <a href="../../1502-mediapermissionselement/default.htm">MediaPermissionsElement</a>(annot);
mediaClip.EntryP.EntryTF = "TEMPACCESS";
mediaClip.EntryCT = contentType;
mediaClip.EntryD = fileSpec;

<a href="../../1499-mediarenditionelement/default.htm">MediaRenditionElement</a> rendition = new <a href="../../1499-mediarenditionelement/default.htm">MediaRenditionElement</a>(annot, CreationOptions.Indirect);
rendition.EntryS = "MR";
