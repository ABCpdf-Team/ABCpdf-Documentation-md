...
```csharp
MediaClipDataElement()
MediaClipDataElement(Atom atom, IndirectObject host)
MediaClipDataElement(IndirectObject obj)
MediaClipDataElement(Element relation, CreationOptions options)
```
...
```
MediaClipDataElement()
MediaClipDataElement(atom As Atom, host As IndirectObject)
MediaClipDataElement(obj As IndirectObject)
MediaClipDataElement(relation As Element, options As CreationOptions)
```
