...
| --- | --- | --- | --- |
| **[C#]** ```csharp ArrayElementElement> ``` [Visual Basic] `ArrayElementElement>` | null | No | Represents the "AC" entry of the render mode dictionary object. | 

## Notes

Represents the "AC" entry of the render mode dictionary object.
