...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new RenderModeElement. |  |  | 
...
| **[C#]** ```csharp RenderModeElement() RenderModeElement(Atom atom, IndirectObject host) RenderModeElement(IndirectObject obj) RenderModeElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` RenderModeElement() RenderModeElement(atom As Atom, host As IndirectObject) RenderModeElement(obj As IndirectObject) RenderModeElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
