...
```csharp
RenderModeElement()
RenderModeElement(Atom atom, IndirectObject host)
RenderModeElement(IndirectObject obj)
RenderModeElement(Element relation, CreationOptions options)
```
...
```
RenderModeElement()
RenderModeElement(atom As Atom, host As IndirectObject)
RenderModeElement(obj As IndirectObject)
RenderModeElement(relation As Element, options As CreationOptions)
```
