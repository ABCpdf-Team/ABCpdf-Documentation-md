...
```csharp
MediaPlayParametersMhBeElement()
MediaPlayParametersMhBeElement(Atom atom, IndirectObject host)
MediaPlayParametersMhBeElement(IndirectObject obj)
MediaPlayParametersMhBeElement(Element relation, CreationOptions options)
```
...
```
MediaPlayParametersMhBeElement()
MediaPlayParametersMhBeElement(atom As Atom, host As IndirectObject)
MediaPlayParametersMhBeElement(obj As IndirectObject)
MediaPlayParametersMhBeElement(relation As Element, options As CreationOptions)
```
