---
title: "01-mediaplayparametersmhbeelement"
css: "abcpdf-docs.css"
---

|  |  | MediaPlayParametersMhBeElement Function |  |  | 
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new MediaPlayParametersMhBeElement. |  |  | 
...
| **[C#]** ```csharp MediaPlayParametersMhBeElement() MediaPlayParametersMhBeElement(Atom atom, IndirectObject host) MediaPlayParametersMhBeElement(IndirectObject obj) MediaPlayParametersMhBeElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` MediaPlayParametersMhBeElement() MediaPlayParametersMhBeElement(atom As Atom, host As IndirectObject) MediaPlayParametersMhBeElement(obj As IndirectObject) MediaPlayParametersMhBeElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
