...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new D3DAnnotationElement. |  |  | 
...
| **[C#]** ```csharp D3DAnnotationElement() D3DAnnotationElement(Atom atom, IndirectObject host) D3DAnnotationElement(IndirectObject obj) D3DAnnotationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` D3DAnnotationElement() D3DAnnotationElement(atom As Atom, host As IndirectObject) D3DAnnotationElement(obj As IndirectObject) D3DAnnotationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
