...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new MinimumScreenSizeElement. |  |  | 
...
| **[C#]** ```csharp MinimumScreenSizeElement() MinimumScreenSizeElement(Atom atom, IndirectObject host) MinimumScreenSizeElement(IndirectObject obj) MinimumScreenSizeElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` MinimumScreenSizeElement() MinimumScreenSizeElement(atom As Atom, host As IndirectObject) MinimumScreenSizeElement(obj As IndirectObject) MinimumScreenSizeElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
