...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new RenditionMhBeElement. |  |  | 
...
| **[C#]** ```csharp RenditionMhBeElement() RenditionMhBeElement(Atom atom, IndirectObject host) RenditionMhBeElement(IndirectObject obj) RenditionMhBeElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` RenditionMhBeElement() RenditionMhBeElement(atom As Atom, host As IndirectObject) RenditionMhBeElement(obj As IndirectObject) RenditionMhBeElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
