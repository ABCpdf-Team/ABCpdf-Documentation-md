...
```csharp
RenditionMhBeElement()
RenditionMhBeElement(Atom atom, IndirectObject host)
RenditionMhBeElement(IndirectObject obj)
RenditionMhBeElement(Element relation, CreationOptions options)
```
...
```
RenditionMhBeElement()
RenditionMhBeElement(atom As Atom, host As IndirectObject)
RenditionMhBeElement(obj As IndirectObject)
RenditionMhBeElement(relation As Element, options As CreationOptions)
```
