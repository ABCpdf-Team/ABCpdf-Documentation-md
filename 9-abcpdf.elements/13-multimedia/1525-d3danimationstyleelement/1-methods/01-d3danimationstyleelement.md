# D3DAnimationStyleElement Function
...
```csharp
<a href="../default.htm">D3DAnimationStyleElement</a>()<a href="../default.htm">D3DAnimationStyleElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">D3DAnimationStyleElement</a>(IndirectObject obj)<a href="../default.htm">D3DAnimationStyleElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">D3DAnimationStyleElement</a>()<a href="../default.htm">D3DAnimationStyleElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">D3DAnimationStyleElement</a>(obj As IndirectObject)<a href="../default.htm">D3DAnimationStyleElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
Create a new [D3DAnimationStyleElement](default.md).
