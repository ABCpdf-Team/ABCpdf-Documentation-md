---
title: "01-d3danimationstyleelement"
css: "abcpdf-docs.css"
---
...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new D3DAnimationStyleElement. |  |  | 
...
| **[C#]** ```csharp D3DAnimationStyleElement() D3DAnimationStyleElement(Atom atom, IndirectObject host) D3DAnimationStyleElement(IndirectObject obj) D3DAnimationStyleElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` D3DAnimationStyleElement() D3DAnimationStyleElement(atom As Atom, host As IndirectObject) D3DAnimationStyleElement(obj As IndirectObject) D3DAnimationStyleElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
