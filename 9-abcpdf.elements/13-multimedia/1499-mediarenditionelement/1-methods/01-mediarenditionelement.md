...
```csharp
MediaRenditionElement()
MediaRenditionElement(Atom atom, IndirectObject host)
MediaRenditionElement(IndirectObject obj)
MediaRenditionElement(Element relation, CreationOptions options)
```
...
```
MediaRenditionElement()
MediaRenditionElement(atom As Atom, host As IndirectObject)
MediaRenditionElement(obj As IndirectObject)
MediaRenditionElement(relation As Element, options As CreationOptions)
```
