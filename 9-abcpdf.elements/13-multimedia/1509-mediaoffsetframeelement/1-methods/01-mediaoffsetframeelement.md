...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new MediaOffsetFrameElement. |  |  | 
...
| **[C#]** ```csharp MediaOffsetFrameElement() MediaOffsetFrameElement(Atom atom, IndirectObject host) MediaOffsetFrameElement(IndirectObject obj) MediaOffsetFrameElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` MediaOffsetFrameElement() MediaOffsetFrameElement(atom As Atom, host As IndirectObject) MediaOffsetFrameElement(obj As IndirectObject) MediaOffsetFrameElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
