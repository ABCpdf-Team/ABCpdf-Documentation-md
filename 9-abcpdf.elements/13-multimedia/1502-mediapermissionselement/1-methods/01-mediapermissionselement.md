...
```csharp
MediaPermissionsElement()
MediaPermissionsElement(Atom atom, IndirectObject host)
MediaPermissionsElement(IndirectObject obj)
MediaPermissionsElement(Element relation, CreationOptions options)
```
...
```
MediaPermissionsElement()
MediaPermissionsElement(atom As Atom, host As IndirectObject)
MediaPermissionsElement(obj As IndirectObject)
MediaPermissionsElement(relation As Element, options As CreationOptions)
```
