...
```csharp
MediaPlayerInfoElement()
MediaPlayerInfoElement(Atom atom, IndirectObject host)
MediaPlayerInfoElement(IndirectObject obj)
MediaPlayerInfoElement(Element relation, CreationOptions options)
```
...
```
MediaPlayerInfoElement()
MediaPlayerInfoElement(atom As Atom, host As IndirectObject)
MediaPlayerInfoElement(obj As IndirectObject)
MediaPlayerInfoElement(relation As Element, options As CreationOptions)
```
