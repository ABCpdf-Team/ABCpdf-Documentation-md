...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new MediaPlayerInfoElement. |  |  | 
...
| **[C#]** ```csharp MediaPlayerInfoElement() MediaPlayerInfoElement(Atom atom, IndirectObject host) MediaPlayerInfoElement(IndirectObject obj) MediaPlayerInfoElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` MediaPlayerInfoElement() MediaPlayerInfoElement(atom As Atom, host As IndirectObject) MediaPlayerInfoElement(obj As IndirectObject) MediaPlayerInfoElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
