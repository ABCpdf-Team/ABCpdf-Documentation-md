...
```csharp
D3DUnitsElement()
D3DUnitsElement(Atom atom, IndirectObject host)
D3DUnitsElement(IndirectObject obj)
D3DUnitsElement(Element relation, CreationOptions options)
```
...
```
D3DUnitsElement()
D3DUnitsElement(atom As Atom, host As IndirectObject)
D3DUnitsElement(obj As IndirectObject)
D3DUnitsElement(relation As Element, options As CreationOptions)
```
