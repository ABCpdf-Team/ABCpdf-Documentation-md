...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new MediaCriteriaElement. |  |  | 
...
| **[C#]** ```csharp MediaCriteriaElement() MediaCriteriaElement(Atom atom, IndirectObject host) MediaCriteriaElement(IndirectObject obj) MediaCriteriaElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` MediaCriteriaElement() MediaCriteriaElement(atom As Atom, host As IndirectObject) MediaCriteriaElement(obj As IndirectObject) MediaCriteriaElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
