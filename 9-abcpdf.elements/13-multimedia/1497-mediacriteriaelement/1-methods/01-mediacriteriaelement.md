...
```csharp
MediaCriteriaElement()
MediaCriteriaElement(Atom atom, IndirectObject host)
MediaCriteriaElement(IndirectObject obj)
MediaCriteriaElement(Element relation, CreationOptions options)
```
...
```
MediaCriteriaElement()
MediaCriteriaElement(atom As Atom, host As IndirectObject)
MediaCriteriaElement(obj As IndirectObject)
MediaCriteriaElement(relation As Element, options As CreationOptions)
```
