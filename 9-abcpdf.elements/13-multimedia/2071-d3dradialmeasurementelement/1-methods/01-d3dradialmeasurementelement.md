...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new D3DRadialMeasurementElement. |  |  | 
...
| **[C#]** ```csharp D3DRadialMeasurementElement() D3DRadialMeasurementElement(Atom atom, IndirectObject host) D3DRadialMeasurementElement(IndirectObject obj) D3DRadialMeasurementElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` D3DRadialMeasurementElement() D3DRadialMeasurementElement(atom As Atom, host As IndirectObject) D3DRadialMeasurementElement(obj As IndirectObject) D3DRadialMeasurementElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
