...
```csharp
<a href="../default.htm">SelectorRenditionElement</a>()<a href="../default.htm">SelectorRenditionElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">SelectorRenditionElement</a>(IndirectObject obj)<a href="../default.htm">SelectorRenditionElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">SelectorRenditionElement</a>()<a href="../default.htm">SelectorRenditionElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">SelectorRenditionElement</a>(obj As IndirectObject)<a href="../default.htm">SelectorRenditionElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
