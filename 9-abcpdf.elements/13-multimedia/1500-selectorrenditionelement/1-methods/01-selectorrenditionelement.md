...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new SelectorRenditionElement. |  |  | 
...
| **[C#]** ```csharp SelectorRenditionElement() SelectorRenditionElement(Atom atom, IndirectObject host) SelectorRenditionElement(IndirectObject obj) SelectorRenditionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` SelectorRenditionElement() SelectorRenditionElement(atom As Atom, host As IndirectObject) SelectorRenditionElement(obj As IndirectObject) SelectorRenditionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
