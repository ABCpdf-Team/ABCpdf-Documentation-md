...
```csharp
MediaClipElement()
MediaClipElement(Atom atom, IndirectObject host)
MediaClipElement(IndirectObject obj)
MediaClipElement(Element relation, CreationOptions options)
```
...
```
MediaClipElement()
MediaClipElement(atom As Atom, host As IndirectObject)
MediaClipElement(obj As IndirectObject)
MediaClipElement(relation As Element, options As CreationOptions)
```
