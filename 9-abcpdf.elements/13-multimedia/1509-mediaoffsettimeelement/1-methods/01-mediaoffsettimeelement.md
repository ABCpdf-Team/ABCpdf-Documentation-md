...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new MediaOffsetTimeElement. |  |  | 
...
| **[C#]** ```csharp MediaOffsetTimeElement() MediaOffsetTimeElement(Atom atom, IndirectObject host) MediaOffsetTimeElement(IndirectObject obj) MediaOffsetTimeElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` MediaOffsetTimeElement() MediaOffsetTimeElement(atom As Atom, host As IndirectObject) MediaOffsetTimeElement(obj As IndirectObject) MediaOffsetTimeElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
