...
```csharp
MovieElement()
MovieElement(Atom atom, IndirectObject host)
MovieElement(IndirectObject obj)
MovieElement(Element relation, CreationOptions options)
```
...
```
MovieElement()
MovieElement(atom As Atom, host As IndirectObject)
MovieElement(obj As IndirectObject)
MovieElement(relation As Element, options As CreationOptions)
```
