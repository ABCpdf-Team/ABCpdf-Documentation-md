...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new D3DCommentNoteElement. |  |  | 
...
| **[C#]** ```csharp D3DCommentNoteElement() D3DCommentNoteElement(Atom atom, IndirectObject host) D3DCommentNoteElement(IndirectObject obj) D3DCommentNoteElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` D3DCommentNoteElement() D3DCommentNoteElement(atom As Atom, host As IndirectObject) D3DCommentNoteElement(obj As IndirectObject) D3DCommentNoteElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
