...
```csharp
D3DCommentNoteElement()
D3DCommentNoteElement(Atom atom, IndirectObject host)
D3DCommentNoteElement(IndirectObject obj)
D3DCommentNoteElement(Element relation, CreationOptions options)
```
...
```
D3DCommentNoteElement()
D3DCommentNoteElement(atom As Atom, host As IndirectObject)
D3DCommentNoteElement(obj As IndirectObject)
D3DCommentNoteElement(relation As Element, options As CreationOptions)
```
