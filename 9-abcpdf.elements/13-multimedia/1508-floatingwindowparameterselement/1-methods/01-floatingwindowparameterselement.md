...
FloatingWindowParametersElement(Atom atom, IndirectObject host)
FloatingWindowParametersElement(IndirectObject obj)
FloatingWindowParametersElement(Element relation, CreationOptions options)
```
...
```
FloatingWindowParametersElement()
FloatingWindowParametersElement(atom As Atom, host As IndirectObject)
FloatingWindowParametersElement(obj As IndirectObject)
FloatingWindowParametersElement(relation As Element, options As CreationOptions)
```
