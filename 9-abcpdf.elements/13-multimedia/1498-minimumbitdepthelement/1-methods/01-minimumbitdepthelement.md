...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new MinimumBitDepthElement. |  |  | 
...
| **[C#]** ```csharp MinimumBitDepthElement() MinimumBitDepthElement(Atom atom, IndirectObject host) MinimumBitDepthElement(IndirectObject obj) MinimumBitDepthElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` MinimumBitDepthElement() MinimumBitDepthElement(atom As Atom, host As IndirectObject) MinimumBitDepthElement(obj As IndirectObject) MinimumBitDepthElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
