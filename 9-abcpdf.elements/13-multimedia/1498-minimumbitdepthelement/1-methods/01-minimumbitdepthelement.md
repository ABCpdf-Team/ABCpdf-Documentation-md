...
```csharp
MinimumBitDepthElement()
MinimumBitDepthElement(Atom atom, IndirectObject host)
MinimumBitDepthElement(IndirectObject obj)
MinimumBitDepthElement(Element relation, CreationOptions options)
```
...
```
MinimumBitDepthElement()
MinimumBitDepthElement(atom As Atom, host As IndirectObject)
MinimumBitDepthElement(obj As IndirectObject)
MinimumBitDepthElement(relation As Element, options As CreationOptions)
```
