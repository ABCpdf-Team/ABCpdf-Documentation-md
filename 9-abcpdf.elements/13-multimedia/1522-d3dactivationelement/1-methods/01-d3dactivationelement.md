...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new D3DActivationElement. |  |  | 
...
| **[C#]** ```csharp D3DActivationElement() D3DActivationElement(Atom atom, IndirectObject host) D3DActivationElement(IndirectObject obj) D3DActivationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` D3DActivationElement() D3DActivationElement(atom As Atom, host As IndirectObject) D3DActivationElement(obj As IndirectObject) D3DActivationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
