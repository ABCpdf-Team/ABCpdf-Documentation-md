...
| --- | --- | --- | --- |
| **[C#]** ```csharp string ``` [Visual Basic] `string` | null | No | Represents the "MS" entry of the 3d view dictionary object. | 

## Notes

Represents the "MS" entry of the 3d view dictionary object.
