---
title: "17-entrysnapshot"
css: "abcpdf-docs.css"
---

# EntrySnapshot Property

| Type | Default Value | Read Only | Description | 
| --- | --- | --- | --- |
| **[C#]** ```csharp ImageXObjectElement ``` [Visual Basic] `ImageXObjectElement` | null | No | Represents the "Snapshot" entry of the 3d view dictionary object. | 

## Notes

Represents the "Snapshot" entry of the 3d view dictionary object.
