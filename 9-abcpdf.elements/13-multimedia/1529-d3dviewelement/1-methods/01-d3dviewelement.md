...
| **[C#]** ```csharp D3DViewElement() D3DViewElement(Atom atom, IndirectObject host) D3DViewElement(IndirectObject obj) D3DViewElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` D3DViewElement() D3DViewElement(atom As Atom, host As IndirectObject) D3DViewElement(obj As IndirectObject) D3DViewElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
