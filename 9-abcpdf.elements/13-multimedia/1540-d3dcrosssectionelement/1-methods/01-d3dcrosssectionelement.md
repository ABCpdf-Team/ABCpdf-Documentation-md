...
```csharp
D3DCrossSectionElement()
D3DCrossSectionElement(Atom atom, IndirectObject host)
D3DCrossSectionElement(IndirectObject obj)
D3DCrossSectionElement(Element relation, CreationOptions options)
```
...
```
D3DCrossSectionElement()
D3DCrossSectionElement(atom As Atom, host As IndirectObject)
D3DCrossSectionElement(obj As IndirectObject)
D3DCrossSectionElement(relation As Element, options As CreationOptions)
```
