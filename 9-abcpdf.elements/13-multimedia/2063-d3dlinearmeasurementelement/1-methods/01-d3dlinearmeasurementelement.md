...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new D3DLinearMeasurementElement. |  |  | 
...
| **[C#]** ```csharp D3DLinearMeasurementElement() D3DLinearMeasurementElement(Atom atom, IndirectObject host) D3DLinearMeasurementElement(IndirectObject obj) D3DLinearMeasurementElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` D3DLinearMeasurementElement() D3DLinearMeasurementElement(atom As Atom, host As IndirectObject) D3DLinearMeasurementElement(obj As IndirectObject) D3DLinearMeasurementElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
