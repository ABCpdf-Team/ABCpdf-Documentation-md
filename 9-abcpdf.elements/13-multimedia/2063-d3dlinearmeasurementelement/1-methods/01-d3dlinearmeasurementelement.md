...
```csharp
D3DLinearMeasurementElement()
D3DLinearMeasurementElement(Atom atom, IndirectObject host)
D3DLinearMeasurementElement(IndirectObject obj)
D3DLinearMeasurementElement(Element relation, CreationOptions options)
```
...
```
D3DLinearMeasurementElement()
D3DLinearMeasurementElement(atom As Atom, host As IndirectObject)
D3DLinearMeasurementElement(obj As IndirectObject)
D3DLinearMeasurementElement(relation As Element, options As CreationOptions)
```
