...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new SoundObjectStreamElement. |  |  | 
...
| **[C#]** ```csharp SoundObjectStreamElement() SoundObjectStreamElement(Atom atom, IndirectObject host) SoundObjectStreamElement(IndirectObject obj) SoundObjectStreamElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` SoundObjectStreamElement() SoundObjectStreamElement(atom As Atom, host As IndirectObject) SoundObjectStreamElement(obj As IndirectObject) SoundObjectStreamElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
