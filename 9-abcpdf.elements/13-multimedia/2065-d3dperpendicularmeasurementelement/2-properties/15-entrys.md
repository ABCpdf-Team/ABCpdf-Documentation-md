...
| --- | --- | --- | --- |
| **[C#]** ```csharp ProjectionAnnotationElement ``` [Visual Basic] `ProjectionAnnotationElement` | null | No | Represents the "S" entry of the 3d perpendicular dimension measurement object. | 

## Notes

Represents the "S" entry of the 3d perpendicular dimension measurement object.
