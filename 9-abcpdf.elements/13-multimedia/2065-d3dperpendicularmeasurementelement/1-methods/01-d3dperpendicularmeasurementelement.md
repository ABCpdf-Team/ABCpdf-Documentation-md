...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new D3DPerpendicularMeasurementElement. |  |  | 
...
| **[C#]** ```csharp D3DPerpendicularMeasurementElement() D3DPerpendicularMeasurementElement(Atom atom, IndirectObject host) D3DPerpendicularMeasurementElement(IndirectObject obj) D3DPerpendicularMeasurementElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` D3DPerpendicularMeasurementElement() D3DPerpendicularMeasurementElement(atom As Atom, host As IndirectObject) D3DPerpendicularMeasurementElement(obj As IndirectObject) D3DPerpendicularMeasurementElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
