...
```csharp
MediaScreenParametersMhBeElement()
MediaScreenParametersMhBeElement(Atom atom, IndirectObject host)
MediaScreenParametersMhBeElement(IndirectObject obj)
MediaScreenParametersMhBeElement(Element relation, CreationOptions options)
```
...
```
MediaScreenParametersMhBeElement()
MediaScreenParametersMhBeElement(atom As Atom, host As IndirectObject)
MediaScreenParametersMhBeElement(obj As IndirectObject)
MediaScreenParametersMhBeElement(relation As Element, options As CreationOptions)
```
