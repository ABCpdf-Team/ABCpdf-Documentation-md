...
```csharp
D3DLightingSchemeElement()
D3DLightingSchemeElement(Atom atom, IndirectObject host)
D3DLightingSchemeElement(IndirectObject obj)
D3DLightingSchemeElement(Element relation, CreationOptions options)
```
...
```
D3DLightingSchemeElement()
D3DLightingSchemeElement(atom As Atom, host As IndirectObject)
D3DLightingSchemeElement(obj As IndirectObject)
D3DLightingSchemeElement(relation As Element, options As CreationOptions)
```
