...
| **[C#]** ```csharp D3DStreamElement() D3DStreamElement(Atom atom, IndirectObject host) D3DStreamElement(IndirectObject obj) D3DStreamElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` D3DStreamElement() D3DStreamElement(atom As Atom, host As IndirectObject) D3DStreamElement(obj As IndirectObject) D3DStreamElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
