...
```csharp
D3DNodeElement()
D3DNodeElement(Atom atom, IndirectObject host)
D3DNodeElement(IndirectObject obj)
D3DNodeElement(Element relation, CreationOptions options)
```
...
```
D3DNodeElement()
D3DNodeElement(atom As Atom, host As IndirectObject)
D3DNodeElement(obj As IndirectObject)
D3DNodeElement(relation As Element, options As CreationOptions)
```
