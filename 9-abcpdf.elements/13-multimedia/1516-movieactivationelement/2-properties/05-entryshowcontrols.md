...
| --- | --- | --- | --- |
| **[C#]** ```csharp bool? ``` [Visual Basic] `Boolean?` | null | No | Represents the "ShowControls" entry of the movie activation dictionary object. | 

## Notes

Represents the "ShowControls" entry of the movie activation dictionary object.
