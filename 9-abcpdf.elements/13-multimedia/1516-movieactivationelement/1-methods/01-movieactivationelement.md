...
```csharp
MovieActivationElement()
MovieActivationElement(Atom atom, IndirectObject host)
MovieActivationElement(IndirectObject obj)
MovieActivationElement(Element relation, CreationOptions options)
```
...
```
MovieActivationElement()
MovieActivationElement(atom As Atom, host As IndirectObject)
MovieActivationElement(obj As IndirectObject)
MovieActivationElement(relation As Element, options As CreationOptions)
```
