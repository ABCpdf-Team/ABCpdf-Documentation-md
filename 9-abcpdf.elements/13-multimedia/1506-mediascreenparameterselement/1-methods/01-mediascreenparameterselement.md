...
```csharp
MediaScreenParametersElement()
MediaScreenParametersElement(Atom atom, IndirectObject host)
MediaScreenParametersElement(IndirectObject obj)
MediaScreenParametersElement(Element relation, CreationOptions options)
```
...
```
MediaScreenParametersElement()
MediaScreenParametersElement(atom As Atom, host As IndirectObject)
MediaScreenParametersElement(obj As IndirectObject)
MediaScreenParametersElement(relation As Element, options As CreationOptions)
```
