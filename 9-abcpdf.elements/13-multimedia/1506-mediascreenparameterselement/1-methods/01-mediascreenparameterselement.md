...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new MediaScreenParametersElement. |  |  | 
...
| **[C#]** ```csharp MediaScreenParametersElement() MediaScreenParametersElement(Atom atom, IndirectObject host) MediaScreenParametersElement(IndirectObject obj) MediaScreenParametersElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` MediaScreenParametersElement() MediaScreenParametersElement(atom As Atom, host As IndirectObject) MediaScreenParametersElement(obj As IndirectObject) MediaScreenParametersElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
