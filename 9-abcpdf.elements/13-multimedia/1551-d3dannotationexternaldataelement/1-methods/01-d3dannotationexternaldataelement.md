...
```csharp
D3DAnnotationExternalDataElement()
D3DAnnotationExternalDataElement(Atom atom, IndirectObject host)
D3DAnnotationExternalDataElement(IndirectObject obj)
D3DAnnotationExternalDataElement(Element relation, CreationOptions options)
```
...
```
D3DAnnotationExternalDataElement()
D3DAnnotationExternalDataElement(atom As Atom, host As IndirectObject)
D3DAnnotationExternalDataElement(obj As IndirectObject)
D3DAnnotationExternalDataElement(relation As Element, options As CreationOptions)
```
