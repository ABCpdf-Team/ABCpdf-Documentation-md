---
title: "01-mediaclipsectionmhbeelement"
css: "abcpdf-docs.css"
---
...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new MediaClipSectionMhBeElement. |  |  | 
...
| **[C#]** ```csharp MediaClipSectionMhBeElement() MediaClipSectionMhBeElement(Atom atom, IndirectObject host) MediaClipSectionMhBeElement(IndirectObject obj) MediaClipSectionMhBeElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` MediaClipSectionMhBeElement() MediaClipSectionMhBeElement(atom As Atom, host As IndirectObject) MediaClipSectionMhBeElement(obj As IndirectObject) MediaClipSectionMhBeElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
