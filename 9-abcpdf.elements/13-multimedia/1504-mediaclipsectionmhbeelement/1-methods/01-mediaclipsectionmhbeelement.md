...
```csharp
MediaClipSectionMhBeElement()
MediaClipSectionMhBeElement(Atom atom, IndirectObject host)
MediaClipSectionMhBeElement(IndirectObject obj)
MediaClipSectionMhBeElement(Element relation, CreationOptions options)
```
...
```
MediaClipSectionMhBeElement()
MediaClipSectionMhBeElement(atom As Atom, host As IndirectObject)
MediaClipSectionMhBeElement(obj As IndirectObject)
MediaClipSectionMhBeElement(relation As Element, options As CreationOptions)
```
