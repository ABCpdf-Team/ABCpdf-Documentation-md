...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new MediaPlayParametersElement. |  |  | 
...
| **[C#]** ```csharp MediaPlayParametersElement() MediaPlayParametersElement(Atom atom, IndirectObject host) MediaPlayParametersElement(IndirectObject obj) MediaPlayParametersElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` MediaPlayParametersElement() MediaPlayParametersElement(atom As Atom, host As IndirectObject) MediaPlayParametersElement(obj As IndirectObject) MediaPlayParametersElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
