...
```csharp
MediaClipSectionElement()
MediaClipSectionElement(Atom atom, IndirectObject host)
MediaClipSectionElement(IndirectObject obj)
MediaClipSectionElement(Element relation, CreationOptions options)
```
...
```
MediaClipSectionElement()
MediaClipSectionElement(atom As Atom, host As IndirectObject)
MediaClipSectionElement(obj As IndirectObject)
MediaClipSectionElement(relation As Element, options As CreationOptions)
```
