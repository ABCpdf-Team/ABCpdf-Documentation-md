...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new D3DReferenceElement. |  |  | 
...
| **[C#]** ```csharp D3DReferenceElement() D3DReferenceElement(Atom atom, IndirectObject host) D3DReferenceElement(IndirectObject obj) D3DReferenceElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` D3DReferenceElement() D3DReferenceElement(atom As Atom, host As IndirectObject) D3DReferenceElement(obj As IndirectObject) D3DReferenceElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
