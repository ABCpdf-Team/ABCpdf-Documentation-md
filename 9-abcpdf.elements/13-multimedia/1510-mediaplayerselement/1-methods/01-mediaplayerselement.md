...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new MediaPlayersElement. |  |  | 
...
| **[C#]** ```csharp MediaPlayersElement() MediaPlayersElement(Atom atom, IndirectObject host) MediaPlayersElement(IndirectObject obj) MediaPlayersElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` MediaPlayersElement() MediaPlayersElement(atom As Atom, host As IndirectObject) MediaPlayersElement(obj As IndirectObject) MediaPlayersElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
