...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new MediaDurationElement. |  |  | 
...
| **[C#]** ```csharp MediaDurationElement() MediaDurationElement(Atom atom, IndirectObject host) MediaDurationElement(IndirectObject obj) MediaDurationElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` MediaDurationElement() MediaDurationElement(atom As Atom, host As IndirectObject) MediaDurationElement(obj As IndirectObject) MediaDurationElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
