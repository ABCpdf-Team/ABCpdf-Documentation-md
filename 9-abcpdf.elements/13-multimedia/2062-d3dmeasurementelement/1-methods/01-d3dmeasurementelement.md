---
title: "01-d3dmeasurementelement"
css: "abcpdf-docs.css"
---
...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new D3DMeasurementElement. |  |  | 
...
| **[C#]** ```csharp D3DMeasurementElement() D3DMeasurementElement(Atom atom, IndirectObject host) D3DMeasurementElement(IndirectObject obj) D3DMeasurementElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` D3DMeasurementElement() D3DMeasurementElement(atom As Atom, host As IndirectObject) D3DMeasurementElement(obj As IndirectObject) D3DMeasurementElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
