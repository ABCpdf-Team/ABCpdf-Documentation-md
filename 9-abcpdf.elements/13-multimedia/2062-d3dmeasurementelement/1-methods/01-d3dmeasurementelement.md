...
```csharp
D3DMeasurementElement()
D3DMeasurementElement(Atom atom, IndirectObject host)
D3DMeasurementElement(IndirectObject obj)
D3DMeasurementElement(Element relation, CreationOptions options)
```
...
```
D3DMeasurementElement()
D3DMeasurementElement(atom As Atom, host As IndirectObject)
D3DMeasurementElement(obj As IndirectObject)
D3DMeasurementElement(relation As Element, options As CreationOptions)
```
