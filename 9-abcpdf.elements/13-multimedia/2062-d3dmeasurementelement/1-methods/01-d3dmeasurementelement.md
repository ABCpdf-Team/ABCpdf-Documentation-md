# D3DMeasurementElement Function
...
```csharp
<a href="../default.htm">D3DMeasurementElement</a>()<a href="../default.htm">D3DMeasurementElement</a>(Atom atom, IndirectObject host)<a href="../default.htm">D3DMeasurementElement</a>(IndirectObject obj)<a href="../default.htm">D3DMeasurementElement</a>(<a href="../../../01-base/1086-element/default.htm">Element</a> relation, CreationOptions options)
```

[Visual Basic]

```vb
<a href="../default.htm">D3DMeasurementElement</a>()<a href="../default.htm">D3DMeasurementElement</a>(atom As Atom, host As IndirectObject)<a href="../default.htm">D3DMeasurementElement</a>(obj As IndirectObject)<a href="../default.htm">D3DMeasurementElement</a>(relation As <a href="../../../01-base/1086-element/default.htm">Element</a>, options As CreationOptions)
```
...
Create a new [D3DMeasurementElement](default.md).
