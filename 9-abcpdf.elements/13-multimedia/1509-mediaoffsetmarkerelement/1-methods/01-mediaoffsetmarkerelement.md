...
MediaOffsetMarkerElement(Atom atom, IndirectObject host)
MediaOffsetMarkerElement(IndirectObject obj)
MediaOffsetMarkerElement(Element relation, CreationOptions options)
```
...
```
MediaOffsetMarkerElement()
MediaOffsetMarkerElement(atom As Atom, host As IndirectObject)
MediaOffsetMarkerElement(obj As IndirectObject)
MediaOffsetMarkerElement(relation As Element, options As CreationOptions)
```
