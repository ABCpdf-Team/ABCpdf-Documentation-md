...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new MediaOffsetElement. |  |  | 
...
| **[C#]** ```csharp MediaOffsetElement() MediaOffsetElement(Atom atom, IndirectObject host) MediaOffsetElement(IndirectObject obj) MediaOffsetElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` MediaOffsetElement() MediaOffsetElement(atom As Atom, host As IndirectObject) MediaOffsetElement(obj As IndirectObject) MediaOffsetElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
