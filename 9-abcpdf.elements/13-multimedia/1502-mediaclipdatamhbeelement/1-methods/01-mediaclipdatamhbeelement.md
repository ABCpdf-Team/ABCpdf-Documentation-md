...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new MediaClipDataMhBeElement. |  |  | 
...
| **[C#]** ```csharp MediaClipDataMhBeElement() MediaClipDataMhBeElement(Atom atom, IndirectObject host) MediaClipDataMhBeElement(IndirectObject obj) MediaClipDataMhBeElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` MediaClipDataMhBeElement() MediaClipDataMhBeElement(atom As Atom, host As IndirectObject) MediaClipDataMhBeElement(obj As IndirectObject) MediaClipDataMhBeElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
