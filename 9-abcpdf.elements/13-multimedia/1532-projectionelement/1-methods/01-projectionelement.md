...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new ProjectionElement. |  |  | 
...
| **[C#]** ```csharp ProjectionElement() ProjectionElement(Atom atom, IndirectObject host) ProjectionElement(IndirectObject obj) ProjectionElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` ProjectionElement() ProjectionElement(atom As Atom, host As IndirectObject) ProjectionElement(obj As IndirectObject) ProjectionElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
