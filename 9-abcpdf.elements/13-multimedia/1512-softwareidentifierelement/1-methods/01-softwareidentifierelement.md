...
| --- | --- | --- | --- | --- |
|  |  |  | 
| Create a new SoftwareIdentifierElement. |  |  | 
...
| **[C#]** ```csharp SoftwareIdentifierElement() SoftwareIdentifierElement(Atom atom, IndirectObject host) SoftwareIdentifierElement(IndirectObject obj) SoftwareIdentifierElement(Element relation, CreationOptions options) ``` [Visual Basic] ``` SoftwareIdentifierElement() SoftwareIdentifierElement(atom As Atom, host As IndirectObject) SoftwareIdentifierElement(obj As IndirectObject) SoftwareIdentifierElement(relation As Element, options As CreationOptions) ``` |  |  | 
| --- | --- | --- |
