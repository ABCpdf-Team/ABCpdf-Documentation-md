...
```csharp
AtomicArrayElement()
AtomicArrayElement(Atom atom, IndirectObject host)
AtomicArrayElement(IndirectObject obj)
AtomicArrayElement(Element relation, CreationOptions options)
```
...
```
AtomicArrayElement()
AtomicArrayElement(atom As Atom, host As IndirectObject)
AtomicArrayElement(obj As IndirectObject)
AtomicArrayElement(relation As Element, options As CreationOptions)
```
