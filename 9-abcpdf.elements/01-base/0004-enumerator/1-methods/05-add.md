...
```
Overridable Function Add(key As string, value As T) As void
Overridable Function Add(key As TKey, value As TVal) As void
```

			`ArgumentException: Thrown if the key was already present. NullReferenceException: Thrown if the key or value was null.`
