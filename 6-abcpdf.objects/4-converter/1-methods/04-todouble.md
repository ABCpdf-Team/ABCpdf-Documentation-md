...
```csharp
virtual double? ToDouble(Atom atom, int index)
virtual double? ToDouble(Atom atom, string key)
virtual double? ToDouble(Atom atom)
```

<span class=language>[Visual Basic]</span>  

```
Overridable Function ToDouble(atom As Atom, index As int) As Double?
Overridable Function ToDouble(atom As Atom, key As string) As Double?
Overridable Function ToDouble(atom As Atom) As Double?
```
