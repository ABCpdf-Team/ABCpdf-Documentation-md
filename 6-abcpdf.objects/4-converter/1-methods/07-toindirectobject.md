...
```csharp
virtual IndirectObject ToIndirectObject(Atom atom, int index)
virtual IndirectObject ToIndirectObject(Atom atom, string key)
virtual IndirectObject ToIndirectObject(Atom atom)
```

<span class=language>[Visual Basic]</span>  

```
Overridable Function ToIndirectObject(atom As Atom, index As int) As IndirectObject
Overridable Function ToIndirectObject(atom As Atom, key As string) As IndirectObject
Overridable Function ToIndirectObject(atom As Atom) As IndirectObject
```
