...
```csharp
virtual string ToName(Atom atom, int index)
virtual string ToName(Atom atom, string key)
virtual string ToName(Atom atom)
```

<span class=language>[Visual Basic]</span>  

```
Overridable Function ToName(atom As Atom, index As int) As string
Overridable Function ToName(atom As Atom, key As string) As string
Overridable Function ToName(atom As Atom) As string
```
...
Attempts to get a name from the specified atom resolving any references as necessary.
