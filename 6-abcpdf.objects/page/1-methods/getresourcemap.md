...
| **[C#]** ```csharp IDictionaryAtom> GetResourceMap(int id, string type) ``` [Visual Basic] ``` Function GetResourceMap(int id, string type) As IDictionary(Of Atom) ``` |  |  | 
| --- | --- | --- |
