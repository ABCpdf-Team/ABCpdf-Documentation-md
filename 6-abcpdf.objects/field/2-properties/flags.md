...
- Pushbutton (Whether this field is a pushbutton that stores no permanent value)
...
For code shoing how to check, set or clear flags see the [FontObject.Flags](../../fontobject/2-properties/flags.md) property.
