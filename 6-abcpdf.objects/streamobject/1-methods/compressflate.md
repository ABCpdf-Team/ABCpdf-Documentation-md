...
| **[C#]** ```csharp bool CompressFlate() bool CompressFlate(bool force) ``` [Visual Basic] ``` Sub CompressFlate() As Boolean Sub CompressFlate(force As Boolean) As Boolean ``` |  |  | 
| --- | --- | --- |
