...
static ArrayAtom FromContentStream(byte[] value, out IList offsets)
```
...
Shared Function FromContentStream(data() As Byte, Out IList offsets) As ArrayAtom
```
...
using (var doc = new Doc()) {
  ...
  int indent = 0;
  var indentPlus = new HashSet(new string[] { "q", "BT" });
  var indentMinus = new HashSet(new string[] { "Q", "ET" });
...
![](../../../images/pdf/pagecontents.pdf.png) PageContents.pdf