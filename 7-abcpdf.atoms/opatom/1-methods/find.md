...
```csharp
IList> Find(ArrayAtom atom)
IList> Find(ArrayAtom atom, string[] names)
```
...
![](../../../images/pdf/ReplaceColors.pdf.png) ReplaceColors.pdf [Page 1]

![](../../../images/pdf/ReplaceColors.pdf2.png) ReplaceColors.pdf [Page 2]