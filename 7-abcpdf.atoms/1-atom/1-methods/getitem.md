...
```csharp
static Atom GetItem(Atom atom, string key)
static Atom GetItem(Atom atom, int index)
```
...
```
Shared Function GetItem(atom As Atom, key As String) As Atom
Shared Function GetItem(atom As Atom, index As Integer) As Atom
```
