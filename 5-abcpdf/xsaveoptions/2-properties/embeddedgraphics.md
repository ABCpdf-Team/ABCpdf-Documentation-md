...
The HTML5 Canvas element is a blank element on which JavaScript can draw. For older versions of Internet Explorer, the canvas element is automatically converted into VML via [ExplorerCanvas](http://excanvas.sourceforge.net).
