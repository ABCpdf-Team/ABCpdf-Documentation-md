...
Using doc As New Doc()
  ...
  doc.Rect.String = "20 650 80 704"
  ' Render the drawn area with AntiAliasPolygons (default)
  Dim antiAliasedBitmap As Bitmap = doc.Rendering.GetBitmap()
  ' Render the drawn area without AntiAliasPolygons
  doc.Rendering.AntiAliasPolygons = False
  Dim aliasedBitmap As Bitmap = doc.Rendering.GetBitmap()
  ' Add magnified aliased image
  doc.Rect.String = "5 20 605 560"
  doc.AddImageBitmap(aliasedBitmap, False)
  ' Anotate
...
![](../../../images/pdf/RenderingAntiAliasPolygonsTrue.png) RenderingAntiAliasPolygonsTrue.png

![](../../../images/pdf/RenderingAntiAliasPolygonsFalse.png) RenderingAntiAliasPolygonsFalse.png