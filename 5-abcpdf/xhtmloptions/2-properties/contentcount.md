...
Depending on the RetryCount setting (for MSHTML) or the ProcessOptions.RetryCount setting (for Gecko), the page may be re-requested or an error may be returned.
