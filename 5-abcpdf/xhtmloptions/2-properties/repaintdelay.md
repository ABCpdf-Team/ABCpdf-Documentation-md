...
DOM observation is the most accurate measure of detecting changes in the page but requires HtmlOptions.UseScript to be set to its default value of true.
