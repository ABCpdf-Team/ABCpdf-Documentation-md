...
| **[C#]** ```csharp static XImage FromData(byte[] data, XReadOptions options) ``` [Visual Basic] ``` Shared Function FromData(data() As Byte, options As XReadOptions) As XImage ``` `may throw Exception()` |  |  | 
| --- | --- | --- |
