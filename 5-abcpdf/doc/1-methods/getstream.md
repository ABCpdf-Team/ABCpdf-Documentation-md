...
</p>`may throw Exception()` ## Params | Name | Description | | --- | --- | | return | The PDF document as a stream. | ## Notes Normally, you will want to save your documents using the [Save](save.md) method. However, sometimes you will need to obtain your PDF as raw data rather than in a file. The GetStream method allows you to do this.
