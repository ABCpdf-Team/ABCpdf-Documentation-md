...
Function AddLine(x1 As Double, y1 As Double, x2 As Double, y2 As Double, ending1 as LineEnding, ending2 as LineEnding) As Integer
Function AddLine(x1 As Double, y1 As Double, x2 As Double, y2 As Double, ending1 as LineEnding, ending2 as LineEnding, scale1 As Double, scale2 As Double) As Integer
```
...
![](../../../images/pdf/docaddline.pdf.png)docaddline.pdf

Also see example code in: [ABCpdf Advanced Graphics Example](../../../4-examples/17-advancedgraphics.md), [Doc TopDown Property](../2-properties/topdown.md), [Doc Width Property](../2-properties/width.md).