...
Function AddImage(doc As Doc, page As Integer, src As XRect) As Integer
```
`may throw Exception()`
...
- [AddImageFile](addimagefile.md)
- [AddImageData](addimagedata.md)
- [AddImageCopy](addimagecopy.md)
- [AddImageUrl](addimageurl.md)
- [AddImageHtml](addimagehtml.md)
- [AddImageToChain](addimagetochain.md)
- [AddImageDoc](addimagedoc.md)
- [AddImageObject](addimageobject.md)
- [AddImageBitmap](addimagebitmap.md)
...
Also see example code in: [ABCpdf Text Flow Round Image Example](../../../4-examples/02-textflow2.md), [XRendering ColorSpace Property](../../xrendering/2-properties/colorspace.md), [XRendering DefaultHalftone Property](../../xrendering/2-properties/defaulthalftone.md).