...
</p>`may throw Exception()` ## Params | Name | Description | | --- | --- | | return | The PDF document as an array of bytes. | ## Notes Normally, you will want to save your documents using the [Save](save.md) method. However, sometimes you will need to obtain your PDF as raw data rather than in a file. The GetData method allows you to do this.
...
Sometimes, the use of HTTPS with PDF content can be problematic. For example, see [Microsoft KB812935](http://support.microsoft.com/kb/812935).
...
![](../../../images/pdf/docsave.pdf.png)hello.asp