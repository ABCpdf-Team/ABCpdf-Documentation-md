...
| --- | --- | --- | --- | --- |
|  |  |  | 
| This is the top level object that represents a PDF document. ``` System.Object WebSupergoo.ABCpdf13.Doc Implements: IDisposable ``` |  |  | 
...
| AddImageBitmap | Adds a System.Drawing.Bitmap to the current page. | 
| AddImageCopy | Adds a copy of an existing image in the Doc, to the current page. | 
| AddImageData | Extract an image from data and add it to the current page. | 
...
| AddImageObject | Adds an XImage based image to the current page. | 
...
| AddText | Adds a block of single styled text to the current page. | 
| AddTextStyled | Adds a block of multi-styled text to the current page. | 
...
| FitTextStyled | Fit a block of styled text into the current rectangle. | 
...
| GetStream | Gets a document as raw data stream. | 
