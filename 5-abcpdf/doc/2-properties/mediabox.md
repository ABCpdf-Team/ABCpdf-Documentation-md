...
[C#] theDoc.MediaBox.String = "0 0 200 300"; theDoc.Rect.String = theDoc.MediaBox.String;
...
[C#] theDoc.SetInfo(theDoc.Page, "/MediaBox:Rect", "0 0 200 300");
...
[C#] theDoc.SetInfo(theDoc.Page, "/CropBox:Rect", "20 20 180 280");
...
[C#] using var doc = new Doc(); doc.Page = doc.AddPage(); doc.MediaBox.String = "A4"; doc.Page = doc.AddPage(); doc.MediaBox.String = "B5"; doc.Page = doc.AddPage(); doc.Save("docmediabox.pdf");
