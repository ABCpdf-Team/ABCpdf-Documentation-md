...
When this property is set to true ABCpdf will detect these standard scripts and generate appearances conforming with them. See the Field.Format property for details.
