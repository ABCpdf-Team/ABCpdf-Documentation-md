...
| **[C#]** ```csharp void MakeFieldsUnique() void MakeFieldsUnique(string token) ``` [Visual Basic] ``` Sub MakeFieldsUnique() Sub MakeFieldsUnique(token As String) ``` |  |  | 
| --- | --- | --- |
