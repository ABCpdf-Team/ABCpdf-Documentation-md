...
```csharp
Tuple GetStreamAndOffset((IndirectObject owner, int offset, int length)
```

<span class=language>[Visual Basic]</span>  

            `Sub GetStreamAndOffset(owner As IndirectObject, offset As int, length As int) As Tuple`			
## Params
