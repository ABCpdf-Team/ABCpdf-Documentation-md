...
| --- | --- | --- | --- |
| **[C#]** ```csharp bool ``` [Visual Basic]`Boolean` | true | No | Gets or sets a value indicating whether annotations are to be recolored. | 
...
Also see example code in: [RecolorOperation Recolor Function](../1-methods/recolor.md).