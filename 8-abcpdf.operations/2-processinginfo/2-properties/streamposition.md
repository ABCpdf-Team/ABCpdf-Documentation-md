...
This property holds the position in the PDF stream. Set this value to null to end the processing of the current stream. See the [RenderOperation.Save method.](6-renderoperation/1-methods/save.md)
