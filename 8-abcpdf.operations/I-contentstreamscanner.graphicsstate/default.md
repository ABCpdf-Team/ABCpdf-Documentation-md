...
| --- | --- | --- | --- | --- |
|  |  |  | 
| The graphics state as saved and restored using the PDF save and restore graphics state operators. ``` System.Object WebSupergoo.ABCpdf13.Operations.ContentStreamScanner.GraphicsState ``` |  |  | 
