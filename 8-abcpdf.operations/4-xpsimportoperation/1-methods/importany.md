...
The Microsoft XPS Document Writer (MXDW) must also be available. This is the default on Windows Vista. For Windows XP, you can download MXDW at this address: [http://msdn.microsoft.com/en-us/library/dd183313(VS.85).aspx](http://msdn.microsoft.com/en-us/library/dd183313(VS.85).aspx).
