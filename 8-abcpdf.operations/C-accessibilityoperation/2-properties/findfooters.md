...
Whether to detect and remove page footers.
...
If this property is set to true, the AccessibilityOperation will attempt to detect repeated footers and mark them as artifacts.
