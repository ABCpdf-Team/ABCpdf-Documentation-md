...
| **[C#]** ```csharp AccessibilityOperation(Doc doc) ``` [Visual Basic] ``` Sub New(doc As Doc) ``` `may throw Exception()` |  |  | 
| --- | --- | --- |
