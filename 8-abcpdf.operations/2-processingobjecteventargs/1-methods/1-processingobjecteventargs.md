---
title: "1-processingobjecteventargs"
css: "abcpdf-docs.css"
---
...
```csharp
ProcessingObjectEventArgs(IndirectObject obj)
ProcessingObjectEventArgs(IndirectObject obj, ProcessingInfo info)
```
...
Sub New(obj As IndirectObject, info As ProcessingInfo)
```
